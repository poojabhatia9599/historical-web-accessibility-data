...
try{Zf("//web.archive.org/web/20201015061336/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}lg.push(ig(function(){mg||"google_ad_status"in window||(eg("//web.archive.org/web/20201015061336/https://static.doubleclick.net/instream/ad_status.js",a),mg=!0,P("DCLKSTAT",3))},5E3))}}
...
b=wh("//web.archive.org/web/20201015061336/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Ve&&b.abort();
return Pe(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Hj.dispose();a=0;for(var b=lg.length;a<b;a++)kg(lg[a]);lg.length=0;dg("//web.archive.org/web/20201015061336/https://static.doubleclick.net/instream/ad_status.js");mg=!1;P("DCLKSTAT",0);Vc(sm,rm);if(a=qm)a.removeEventListener("onScreenChanged",wm),a.removeEventListener("onLogClientVeCreated",um),a.removeEventListener("onLogServerVeCreated",xm),a.removeEventListener("onLogVeClicked",ym),a.removeEventListener("onLogVesShown",zm),a.removeEventListener("onVideoDataChange",vm),a.destroy();
tm={}});
...
/*
     FILE ARCHIVED ON 06:13:36 Oct 15, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:37:11 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 971.283
  exclusion.robots: 0.084
  exclusion.robots.policy: 0.074
  cdx.remote: 0.06
  esindex: 0.009
  LoadShardBlock: 570.718 (3)
  PetaboxLoader3.datanode: 584.87 (5)
  load_resource: 2267.569 (2)
  PetaboxLoader3.resolve: 1886.635 (2)
*/