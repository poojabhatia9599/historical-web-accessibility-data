...
;function Y(a,b,c){this.l=this.f=this.g=null;this.j=Na(this);this.h=0;this.s=!1;this.m=[];this.i=null;this.v=c;this.H={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?sc(a.src):"https://web.archive.org/web/20200929040403/https://www.youtube.com"),this.g=new If(b),c||(b=ej(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+Na(this.f)),Cf[this.f.id]=this,window.postMessage){this.i=new N;fj(this);b=R(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
...
/*
     FILE ARCHIVED ON 04:04:03 Sep 29, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:27:16 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 301.829
  exclusion.robots: 0.082
  exclusion.robots.policy: 0.072
  cdx.remote: 0.064
  esindex: 0.011
  LoadShardBlock: 141.517 (3)
  PetaboxLoader3.datanode: 182.942 (5)
  load_resource: 389.639 (2)
  PetaboxLoader3.resolve: 255.892 (2)
*/