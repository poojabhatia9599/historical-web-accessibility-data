...
m.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Jb(a.src):"https://web.archive.org/web/20220101010538/https://www.youtube.com"),this.i=new hl(b),c||(b=ql(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ma(this.h)),bl[this.h.id]=this,window.postMessage){this.l=new L;rl(this);b=il(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in dl)dl.hasOwnProperty(e)&&
ol(this,e)}};
...
/*
     FILE ARCHIVED ON 01:05:38 Jan 01, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:14:52 Dec 11, 2023.
...
playback timings (ms):
  ...
  cdx.remote: 0.094
  esindex: 0.012
  LoadShardBlock: 435.539 (6)
  PetaboxLoader3.datanode: 126.41 (8)
  load_resource: 249.902 (2)
  PetaboxLoader3.resolve: 169.983 (2)
*/