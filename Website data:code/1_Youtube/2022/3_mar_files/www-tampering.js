...
;function O(a,b,c){a||(a=ma);ma=null;var d=this.constructor.j;a||(a=d?[d]:[]);this.g=(d?0:-1)-(this.constructor.g||0);this.o=void 0;this.i=a;a:{d=this.i.length;a=d-1;if(d&&(d=this.i[a],L(d))){this.j=a-this.g;this.l=d;break a}void 0!==b&&-1<b?(this.j=Math.max(b,a+1-this.g),this.l=void 0):this.j=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.j)a+=this.g,(d=this.i[a])?Array.isArray(d)&&K(d):this.i[a]=da;else{d=this.l||(this.l=this.i[this.j+this.g]={});var h=d[a];h?Array.isArray(h)&&K(h):
d[a]=da}}
...
M&&na();function oa(a,b){var c=this.g,d=!0;d=void 0===d?!1:d;ea(a);a.o||(a.o={});var h=b?b.i:b;a.o[c]=b;b=d;b=void 0===b?!1:b;ea(a);c<a.j&&!b?a.i[c+a.g]=h:(a.l||(a.l=a.i[a.j+a.g]={}))[c]=h;return a}
...
/*
     FILE ARCHIVED ON 00:01:57 Mar 01, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:11:49 Dec 11, 2023.
...
/*
playback timings (ms):
  captures_list: 96.248
  exclusion.robots: 0.093
  exclusion.robots.policy: 0.083
  cdx.remote: 0.062
  esindex: 0.009
  LoadShardBlock: 63.536 (3)
  PetaboxLoader3.datanode: 76.608 (4)
  load_resource: 59.994
