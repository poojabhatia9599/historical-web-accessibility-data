...
Ea:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Close"},U:[g.eH()]});g.H(this,a);a.Ba(this.kC.element);this.T(a.element,"click",this.Hj);a=new g.V({G:"button",Ea:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Close"},U:[g.kH()]});g.H(this,a);a.Ba(this.kC.element);this.T(a.element,"click",this.pZ);this.T(this.player,"presentingplayerstatechange",this.Sc);this.T(this.player,"appresize",this.xb);this.T(this.player,"fullscreentoggled",this.xb);this.xb()};
...
/*
     ...
     INTERNET ARCHIVE ON 19:25:12 Dec 11, 2023.
...
/*
playback timings (ms):
  captures_list: 204.88
  exclusion.robots: 0.09
  exclusion.robots.policy: 0.082
  cdx.remote: 0.056
  esindex: 0.009
  LoadShardBlock: 64.854 (3)
  PetaboxLoader3.datanode: 113.661 (4)
  load_resource: 197.581
  PetaboxLoader3.resolve: 70.161
*/