...
"d MMMM y","d MMM y","dd/MM/y"],TIMEFORMATS:["HH:mm:ss zzzz","HH:mm:ss z","HH:mm:ss","HH:mm"],DATETIMEFORMATS:["{1} 'at' {0}","{1} 'at' {0}","{1}, {0}","{1}, {0}"],FIRSTDAYOFWEEK:0,WEEKENDRANGE:[5,6],FIRSTWEEKCUTOFFDAY:3};function k(b,c){if(void 0===c){c=b+"";var a=c.indexOf(".");c=Math.min(-1===a?0:c.length-a-1,3)}return 1==(b|0)&&0==c?"one":"other"}
...
/*
     FILE ARCHIVED ON 00:03:35 May 01, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:24:23 Dec 11, 2023.
...
playback timings (ms):
  ...
  load_resource: 66.015
  PetaboxLoader3.resolve: 20.937
*/