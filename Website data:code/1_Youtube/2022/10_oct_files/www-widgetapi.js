...
function Qn(a,b,c){this.m=this.g=this.h=null;this.i=0;this.s=!1;this.l=[];this.j=null;this.H={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.B=c;c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Vb(a.src):"https://web.archive.org/web/20221001000534/https://www.youtube.com"),this.h=new Mn(b),c||(b=Rn(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.g=a,this.g.id||(this.g.id="widget"+Qa(this.g)),Gn[this.g.id]=this,window.postMessage){this.j=
...
/*
     FILE ARCHIVED ON 00:05:34 Oct 01, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:43:24 Dec 11, 2023.
...
/*
playback timings (ms):
  captures_list: 1349.136
  exclusion.robots: 0.077
  exclusion.robots.policy: 0.065
  cdx.remote: 0.06
  esindex: 0.01
  LoadShardBlock: 149.466 (4)
  PetaboxLoader3.datanode: 178.504 (6)
  load_resource: 88.402 (2)
