...
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Bb(a.src):"https://web.archive.org/web/20220201000053/https://www.youtube.com"),this.i=new Vk(b),c||(b=dl(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ma(this.h)),Pk[this.h.id]=this,window.postMessage){this.l=new K;el(this);b=Wk(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Rk)Rk.hasOwnProperty(e)&&
bl(this,e)}};
...
/*
     FILE ARCHIVED ON 00:00:53 Feb 01, 2022 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 520.325
  exclusion.robots: 0.099
  exclusion.robots.policy: 0.088
  cdx.remote: 0.067
  esindex: 0.011
  LoadShardBlock: 74.792 (3)
  PetaboxLoader3.datanode: 81.791 (5)
  load_resource: 288.448 (2)
  PetaboxLoader3.resolve: 217.72 (2)
*/