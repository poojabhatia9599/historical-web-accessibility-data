...
var _yt_www={};(function(g){var window=this;var ca,aaa,ka,la,ma,pa,na,qa,ra,sa,daa,eaa,Cb,Wb,qc,iaa,xc,Bc,Cc,Dc,Lc,Mc,kaa,maa,rd,naa,oaa,sd,td,qaa,Cd,Ed,Fd,Kd,raa,Nd,Ud,Td,taa,Xd,Yd,Zd,$d,vaa,be,ce,ge,waa,he,oe,qe,xaa,ve,ze,te,re,zaa,ye,we,xe,Be,yaa,Aaa,Ge,He,Le,Baa,Caa,Daa,Re,Te,Faa,Ye,Ze,af,Gaa,df,hf,jf,kf,lf,mf,Df,Iaa,Hf,Kf,Lf,Nf,Jaa,Vf,fg,Maa,ng,ig,Naa,pg,Oaa,Paa,Qaa,Raa,Taa,Gg,Uaa,Hg,Ig,Vaa,Ng,Lg,Jg,Pg,Xg,hh,ih,Zaa,wh,Yaa,cba,Ih,Nh,Oh,dba,Uh,Vh,ci,bi,eba,gi,ni,oi,pi,ti,xi,Ai,Ci,Di,fba,iba,Ii,Ki,Hi,Ji,Qi,Ri,Xi,jba,Si,Yi,kba,aj,Pi,bj,lba,
Zi,$i,mba,lj,nba,oba,qj,rj,sj,tj,tba,Lj,xj,Mj,yj,vj,Gj,Qj,zj,pba,Uj,Fj,Vj,qba,rba,Hj,Cj,Dj,wj,Pj,Ej,Xj,Jj,Rj,Kj,yba,Bj,Tj,Aba,Hba,Gba,Fba,dk,Eba,Cba,Dba,Iba,Jba,Kba,Lba,rk,nk,pk,tk,Mba,uk,wk,Nba,Oba,xk,yk,Dk,Hk,Ik,Kk,Ok,Pk,Qk,Vba,Wba,Ek,Gk,Ck,Uba,Fk,Uk,Wk,Tk,Xk,Vk,Xba,aca,Yba,dca,$ba,Zba,bca,cca,fca,$k,eca,Yk,gca,ica,kca,jca,hca,al,bl,cl,ea,dl,Fa,caa;g.ba=function(a){return function(){return g.aa[a].apply(this,arguments)}};
...
pa=function(){la();var a=ia.Symbol.iterator;a||(a=ia.Symbol.iterator=ia.Symbol("Symbol.iterator"));"function"!=typeof Array.prototype[a]&&ja(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return na(ca(this))}});
pa=function(){}};
na=function(a){pa();a={next:a};a[ia.Symbol.iterator]=function(){return this};
return a};
...
g.p=function(a,b,c){a=a.split(".");c=c||g.n;a[0]in c||"undefined"==typeof c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&g.ua(b)?c[d]=b:c[d]&&c[d]!==Object.prototype[d]?c=c[d]:c=c[d]={}};
...
c.prototype=b.prototype;a.T=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.xw=function(d,e,f){for(var k=Array(arguments.length-2),l=2;l<arguments.length;l++)k[l-2]=arguments[l];b.prototype[e].apply(d,k)}};
...
g.Ka=function(a,b,c){b=g.Ja(a,b,c);return 0>b?null:g.va(a)?a.charAt(b):a[b]};
g.Ja=function(a,b,c){for(var d=a.length,e=g.va(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&b.call(c,e[f],f,a))return f;return-1};
...
g.Lb=function(a){if(a instanceof g.Fb)return a;a="object"==typeof a&&a.fe?a.cd():String(a);Kb.test(a)||(a="about:invalid#zClosurez");return g.Ib(a)};
g.Mb=function(a,b){if(a instanceof g.Fb)return a;a="object"==typeof a&&a.fe?a.cd():String(a);if(b&&/^data:/i.test(a)){var c=g.Jb(a);if(c.cd()==a)return c}Kb.test(a)||(a="about:invalid#zClosurez");return g.Ib(a)};
...
g.Yb=function(){return g.Ub("Safari")&&!(g.Xb()||g.Ub("Coast")||g.Ub("Opera")||g.Ub("Edge")||g.Ub("Edg/")||Wb()||g.Ub("Silk")||g.Ub("Android"))};
...
g.ec=function(a){if(a instanceof g.ac)return a;var b="object"==typeof a,c=null;b&&a.im&&(c=a.C());return g.dc(g.zb(b&&a.fe?a.cd():String(a)),c)};
...
iaa=function(a,b){var c=g.x.hC;return Object.prototype.hasOwnProperty.call(c,a)?c[a]:c[a]=b(a)};
...
g.Ic=function(a){var b=g.r("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if(g.va(a))return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(f){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||g.n.$googDebugFname||b}catch(f){e="Not available",c=!0}return!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:(b=a.message,null==b&&(b=a.constructor&&
...
g.Pc=function(a,b){this.x=g.ua(a)?a:0;this.y=g.ua(b)?b:0};
...
g.y=function(a){return g.va(a)?document.getElementById(a):a};
g.Tc=function(a){var b=document;return g.va(a)?b.getElementById(a):a};
g.Vc=function(a,b){g.Ua(b,function(c,d){c&&"object"==typeof c&&c.fe&&(c=c.cd());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Uc.hasOwnProperty(d)?a.setAttribute(Uc[d],c):g.qb(d,"aria-")||g.qb(d,"data-")?a.setAttribute(d,c):a[d]=c})};
...
g.Zc=function(a,b){var c=String(b[0]),d=b[1];if(!jaa&&d&&(d.name||d.type)){c=["<",c];d.name&&c.push(' name="',g.mc(d.name),'"');if(d.type){c.push(' type="',g.mc(d.type),'"');var e={};g.eb(e,d);delete e.type;d=e}c.push(">");c=c.join("")}c=a.createElement(c);d&&(g.va(d)?c.className=d:g.Ba(d)?c.className=d.join(" "):g.Vc(c,d));2<b.length&&g.ad(a,c,b,2);return c};
g.ad=function(a,b,c,d){function e(k){k&&b.appendChild(g.va(k)?a.createTextNode(k):k)}
...
function b(z){for(var B=k,J=0;64>J;J+=4)B[J/4]=z[J]<<24|z[J+1]<<16|z[J+2]<<8|z[J+3];for(J=16;80>J;J++)z=B[J-3]^B[J-8]^B[J-14]^B[J-16],B[J]=(z<<1|z>>>31)&4294967295;z=e[0];var T=e[1],X=e[2],ta=e[3],Oa=e[4];for(J=0;80>J;J++){if(40>J)if(20>J){var Ia=ta^T&(X^ta);var vd=1518500249}else Ia=T^X^ta,vd=1859775393;else 60>J?(Ia=T&X|ta&(T|X),vd=2400959708):(Ia=T^X^ta,vd=3395469782);Ia=((z<<5|z>>>27)&4294967295)+Ia+Oa+vd+B[J]&4294967295;Oa=ta;ta=X;X=(T<<30|T>>>2)&4294967295;T=z;z=Ia}e[0]=e[0]+z&4294967295;e[1]=
e[1]+T&4294967295;e[2]=e[2]+X&4294967295;e[3]=e[3]+ta&4294967295;e[4]=e[4]+Oa&4294967295}
function c(z,B){if("string"===typeof z){z=unescape(encodeURIComponent(z));for(var J=[],T=0,X=z.length;T<X;++T)J.push(z.charCodeAt(T));z=J}B||(B=z.length);J=0;if(0==q)for(;J+64<B;)b(z.slice(J,J+64)),J+=64,u+=64;for(;J<B;)if(f[q++]=z[J++],u++,64==q)for(q=0,b(f);J+64<B;)b(z.slice(J,J+64)),J+=64,u+=64}
function d(){var z=[],B=8*u;56>q?c(l,56-q):c(l,64-(q-56));for(var J=63;56<=J;J--)f[J]=B&255,B>>>=8;b(f);for(J=B=0;5>J;J++)for(var T=24;0<=T;T-=8)z[B++]=e[J]>>T&255;return z}
for(var e=[],f=[],k=[],l=[128],m=1;64>m;++m)l[m]=0;var q,u;a();return{reset:a,update:c,digest:d,Uw:function(){for(var z=d(),B="",J=0;J<z.length;J++)B+="0123456789ABCDEF".charAt(Math.floor(z[J]/16))+"0123456789ABCDEF".charAt(z[J]%16);return B}}};
...
sd=function(a){var b=naa();b.update(a);return b.Uw().toLowerCase()};
...
g.ud=function(a,b){a.Zc?g.ua(void 0)?b.call(void 0):b():(a.Uf||(a.Uf=[]),a.Uf.push(g.ua(void 0)?(0,g.t)(b,void 0):b))};
g.wd=function(a){a&&"function"==typeof a.dispose&&a.dispose()};
g.yd=function(a,b){this.type=a;this.currentTarget=this.target=b;this.F=!1;this.Wt=!0};
...
qaa=function(a,b,c,d,e){this.listener=a;this.C=null;this.src=b;this.type=c;this.capture=!!d;this.Mh=e;this.key=++paa;this.Qg=this.Ji=!1};
Cd=function(a){a.Qg=!0;a.listener=null;a.C=null;a.src=null;a.Mh=null};
g.Dd=function(a){this.src=a;this.listeners={};this.C=0};
Ed=function(a,b){var c=b.type;if(!(c in a.listeners))return!1;var d=g.Qa(a.listeners[c],b);d&&(Cd(b),0==a.listeners[c].length&&(delete a.listeners[c],a.C--));return d};
Fd=function(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.Qg&&f.listener==b&&f.capture==!!c&&f.Mh==d)return e}return-1};
...
g.Rd=function(a){if(g.xa(a)||!a||a.Qg)return!1;var b=a.src;if(g.Bd(b))return Ed(b.Hd,a);var c=a.type,d=a.C;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Nd(c),d):b.addListener&&b.removeListener&&b.removeListener(d);Od--;(c=g.Ld(b))?(Ed(c,a),0==c.C&&(c.src=null,b[Md]=null)):Cd(a);return!0};
Nd=function(a){return a in Sd?Sd[a]:Sd[a]="on"+a};
Ud=function(a,b,c,d){var e=!0;if(a=g.Ld(a))if(b=a.listeners[b.toString()])for(b=b.concat(),a=0;a<b.length;a++){var f=b[a];f&&f.capture==c&&!f.Qg&&(f=Td(f,d),e=e&&!1!==f)}return e};
Td=function(a,b){var c=a.listener,d=a.Mh||a.src;a.Ji&&g.Rd(a);return c.call(d,b)};
...
return a[Vd]};
g.Wd=function(){g.C.call(this);this.Hd=new g.Dd(this);this.dw=this;this.Um=null};
Xd=function(a,b,c,d){b=a.Hd.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var k=b[f];if(k&&!k.Qg&&k.capture==c){var l=k.listener,m=k.Mh||k.src;k.Ji&&Ed(a.Hd,k);e=!1!==l.call(m,d)&&e}}return e&&0!=d.Wt};
...
if("undefined"!==typeof a&&!g.Vb()){var b=new a,c={},d=c;b.port1.onmessage=function(){if(g.ua(c.next)){c=c.next;var e=c.Ko;c.Ko=null;e()}};
...
e.onRejected=c?function(l){try{var m=c.call(d,l);!g.ua(m)&&l instanceof g.Ae?k(l):f(m)}catch(q){k(q)}}:k});
...
g.Fe=function(a,b,c){g.C.call(this);this.C=a;this.D=b||0;this.F=c;this.hc=(0,g.t)(this.Sp,this)};
...
g.Ie=function(a){if(a.classList)return a.classList;a=a.className;return g.va(a)&&a.match(/\S+/g)||[]};
...
g.We=function(a,b,c,d){if(b=a.F[b]){var e=a.C;(b=g.Ka(b,function(f){return e[f+1]==c&&e[f+2]==d}))&&a.Dd(b)}};
Faa=function(a,b,c){ge(function(){a.apply(b,c)})};
g.Xe=function(a){this.C=a};
Ye=function(a){this.C=a};
Ze=function(a){this.data=a};
af=function(a){return!g.ua(a)||a instanceof Ze?a:new Ze(a)};
...
Jaa=function(a,b,c,d,e){var f=!1,k=Lf("log_window_onerror_fraction");if(k&&Math.random()<k)f=!0;else{k=document.getElementsByTagName("script");for(var l=0,m=k.length;l<m;l++)if(0<k[l].src.indexOf("/debug-")){f=!0;break}}f&&(e||(g.va(a)?f=a:ErrorEvent&&a instanceof ErrorEvent?(f=a.message,b=a.filename,c=a.lineno,d=a.colno):(f="Unknown error",b="Unknown file",c=0),a=Error(f),a.name="UnhandledWindowError",e=a,e.message=f,e.fileName=b,e.lineNumber=c,isNaN(d)?delete e.columnNumber:e.columnNumber=d),g.Mf(e))};
...
g.$f=function(a){var b=Vf();b&&(g.xa(a)?a=[a]:g.va(a)&&(a=[parseInt(a,10)]),(0,g.A)(a,function(c){b.unsubscribeByKey(c);delete Wf[c]}))};
...
b.ts&&0<b.timeout&&(f=g.Rf(function(){e||(e=!0,g.Tf(f),b.ts.call(b.context||g.n))},b.timeout))}else g.H(a,b)};
...
return k};
Hg=function(a,b){b.NB&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=g.E("XSRF_FIELD_NAME",void 0),d=b.Sa;d&&(d[c]&&delete d[c],a=g.wg(a,d));return a};
Ig=function(a,b){var c=g.E("XSRF_FIELD_NAME",void 0),d=g.E("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.ha,k=g.E("XSRF_FIELD_NAME",void 0),l;b.headers&&(l=b.headers["Content-Type"]);b.kx||g.sf(a)&&!b.withCredentials&&g.sf(a)!=document.location.hostname||"POST"!=b.method||l&&"application/x-www-form-urlencoded"!=l||b.ha&&b.ha[k]||(f||(f={}),f[c]=d);f&&g.va(e)&&(e=g.ug(e),g.eb(e,f),e=b.qt&&"JSON"==b.qt?JSON.stringify(e):g.yf(e));f=e||f&&!g.Ya(f);!Kg&&f&&"POST"!=b.method&&(Kg=!0,g.Mf(Error("AJAX request with postData should use POST")));
return e};
...
g.Wg=function(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.rotation=this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{a=a||window.event;if(!a)return;this.event=a}catch(c){if(g.qg("kevlar_js_fixes"))return;throw c;}for(var b in a)b in Xaa||(this[b]=a[b]);this.rotation=a.rotation;(b=a.target||a.srcElement)&&3==b.nodeType&&(b=b.parentNode);
...
g.Yg=function(a){g.ua(a.C)||Xg(a);return a.C};
g.Zg=function(a){g.ua(a.F)||Xg(a);return a.F};
...
g.dh=function(a){a&&("string"==typeof a&&(a=[a]),(0,g.A)(a,function(b){if(b in $g){var c=$g[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?ch()||g.wa(c)?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete $g[b]}}))};
g.eh=function(a,b,c){var d=void 0===d?{}:d;var e;return e=g.I(a,b,function(){g.dh(e);c.apply(a,arguments)},d)};
g.fh=function(a){for(var b in $g)$g[b][0]==a&&g.dh(b)};
g.gh=function(a){this.hc=a;this.C=null;this.D=0;this.L=null;this.G=0;this.F=[];for(a=0;4>a;a++)this.F.push(0);this.H=0;this.J=g.I(window,"mousemove",(0,g.t)(this.X,this));this.O=g.Sf((0,g.t)(this.N,this),25)};
hh=function(){g.C.call(this);this.C=[]};
ih=function(a){a=a||{};var b={enablejsapi:1},c={};this.url=a.url||"";this.args=a.args||g.bb(b);this.assets=a.assets||{};this.attrs=a.attrs||g.bb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}};
g.jh=function(a){a instanceof ih||(a=new ih(a));return a};
g.oh=function(a,b,c,d,e,f){f=f||{};f.name=c||g.E("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||g.E("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(!(!a||!e||5<=kh||(g.qg("console_log_js_exceptions")&&(e=a,c=[],c.push("Name: "+e.name),c.push("Message: "+e.message),e.hasOwnProperty("params")&&c.push("Error Params: "+JSON.stringify(e.params)),c.push("File name: "+e.fileName),c.push("Stacktrace: "+
e.stack),c=c.join("\n"),window.console.log(c,e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=g.Ic(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&g.Da(window.yterr)&&window.yterr(a),lh[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Sa:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},ha:{url:g.E("PAGE_NAME",
window.location.href),file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.ha.stack=e);for(var k in f)b.ha["client."+k]=f[k];if(k=g.E("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var l in k)b.ha[l]=k[l];g.H(g.E("ECATCHER_REPORT_HOST","")+"/error_204",b);lh[a.message]=!0;kh++}};
g.uh=function(){g.Tf(g.ph);g.Tf(g.qh);g.qh=0;if(!g.Ya(g.rh)){for(var a in g.rh){var b=sh[a];b&&(Yaa(a,b),delete g.rh[a])}g.Ya(g.rh)||g.th()}};
Zaa=function(){var a=[];for(e in g.rh){var b=vh[e]||{};vh[e]=b;for(var c in g.rh[e]){var d=wh(e,c);b.storedEventsCount=b.storedEventsCount||0;b.storedEventsCount+=d.length}}var e=Math.round(g.xh());for(var f in vh)b=vh[f],b.eventType=f in yh?yh[f]:"UNKNOWN_TYPE",c=zh[f],b.metricIntervalMs=c?e-c:e-g.Ah,a.push(b),zh[f]=e,delete vh[f];return a};
g.th=function(){g.qg("web_gel_timeout_cap")&&!g.qh&&(g.qh=g.Rf(g.uh,3E4));g.Tf(g.ph);var a=g.rg("web_gel_debounce_ms",1E4);g.ph=g.Rf(g.uh,g.E("LOGGING_BATCH_TIMEOUT",g.Bh||a))};
wh=function(a,b){b=void 0===b?"":b;g.rh[a]=g.rh[a]||{};g.rh[a][b]=g.rh[a][b]||[];return g.rh[a][b]};
Yaa=function(a,b){var c=$aa[a],d=vh[a]||{};vh[a]=d;var e=Math.round(g.xh());for(q in g.rh[a]){var f=g.cb({context:g.Ch(b.C)});f[c]=wh(a,q);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;var k=Dh[q];if(k)a:{var l=q;if(k.videoId)var m="VIDEO";else if(k.playlistId)m="PLAYLIST";else break a;f.credentialTransferTokenTargetId=k;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:l,scope:m}]}delete Dh[q];f.requestTimeMs=
e;if(k=g.E("EVENT_ID",void 0))m=(g.E("BATCH_CLIENT_COUNTER",void 0)||0)+1,m>aba&&(m=1),g.Jf("BATCH_CLIENT_COUNTER",m),k={serializedEventId:k,clientCounter:m},f.serializedClientEventId=k,Eh&&Fh&&g.qg("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:Eh,roundtripMs:Fh}),Eh=k,Fh=0;g.Gh(b,a,f,{retry:bba.has(a),onSuccess:(0,g.t)(cba,this,g.xh())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var q=d.diffCount||0;d.averageTimeBetweenDispatchesMs=q?(d.averageTimeBetweenDispatchesMs*
q+c)/(q+1):c;d.diffCount=q+1}d.previousDispatchMs=e};
cba=function(a){Fh=Math.round(g.xh()-a)};
g.Jh=function(a){var b=void 0===a?{}:a;a=void 0===b.OB?!0:b.OB;b=void 0===b.EJ?!1:b.EJ;if(null==g.r("_lact",window)){var c=parseInt(g.E("LACT"),10);c=isFinite(c)?(0,g.Nc)()-Math.max(c,0):-1;g.p("_lact",c,window);g.p("_fact",c,window);-1==c&&g.Hh();g.I(document,"keydown",g.Hh);g.I(document,"keyup",g.Hh);g.I(document,"mousedown",g.Hh);g.I(document,"mouseup",g.Hh);a&&(b?g.I(window,"touchmove",function(){Ih("touchmove",200)},{passive:!0}):(g.I(window,"resize",function(){Ih("resize",200)}),g.I(window,
"scroll",function(){Ih("scroll",200)})));
new g.gh(function(){Ih("mouse",100)});
g.I(document,"touchstart",g.Hh,{passive:!0});g.I(document,"touchend",g.Hh,{passive:!0})}};
Ih=function(a,b){Kh[a]||(Kh[a]=!0,g.kg(function(){g.Hh();Kh[a]=!1},b))};
g.Hh=function(){null==g.r("_lact",window)&&g.Jh();var a=(0,g.Nc)();g.p("_lact",a,window);-1==g.r("_fact",window)&&g.p("_fact",a,window);(a=g.r("ytglobal.ytUtilActivityCallback_"))&&a()};
g.Lh=function(){var a=g.r("_lact",window);return null==a?-1:Math.max((0,g.Nc)()-a,0)};
g.Mh=function(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||g.xh());f[a]=b;f.context={lastActivityMs:String(d?-1:g.Lh())};e?(a={},e.videoId?a.videoId=e.videoId:e.playlistId&&(a.playlistId=e.playlistId),Dh[e.token]=a,e=wh("log_event",e.token)):e=wh("log_event");e.push(f);c&&(sh.log_event=new c);e.length>=(g.rg("web_logging_max_batch")||20)?g.uh():g.th()};
g.Ch=function(a){a={client:{hl:a.VB,gl:a.UB,clientName:a.SB,clientVersion:a.TB}};var b=window.devicePixelRatio;b&&1!=b&&(a.client.screenDensityFloat=String(b));g.E("DELEGATED_SESSION_ID")&&!g.qg("pageid_as_header_web")&&(a.user={onBehalfOfUser:g.E("DELEGATED_SESSION_ID")});return a};
Nh=function(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||g.E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.SW||g.E("AUTHORIZATION"))||(a?b="Bearer "+g.r("gapi.auth.getToken")().RW:b=td([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=g.E("SESSION_INDEX",0),g.qg("pageid_as_header_web")&&(d["X-Goog-PageId"]=g.E("DELEGATED_SESSION_ID")));return d};
...
dba=function(a,b,c,d){if(d)return null;d=Th.get("nextId",!0)||1;var e=Th.get("requests",!0)||{};e[d]={method:a,request:b,authState:Oh(c),requestTime:Math.round(g.xh())};Th.set("nextId",d+1,86400,!0);Th.set("requests",e,86400,!0);return d};
Uh=function(a){var b=Th.get("requests",!0)||{};delete b[a];Th.set("requests",b,86400,!0)};
Vh=function(a){var b=Th.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(g.xh())-d.requestTime)){var e=d.authState,f=Oh(Nh(!1));g.ab(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(g.xh())),g.Gh(a,d.method,e,{}));delete b[c]}}Th.set("requests",b,86400,!0)}};
g.Wh=function(a){var b=this;this.C=a||{QB:g.E("INNERTUBE_API_KEY",void 0),RB:g.E("INNERTUBE_API_VERSION",void 0),SB:g.E("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),TB:g.E("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),VB:g.E("INNERTUBE_CONTEXT_HL",void 0),UB:g.E("INNERTUBE_CONTEXT_GL",void 0),WB:g.E("INNERTUBE_HOST_OVERRIDE",void 0)||"",XB:!!g.E("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};g.jg(function(){Vh(b)},5E3)};
g.Gh=function(a,b,c,d){!g.E("VISITOR_DATA")&&.01>Math.random()&&g.Mf(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",ha:c,qt:"JSON",Tc:function(){d.Tc()},
ts:d.Tc,onSuccess:function(B,J){if(d.onSuccess)d.onSuccess(J)},
Nj:function(B){if(d.onSuccess)d.onSuccess(B)},
onError:function(B,J){if(d.onError)d.onError(J)},
rs:function(B){if(d.onError)d.onError(B)},
timeout:d.timeout,withCredentials:!0},f="",k=a.C.WB;k&&(f=k);k=a.C.XB||!1;var l=Nh(k,f,d);Object.assign(e.headers,l);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var m=""+f+("/youtubei/"+a.C.RB+"/"+b)+"?alt=json&key="+a.C.QB,q;if(d.retry&&g.qg("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(q=dba(b,c,l,k))){var u=e.onSuccess,z=e.Nj;e.onSuccess=function(B,J){Uh(q);u(B,J)};
c.Nj=function(B,J){Uh(q);z(B,J)}}try{g.qg("use_fetch_for_op_xhr")?Uaa(m,e):g.Og(m,e)}catch(B){if("InvalidAccessError"==B)q&&(Uh(q),q=0),g.Mf(Error("An extension is blocking network request."),"WARNING");
else throw B;}q&&g.jg(function(){Vh(a)},5E3)};
g.Xh=function(a,b,c){var d=g.Wh;g.E("ytLoggingEventsDefaultDisabled",!1)&&g.Wh==g.Wh&&(d=null);g.Mh(a,b,d,c,void 0)};
...
g.ai=function(a,b,c){(0,g.A)(b,function(d){g.Mh("visualElementHidden",{csn:a,ve:g.$h(d),eventType:c?16:8},g.Wh,void 0,void 0)})};
ci=function(a,b){var c=Object.keys(a).join("");bi("info_"+c+"_"+b)||(a.clientActionNonce=b,g.Xh("latencyActionInfo",a))};
bi=function(a){di[a]=di[a]||{count:0};var b=di[a];b.count++;b.time=g.xh();ei||(ei=g.jg(eba,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;g.oh(c,b)}return!0}return!1};
eba=function(){var a=g.xh(),b;for(b in di)6E4<a-di[b].time&&delete di[b];ei=0};
gi=function(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=(0,g.Nc)();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(fi)for(a=1,b=0;b<fi.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^fi.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&
63));return a.join("")};
g.li=function(a){if("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND"==a||"FOREGROUND_HEARTBEAT_TRIGGER_ON_FOREGROUND"==a){if(hi==a)return;hi=a}var b=9E4+2E3*Math.random();if("FOREGROUND_HEARTBEAT_TRIGGER_ON_INTERVAL"!=a||!(g.Lh()>b)&&"visible"==g.Vg()){b=-1;g.ii&&(b=Math.round(g.xh()-g.ii));var c=String;var d=g.r("_fact",window);d=null==d||-1==d?-1:Math.max((0,g.Nc)()-d,0);a={firstActivityMs:c(d),clientDocumentNonce:ji,index:String(ki),lastEventDeltaMs:String(b),trigger:a};g.Mh("foregroundHeartbeat",
a,g.Wh);g.p("_fact",-1,window);ki++;g.ii=g.xh()}};
g.mi=function(a){a&&g.Mh("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:ji,clientScreenNonce:a},g.Wh)};
...
pi=function(a){return g.E(oi(void 0===a?0:a),void 0)};
g.qi=function(){var a=pi(0),b;a?b=new g.Zh({veType:a,youtubeData:void 0}):b=null;return b};
g.ri=function(a){a=void 0===a?0:a;var b=g.E(ni(a));b||0!=a||(b=g.E("EVENT_ID"));return b?b:null};
g.si=function(a,b,c){c=void 0===c?0:c;if(a!==g.E(ni(c))||b!==g.E(oi(c)))g.Jf(ni(c),a),g.Jf(oi(c),b),0==c&&(b=function(){setTimeout(function(){g.mi(a)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())};
ti=function(){var a=g.qi(),b=g.ri();b&&a&&g.ai(b,[a],!0)};
g.ui=function(a,b,c,d,e){this.name=a;this.deps=b||[];this.page=c||"";this.L=d?Nf(d):null;this.H=e?Nf(e):null;this.G=[];this.C=this.F=0};
g.vi=function(a){g.lg(a.F);a.F=g.kg((0,g.t)(a.init,a))};
g.yi=function(a){a.name in wi&&xi(a.name);wi[a.name]={reqs:[],disable:(0,g.t)(a.disable,a)};(0,g.A)(a.deps,function(b){if(!(b in wi))throw Error("Module "+b+" required by "+a.name);wi[b].reqs.push(a.name)});
a.enable()};
xi=function(a){if(a in wi){var b=wi[a];(0,g.A)(b.reqs,function(c){xi(c)});
try{b.disable()}catch(c){}delete wi[a]}};
Ai=function(a){Hf(g.zi,arguments)};
g.Bi=function(a){return a in g.zi};
Ci=function(a){Hf(g.zi,arguments)};
...
"1"===g.Cf(a,"ae")&&"1"===g.Cf(a,"act")?Di(a)?(b&&b(),d=!0):d=!1:d=!1,d||fba(a,b)))};
Di=function(a,b){try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,void 0===b?"":b))return!0}catch(c){}return!1};
fba=function(a,b){var c=new Image,d=""+gba++;Fi[d]=c;c.onload=c.onerror=function(){b&&Fi[d]&&b();delete Fi[d]};
c.src=a};
g.Gi=function(a,b){a=a||"";var c=a.match(hba);spf.style.load(a,c?c[1]:"",b)};
iba=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Hi(a)||c.some(function(e){return!Hi(e)}))throw Error("Only objects may be merged.");
c=g.da(c);for(d=c.next();!d.done;d=c.next())Ii(a,d.value)};
Ii=function(a,b){for(var c in b)if(Hi(b[c])){if(c in a&&!Hi(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});Ii(a[c],b[c])}else if(Ji(b[c])){if(c in a&&!Ji(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Ki(a[c],b[c])}else a[c]=b[c];return a};
Ki=function(a,b){for(var c=g.da(b),d=c.next();!d.done;d=c.next())d=d.value,Hi(d)?a.push(Ii({},d)):Ji(d)?a.push(Ki([],d)):a.push(d);return a};
Hi=function(a){return"object"===typeof a&&!Array.isArray(a)};
Ji=function(a){return"object"===typeof a&&Array.isArray(a)};
g.Li=function(a,b,c){var d=g.E("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=g.sf(window.location.href);e&&d.push(e);e=g.sf(a);if(g.Ma(d,e)||!e&&g.qb(a,"/"))if(g.qg("autoescape_tempdata_url")&&(d=document.createElement("a"),g.hc(d,a),a=d.href),a&&(a=g.tf(a),d=a.indexOf("#"),a=0>d?a:a.substr(0,d))){if(b.itct||b.ved)b.csn=b.csn||g.ri();c?(c=parseInt(c,10),isFinite(c)&&0<c&&(a="ST-"+g.pc(a).toString(36),b=b?g.yf(b):"",g.Qh(a,b,c||5))):(c="ST-"+g.pc(a).toString(36),b=b?g.yf(b):"",g.Qh(c,b,5))}};
g.Mi=function(a){var b=void 0===b?{}:b;var c=void 0===c?"":c;var d=void 0===d?window:d;g.jc(d.location,g.zf(a,b)+c)};
g.Ni=function(a,b){b&&g.Li(a,b);(window.ytspf||{}).enabled?spf.navigate(a):g.Mi(a)};
g.Oi=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=g.E("EVENT_ID");d&&(b.ei||(b.ei=d));b&&g.Li(a,b);if(c)return!1;g.Ni(a);return!0};
Qi=function(a,b){g.C.call(this);this.H=this.qa=a;this.O=b;this.L=!1;this.api={};this.aa=this.X=null;this.J=new g.Ve;g.xd(this,this.J);this.D={};this.la=this.ia=this.F=this.ob=this.C=null;this.V=!1;this.G=this.N=null;this.wa={};this.ub=["onReady"];this.Za=null;this.qb=NaN;this.W={};Pi(this);this.Ci("WATCH_LATER_VIDEO_ADDED",this.cH.bind(this));this.Ci("WATCH_LATER_VIDEO_REMOVED",this.dH.bind(this));this.Ci("onAdAnnounce",this.bw.bind(this));this.yb=new hh(this);g.xd(this,this.yb)};
Ri=function(a){a.C.loaded||(a.C.loaded=!0,"0"!=a.C.args.autoplay?a.api.loadVideoByPlayerVars(a.C.args):a.api.cueVideoByPlayerVars(a.C.args))};
Xi=function(a){var b=!0,c=Si(a);c&&a.C&&(a=a.C,b=g.F(c,"version")==a.assets.js);return b&&!!g.r("yt.player.Application.create")};
jba=function(a){if(!a.sb()&&!a.V){var b=Xi(a);if(b&&"html5"==(Si(a)?"html5":null))a.la="html5",a.L||Yi(a);else if(Zi(a),a.la="html5",b&&a.G)a.qa.appendChild(a.G),Yi(a);else{a.C.loaded=!0;var c=!1;a.N=function(){c=!0;var d=a.C.clone();g.r("yt.player.Application.create")(a.qa,d);Yi(a)};
a.V=!0;b?a.N():(g.cg(a.C.assets.js,a.N),g.Gi(a.C.assets.css),$i(a)&&!c&&g.p("yt.player.Application.create",null,void 0))}}};
Si=function(a){var b=g.y(a.F);!b&&a.H&&a.H.querySelector&&(b=a.H.querySelector("#"+a.F));return b};
Yi=function(a){if(!a.sb()){var b=Si(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.V=!1,b.isNotServable&&b.isNotServable(a.C.args.video_id)||kba(a)):a.qb=g.Rf(function(){Yi(a)},50)}};
kba=function(a){Pi(a);a.L=!0;var b=Si(a);b.addEventListener&&(a.X=aj(a,b,"addEventListener"));b.removeEventListener&&(a.aa=aj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=aj(a,b,e))}for(var f in a.D)a.X(f,a.D[f]);Ri(a);a.ia&&a.ia(a.api);a.J.oa("onReady",a.api)};
aj=function(a,b,c){var d=b[c];return function(){try{return a.Za=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Za=e,g.Of(e))}}};
Pi=function(a){a.L=!1;if(a.aa)for(var b in a.D)a.aa(b,a.D[b]);for(var c in a.W)g.Tf(parseInt(c,10));a.W={};a.X=null;a.aa=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Ci.bind(a);a.api.removeEventListener=a.tL.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.dy.bind(a);a.api.getPlayerType=a.xy.bind(a);a.api.getCurrentVideoConfig=a.Gx.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.VC.bind(a)};
bj=function(a,b){var c=b;if("string"==typeof b){if(a.wa[b])return a.wa[b];c=function(){var d=g.r(b);d&&d.apply(g.n,arguments)};
...
g.$a(a.W,String(e),!0)};
return c};
Zi=function(a){a.cancel();Pi(a);a.la=null;a.C&&(a.C.loaded=!1);var b=Si(a);b&&(Xi(a)||!$i(a)?a.G=b:(b&&b.destroy&&b.destroy(),a.G=null));g.cd(a.qa)};
$i=function(a){return a.C&&a.C.args&&a.C.args.fflags?-1!=a.C.args.fflags.indexOf("player_destroy_old_version=true"):!1};
g.ej=function(a,b){a=g.va(a)?g.Tc(a):a;var c=g.cj+"_"+g.Ga(a),d=g.dj[c];if(d)return d.loadNewVideoConfig(b),d.api;d=new Qi(a,c);g.dj[c]=d;g.G("player-added",d.api);g.ud(d,g.v(mba,d));g.Rf(function(){d.loadNewVideoConfig(b)},0);
return d.api};
mba=function(a){delete g.dj[a.getId()]};
g.fj=function(a){if(!a)return null;var b=g.cj+"_"+g.Ga(a),c=g.dj[b];c||(c=new Qi(a,b),g.dj[b]=c);return c.api};
g.gj=function(a){return g.fj(document.getElementById(a))};
g.hj=function(a,b){this.version=a;this.args=b};
g.ij=function(a,b){this.topic=a;this.C=b};
g.kj=function(a,b){var c=g.jj();c&&c.publish.call(c,a.toString(),a,b)};
g.jj=function(){return g.r("ytPubsub2Pubsub2Instance")};
g.mj=function(a,b){var c={};c.key=a;c.value=b;return lj().then(function(d){return new Promise(function(e,f){var k=d.transaction("swpushnotificationsstore","readwrite").objectStore("swpushnotificationsstore").put(c);k.onsuccess=e;k.onerror=f})})};
g.nj=function(a){return lj().then(function(b){return new Promise(function(c,d){var e=b.transaction("swpushnotificationsstore").objectStore("swpushnotificationsstore").get(a);e.onsuccess=function(){var f=e.result;c(f?f.value:null)};
e.onerror=function(){d('Unable to get key "'+a+'" from object store.')}})},function(){return null})};
lj=function(){return oj?Promise.resolve(oj):new Promise(function(a,b){var c=self.indexedDB.open("swpushnotificationsdb");c.onerror=b;c.onsuccess=function(){var d=c.result;if(d.objectStoreNames.contains("swpushnotificationsstore"))oj=d,a(oj);else return self.indexedDB.deleteDatabase("swpushnotificationsdb"),lj()};
...
oba=function(a){if(pj.getEntriesByType){var b=pj.getEntriesByType("paint");if(b=g.Ka(b,function(d){return"first-paint"==d.name}))return Math.round(a.navigationStart+b.startTime)}if(a.msFirstPaint)return Math.max(0,a.msFirstPaint);
...
qj=function(){var a=g.E("TIMING_TICK_EXPIRATION");a||(a={},g.Jf("TIMING_TICK_EXPIRATION",a));return a};
rj=function(){var a=qj(),b;for(b in a)g.lg(a[b]);g.Jf("TIMING_TICK_EXPIRATION",{})};
sj=function(a,b){g.hj.call(this,1,arguments)};
tj=function(a,b){g.hj.call(this,1,arguments)};
tba=function(){uj=!1;var a=g.E("TIMING_INFO",{});for(b in a)vj(b,a[b]);vj("is_nav",1);(a=g.ri())&&vj("csn",a);(a=g.E("PREVIOUS_ACTION",void 0))&&vj("pa",a);var b=wj();b.p=g.E("CLIENT_PROTOCOL")||"unknown";b.t=g.E("CLIENT_TRANSPORT")||"unknown";vj("yt_vis",pba());if("cold"==b.yt_lt){a=pj.timing||{};a.navigationStart&&(xj("srt",a.responseStart),1!=b.prerender&&yj("n",a.navigationStart));b=oba(a);0<b&&xj("fpt",b);zj(a);pj.getEntriesByType&&qba();a=[];if(document.querySelector&&pj&&pj.getEntriesByName)for(var c in Aj)b=
Aj[c],rba(c,b)&&a.push(b);a.length&&vj("rc",a.join(","))}Bj(void 0)&&(c={},c.actionType=sba[g.E("TIMING_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN",a=Cj(void 0),ci(c,a));if("cold"==wj().yt_lt){a=Dj();c=Ej();for(var d in a)g.qb(d,"_")||"tick_"+d in c||Fj(d,a[d]);d=wj();for(var e in d)"info_"+e in c||Gj(e,d[e])}Hj(!0);g.Ij(!1)};
Lj=function(){Jj(void 0);uba();Kj(!1,void 0);g.E("TIMING_ACTION")&&g.Jf("PREVIOUS_ACTION",g.E("TIMING_ACTION"));g.Jf("TIMING_ACTION","")};
xj=function(a,b,c){b||"_"==a[0]||Mj(a,c);var d=Dj(c),e=b||g.xh();d[a]&&(d["_"+a]=d["_"+a]||[d[a]],d["_"+a].push(e));d[a]=e;e=qj();var f=e[a];f&&(g.lg(f),e[a]=0);Fj(a,b,c)||g.Ij(!1,c);return d[a]};
Mj=function(a,b){pj.mark&&(g.qb(a,"mark_")||(a="mark_"+a),b&&(a+=" ("+b+")"),pj.mark(a))};
yj=function(a,b){vj("yt_sts",a,void 0);xj("_start",b,void 0)};
vj=function(a,b,c){wj(c)[a]=b;Bj(c)&&Gj(a,b,c)};
Gj=function(a,b,c){Ej(c)["info_"+a]=b;if(a in Nj){var d=Nj[a];g.Ma(vba,d)&&(b=!!b);a in Oj&&(b=Oj[a]+b.toUpperCase());a={};d=d.split(".");for(var e=a,f=0;f<d.length-1;f++)e[d[f]]=e[d[f]]||{},e=e[d[f]];e[d[d.length-1]]=b;Bj(c)&&(iba(Pj(c),a),b=Cj(c),ci(a,b))}else g.Ma(wba,a)||(b=Error("Unknown label logged with GEL CSI"),b.params=a,g.Of(b))};
Qj=function(a){var b=Dj(a);if(b.aft)return b.aft;a=g.E((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN};
zj=function(a,b){xj("nreqs",a.requestStart,b);xj("nress",a.responseStart,b);xj("nrese",a.responseEnd,b);0<a.redirectEnd-a.redirectStart&&(xj("nrs",a.redirectStart,b),xj("nre",a.redirectEnd,b));0<a.domainLookupEnd-a.domainLookupStart&&(xj("ndnss",a.domainLookupStart,b),xj("ndnse",a.domainLookupEnd,b));0<a.connectEnd-a.connectStart&&(xj("ntcps",a.connectStart,b),xj("ntcpe",a.connectEnd,b));a.secureConnectionStart>=a.navigationStart&&0<a.connectEnd-a.secureConnectionStart&&(xj("nstcps",a.secureConnectionStart,
b),xj("ntcpe",a.connectEnd,b))};
g.Ij=function(a,b){if(!Rj(b)){var c=g.E((b||"")+"TIMING_ACTION",void 0),d=Dj(b);if(g.r("ytglobal.timing"+(b||"")+"ready_")&&c&&d._start&&(c=Qj(b)))if(Sj||(g.kj(xba,new sj(Math.round(c-d._start),b)),Sj=!0),a||b)Tj(b);else{c=!0;var e=g.E("TIMING_WAIT",[]);if(e.length)for(var f=0,k=e.length;f<k;++f)if(!(e[f]in d)){c=!1;break}c&&Tj(b)}}};
...
Uj=function(a){if(!Rj(void 0)){var b=g.E("CSI_SERVICE_NAME","youtube");g.E("TIMING_ACTION",void 0)&&b&&(xj("aa",void 0,void 0),vj("ap",1,void 0),vj("yt_fss",a,void 0),Tj(void 0))}};
Fj=function(a,b,c){Ej(c)["tick_"+a]=b;c||b||g.xh();return Bj(c)?(c=Cj(c),"_start"==a?bi("baseline_"+c)||g.Xh("latencyActionBaselined",{clientActionNonce:c},b):bi("tick_"+a+"_"+c)||g.Xh("latencyActionTicked",{tickName:a,clientActionNonce:c},b),!0):!1};
Vj=function(a){return Math.round(pj.timing.navigationStart+a)};
qba=function(){var a=window.location.protocol,b=pj.getEntriesByType("resource");b=(0,g.Wj)(b,function(c){return 0==c.name.indexOf(a+"//web.archive.org/web/20190601000228/https://fonts.gstatic.com/s/")});
(b=(0,g.Ef)(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(xj("wffs",Vj(b.startTime)),xj("wffe",Vj(b.responseEnd)))};
rba=function(a,b){var c=document.querySelector(a);if(!c)return!1;var d="",e=c.nodeName;"SCRIPT"==e?(d=c.src,d||(d=c.getAttribute("data-timing-href"))&&(d=window.location.protocol+d)):"LINK"==e&&(d=c.href);return d?(c=pj.getEntriesByName(d))&&c[0]&&(c=c[0],d=window.performance.timing.navigationStart,xj("rsf_"+b,d+Math.round(c.fetchStart)),xj("rse_"+b,d+Math.round(c.responseEnd)),void 0!==c.transferSize&&(d=wj(void 0),e=Pj(void 0),"rc"in d||"rc"in e||vj("rc",""),0===c.transferSize))?!0:!1:!1};
Hj=function(a){g.p("ytglobal.timingready_",a,void 0)};
Cj=function(a){var b=Xj(a).nonce;b||(b=gi(),Xj(a).nonce=b);return b};
Dj=function(a){return Xj(a).tick};
wj=function(a){return Xj(a).info};
Pj=function(a){a=Xj(a);"gelInfo"in a||(a.gelInfo={});return a.gelInfo};
Ej=function(a){a=Xj(a);"gel"in a||(a.gel={});return a.gel};
Xj=function(a){return g.r("ytcsi."+(a||"")+"data_")||Jj(a)};
Jj=function(a){var b={tick:{},info:{}};g.p("ytcsi."+(a||"")+"data_",b,void 0);return b};
Rj=function(a){return!!g.r("yt.timing."+(a||"")+"pingSent_")};
Kj=function(a,b){g.p("yt.timing."+(b||"")+"pingSent_",a,void 0)};
yba=function(a){var b=Dj(a),c=b.pbr,d=b.vc;b=b.pbs;return c&&d&&b&&c<d&&d<b&&1==wj(a).yt_pvis};
Bj=function(a){return uj||g.qg("csi_on_gel")||!!Xj(a).useGel};
Tj=function(a){rj();if(!Bj(a)){var b=Dj(a),c=wj(a),d=b._start;for(k in b)if(g.qb(k,"_")&&g.Ba(b[k])){var e=k.slice(1);if(e in zba){var f=(0,g.Yj)(b[k],function(u){return Math.round(u-d)});
c["all_"+e]=f.join()}delete b[k]}f=g.E("CSI_SERVICE_NAME","youtube");var k={v:2,s:f,action:g.E((a||"")+"TIMING_ACTION",void 0)};e=vj.srt;void 0!==b.srt&&delete c.srt;if(c.h5jse){var l=window.location.protocol+g.r("ytplayer.config.assets.js");(l=pj.getEntriesByName?pj.getEntriesByName(l)[0]:null)?c.h5jse=Math.round(c.h5jse-l.responseEnd):delete c.h5jse}b.aft=Qj(a);yba(a)&&"youtube"==f&&(vj("yt_lt","hot_bg",a),f=b.vc,l=b.pbs,delete b.aft,c.aft=Math.round(l-f));for(var m in c)"_"!=m.charAt(0)&&(k[m]=
c[m]);b.ps=g.xh();m={};f=[];for(var q in b)"_"!=q.charAt(0)&&(l=Math.round(b[q]-d),m[q]=l,f.push(q+"."+l));k.rt=f.join(",");(b=g.r("ytdebug.logTiming"))&&b(k,m);Aba(k,!!c.ap,a);g.kj(Bba,new tj(m.aft+(e||0),a))}};
Aba=function(a,b,c){if(g.qg("debug_csi_data")){var d=g.r("yt.timing.csiData");d||(d=[],g.p("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;Di(a,f)||g.Ei(a,void 0,void 0,void 0,f)}else g.Ei(a);Kj(!0,c)};
Hba=function(){Zj++;var a=g.Xc(),b=new g.id(0,0,a.width,a.height);ak("vph",a.height);ak("vpw",a.width);(0,g.bk)("vpc");a=document.querySelectorAll(".yt-lockup-thumbnail img[data-ytimg]");var c=a.length,d=[],e=!0;ck.start();for(var f=0;f<c;f++){var k=a[f];if(dk(k,b)){var l=Cba(k);l.then(Dba);d.push(l);ek.push(l);k.loadTime||(e=!1)}}e&&ak("yt_eil",1);(0,g.bk)("vpcc");b=g.se(d).then(Eba);g.ue(b,Fba);b.then(Gba);ek.push(b);return b};
Gba=function(){ck.stop()};
Fba=function(){(0,g.bk)("vpr")};
dk=function(a,b){for(var c=a,d=[];c!=document.body;){var e=g.Ug(c);if(e in fk)return!0;if(e in gk)return!1;var f=window.getComputedStyle(c);if("none"==f.display||"hidden"==f.visibility)return gk[e]=!0,!1;f=c.getBoundingClientRect();if(!(b.left<=f.left+f.width&&f.left<=b.left+b.width&&b.top<=f.top+f.height&&f.top<=b.top+b.height))return gk[e]=!0,!1;d.push(e);c=c.parentElement}for(c=0;c<d.length;c++)fk[d[c]]=!0;return!0};
Eba=function(a){var b=g.Xc();b=new g.id(0,0,b.width,b.height);for(var c=0,d=0,e=a.length;d<e;d++){var f=a[d].time;dk(a[d].MB,b)&&c<f&&(c=f)}return c};
Cba=function(a){var b=Zj;return new g.ne(function(c,d){var e={MB:a,time:0};a.loadTime?(e.time=parseInt(a.loadTime,10),c(e)):(a.slt=function(){Zj!=b?d():(e.time=parseInt(a.loadTime,10),c(e),a.slt=void 0)},hk.push(a))})};
Dba=function(a){ck.start();a=a.time;ik<a&&(ik=a,(0,g.bk)("lim",a))};
Iba=function(){(0,g.bk)("vptl",ik);(0,g.bk)("vpl",ik)};
Jba=function(){ek.forEach(function(a){a.cancel()});
ik=ek.length=0;fk={};gk={};hk.forEach(function(a){a.slt=void 0});
hk.length=0};
g.jk=function(a,b){g.Ei("/gen_204?"+a,b)};
Kba=function(a){if(null==a)return[];var b=[];g.qg("ima_prevent_mpu_queries_on_cached_playback")&&0>kk.indexOf("ad3_module")&&kk.push("ad3_module");kk.forEach(function(c){c in a&&(delete a[c],b.push(c))});
a.cached_load="1";return b};
g.lk=function(){return g.D(g.y("page-container"),"remote-connected")};
Lba=function(){mk=g.Sf(nk,5E3);var a=g.ok();a?(a.addEventListener("onReady",nk),a.addEventListener("onStateChange",nk)):pk("unable to init PP monitor")};
rk=function(a){for(var b in g.dj){var c=g.dj[b];c&&c.cancel()}if(a=a||null)qk="",g.ej("player-api",a),a=g.jh(a),a.loaded=!0;nk();g.p("ytplayer.config",a,void 0)};
g.ok=function(){return g.gj("player-api")};
nk=function(){var a=g.ok();if(a){var b=g.y("player");b=!b||g.D(b,"off-screen");var c=1==(a&&a.isReady()?a.getPlayerState():void 0),d="watch"==g.E("PAGE_NAME"),e=g.lk();!c||d||e||(pk("PP playing off watch (paused)"),a.pauseVideo());b&&d?pk("PP off-screen on watch"):b||d||pk("PP !off-screen off watch")}};
pk=function(a){var b=g.E("PAGE_NAME");b&&(Error(a).params=[b,qk,g.r("_spf_state.nav-counter")],g.p("yt.www.persistentplayer.issue",a,void 0),g.Mf(Error(a),"WARNING"))};
tk=function(){(0,g.bk)("ol");window.requestAnimationFrame&&!document.hidden?window.requestAnimationFrame(function(){setTimeout(function(){(0,g.bk)("cpt");g.G("on_cpt_tick",(new Date).getTime())},0)}):document.hidden?((0,g.bk)("cpt"),g.G("on_cpt_tick",(new Date).getTime())):setTimeout(function(){(0,g.bk)("cpt");
g.G("on_cpt_tick",(new Date).getTime())},0);
Mba();g.E("CSI_VIEWPORT")&&(sk=Hba(),sk.then(function(a){(0,g.bk)("vpl",a);sk=null},function(){}))};
Mba=function(){uk("init");var a=g.E("PAGE_NAME",void 0);a&&uk("init-"+a)};
uk=function(a){g.og()?vk.push(g.kg(g.v(g.ag,a),0)):g.G(a)};
wk=function(){g.mg(vk);vk.length=0;Jba();sk&&(sk.cancel(),sk=null);var a=g.E("PAGE_NAME",void 0);a&&g.ag("dispose-"+a);g.ag("dispose")};
Nba=function(){tk()};
Oba=function(){g.E("TIMING_REPORT_ON_UNLOAD")&&g.Ij(!0);Uj("u");g.li("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND");ti();g.Yh();g.uh();wk();g.ag("pageunload")};
xk=function(){g.Hh()};
yk=function(){window.yt_spf_loaded_history=!0;g.Hh()};
Dk=function(){zk=1;Ak=Bk=0;g.E("TIMING_REPORT_ON_UNLOAD")&&g.Ij(!0);g.qg("warm_load_nav_start_web")?(Uj("n"),Lj(),Hj(!1),g.Jf("TIMING_AFT_KEYS",[]),vj("yt_lt","warm"),g.Jf("TIMING_ACTION",""),g.Jf("TIMING_WAIT",[]),rj(),yj("n")):(Uj("n"),Lj(),yj("n"));Mj("nr");Ck(Pba);ti();g.ag("navigate")};
Hk=function(a){a=a.detail.part||a.detail.partial;(0,g.bk)("nc"+Bk);++Bk;if(a&&a.data&&a.data.deferDispose)"watch"==a.name&&(0,g.bk)("bc");else{var b=1==zk;zk=2;b?(Ck(Qba),Ek()):Ck(Rba);if(b=a&&a.data&&a.data.swfcfg)Fk(a.timing,b.args),Gk(b)}};
Ik=function(){(0,g.bk)("np"+Ak);++Ak};
Kk=function(a){a=a.detail.response;var b=1==zk;zk=3;b&&(Ck(Sba),Ek());if(b=a.data&&a.data.swfcfg)Fk(a.timing,b.args),Gk(b)};
Ok=function(a){(0,g.bk)("nd");a=a.detail.response;g.Lk=a.cacheKey;a=a.timing;var b=window._spf_state;g.Mk.navigationCount=b&&b["nav-counter"]||0;g.qg("warm_load_nav_start_web")?(0,g.bk)("srt",a.responseStart):(yj("ne",a.responseStart),ak("srt",Math.max(0,a.responseStart-a.navigationStart)));ak("yt_lt",a.spfCached?"hot":"warm");(0,g.bk)("pfs",a.fetchStart);(0,g.bk)("pfrs",a.responseStart);"redirectStart"in a&&Tba(a);Ck(Nk);document.getElementById("content").style.height="";tk();zk=0};
Pk=function(a){var b=a.detail.url;if(a=a.detail.err)a.message&&(a.message+=" (url: "+b+")"),g.Mf(a)};
Qk=function(a){g.jk(g.yf({spfreload:"1",url:a.detail.url,reason:a.detail.reason}))};
Vba=function(){Uba();window.yt_spf_loaded_history=!1};
Wba=function(){};
Ek=function(){var a=document.getElementById("content");-1<a.className.indexOf("spf-animate")&&(a.style.height=a.clientHeight+"px");wk();a=g.E("PREVIOUS_ACTION");for(var b in g.If)delete g.If[b];g.Jf("PREVIOUS_ACTION",a);g.Jf("SERVED_VIA_SPF_HISTORY",!!window.yt_spf_loaded_history);g.p("ytplayer.config",null,void 0);(b=g.ok())&&b.stopVideo?(b.stopVideo(),b.getLastError()&&((b=document.getElementById("movie_player"))&&b.stopVideo?(b.stopVideo(),qk="recovered"):qk="missing2")):qk="missing";nk()};
Gk=function(a){"cfg"in Dj(void 0)||(0,g.bk)("cfg");rk(a)};
Ck=function(a){var b=document.getElementById("progress");b||(b=document.createElement("div"),b.id="progress",b.appendChild(document.createElement("dt")),b.appendChild(document.createElement("dd")),document.body.appendChild(b));g.lg(Rk);Rk=g.kg(function(){var c=a[0],d=a[1],e=a[2];b.className="";var f=b.style;f.transitionDuration=f.webkitTransitionDuration=c+"ms";f.width=d+"%";g.Tf(Sk);Sk=g.Rf(function(){b.className=e},c)},0)};
Uba=function(){var a=Nk[0]+50;g.Tf(Sk);Sk=g.Rf(function(){var b=document.getElementById("progress");b&&b.parentNode.removeChild(b)},a)};
Fk=function(a,b){var c=a&&a.spfCached,d=a&&a.spfPrefetched,e=[];c&&!d&&null!=b&&(e=Kba(b));g.E("EXP_DEBUG_PREFETCH")&&(e.sort(),c={a:"updatePlayerVarsForCachedLoad",cached:c,prefetched:d,deleted:e.join("")},g.jk(g.yf(c)))};
Uk=function(){return"granted"!=Notification.permission?Promise.resolve():Tk().then(function(a){return a?a.pushManager.getSubscription().then(function(b){return b?Promise.resolve():a.pushManager.subscribe({userVisibleOnly:!0}).then(function(){return Promise.resolve()},function(){return Promise.resolve()})}):Promise.resolve()})["catch"](function(){})};
Wk=function(){Vk({type:"notifications_register",data:g.E("ID_TOKEN")})};
Tk=function(){return navigator.serviceWorker.getRegistration(String(pg("service_worker_scope")||""))};
Xk=function(a){return!(!a||!a.pushManager)};
Vk=function(a){Tk().then(function(b){if(!b||!b.active)return Promise.reject();b.active.postMessage(a);return Promise.resolve()})};
Xba=function(){if(!g.E("LOGGED_IN",void 0))return Promise.resolve(!1);var a=String(pg("service_worker_push_force_notification_prompt_tag")||"");return a?g.nj("PromptTags").then(function(b){if(!b)return!0;var c=[];try{c=JSON.parse(b)}catch(d){return!1}return c&&-1==c.indexOf(a)}):Promise.resolve(!1)};
aca=function(){var a=void 0===a?!1:a;return(navigator.serviceWorker&&navigator.serviceWorker.getRegistration&&window.Notification?Tk().then(Xk):Promise.resolve(!1)).then(function(b){if(!b)return Promise.resolve();b=Uk().then(function(){Vk({type:"notifications_check_registration",data:g.E("ID_TOKEN")})});
...
dca=function(){var a=g.rg("service_worker_push_logged_out_prompt_watches");return-1==a?Promise.resolve(!1):g.nj("WatchCount").then(function(b){return b>=a})};
$ba=function(){var a=arguments;g.qg("service_worker_push_prompt_modal_enable")&&eca();return Notification.requestPermission().then(function(b){Yk();var c=document.getElementById("ticker");c&&(c.className=c.classList.remove("show"));if("granted"==b)return Uk().then(function(){g.mj("NotificationsDisabled",!1);Wk();return Promise.resolve(!0)});
"denied"==b&&Wk();return Promise.resolve(!1)})["catch"](function(){Yk();
return Promise.reject.apply(Promise,a instanceof Array?a:aaa(g.da(a)))})};
Zba=function(){g.nj("PromptCount").then(function(a){return g.mj("PromptCount",a+1)}).then(function(){return g.mj("PromptTime",(0,g.Nc)())}).then(function(){var a=String(pg("service_worker_push_force_notification_prompt_tag")||"");
if(a)return g.nj("PromptTags").then(function(b){var c=[];if(b)try{c=JSON.parse(b)}catch(d){return!1}c||(c=[]);c.push(a);return g.mj("PromptTags",JSON.stringify(c))})})};
bca=function(){return-1==g.rg("service_worker_push_prompt_cap")?Promise.resolve(!0):g.nj("PromptCount").then(function(a){a||(a=0);return Promise.resolve(a<g.rg("service_worker_push_prompt_cap"))})};
cca=function(){var a=g.rg("service_worker_push_prompt_delay_microseconds");return a?g.nj("PromptTime").then(function(b){return Promise.resolve((0,g.Nc)()-a>(b||0))}):Promise.resolve(!0)};
fca=function(){Zk||Yk()};
$k=function(a){a.style.zIndex=2147483648;a.style.pointerEvents="auto";a.style.backgroundColor="rgba(0, 0, 0, 0.6)";a.style.width="100%";a.style.height="100vh";a.style.position="absolute";a.style.top="0";a.style.left="0";a.style.border="none"};
eca=function(){var a=g.y("yt-push-prompt-modal-bg");Zk=g.qg("service_worker_push_prompt_modal_ignore_click");a?$k(a):(a=g.$c("div",{id:"yt-push-prompt-modal-bg"}),$k(a),document.body.appendChild(a),g.eh(document,"click",fca))};
Yk=function(){var a=g.y("yt-push-prompt-modal-bg");a&&g.dd(a)};
gca=function(a){return Xk(a)?aca():Promise.resolve()};
ica=function(){navigator.serviceWorker.getRegistrations().then(function(a){a.forEach(hca)})};
kca=function(){var a="/sw.js",b=g.E("SERVICE_WORKER_VFL",void 0);b&&(a+="?vfl="+b);a=al(a);g.qg("service_worker_push_enabled")&&a.then(jca).then(gca)};
...
hca=function(a){a&&al("/sw.js?0",a.scope)};
al=function(a,b){return navigator.serviceWorker.register(a,{scope:b||String(pg("service_worker_scope")||"")||"/"})};
bl=function(){g.ui.call(this,"www/base");this.D=0};
cl=function(a){(a=a.detail.name)&&xi(a)};
g.aa=[];ea="function"==typeof Object.create?Object.create:function(a){function b(){}
b.prototype=a;return new b};
if("function"==typeof Object.setPrototypeOf)dl=Object.setPrototypeOf;else{var el;a:{var lca={a:!0},fl={};try{fl.__proto__=lca;el=fl.a;break a}catch(a){}el=!1}dl=el?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}
var fa=dl,ia="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this,ja="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};
...
var f=new c;b.prototype.V=function(k){var l=this.H();k.Ki(l.resolve,l.reject)};
b.prototype.la=function(k,l){var m=this.H();try{k.call(l,m.resolve,m.reject)}catch(q){m.reject(q)}};
b.prototype.then=function(k,l){function m(B,J){return"function"==typeof B?function(T){try{q(B(T))}catch(X){u(X)}}:J}
var q,u,z=new b(function(B,J){q=B;u=J});
this.Ki(m(k,q),m(l,u));return z};
b.prototype["catch"]=function(k){return this.then(void 0,k)};
b.prototype.Ki=function(k,l){function m(){switch(q.F){case 1:k(q.D);break;case 2:l(q.D);break;default:throw Error("Unexpected state: "+q.F);}}
var q=this;null==this.C?f.F(m):this.C.push(m)};
b.resolve=d;b.reject=function(k){return new b(function(l,m){m(k)})};
b.race=function(k){return new b(function(l,m){for(var q=g.da(k),u=q.next();!u.done;u=q.next())d(u.value).Ki(l,m)})};
b.all=function(k){var l=g.da(k),m=l.next();return m.done?d([]):new b(function(q,u){function z(T){return function(X){B[T]=X;J--;0==J&&q(B)}}
var B=[],J=0;do B.push(void 0),J++,d(m.value).Ki(z(B.length-1),u),m=l.next();while(!m.done)})};
return b});
...
g.gl=g.gl||{};g.n=this||self;Fa="closure_uid_"+(1E9*Math.random()>>>0);caa=0;g.Nc=Date.now||function(){return+new Date};g.hl=document;g.md=window;g.w(g.Ha,Error);g.Ha.prototype.name="CustomError";g.La=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(g.va(a))return g.va(b)&&1==b.length?a.indexOf(b,0):-1;
...
g.Wj=Array.prototype.filter?function(a,b,c){return Array.prototype.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=[],f=0,k=g.va(a)?a.split(""):a,l=0;l<d;l++)if(l in k){var m=k[l];
b.call(c,m,l,a)&&(e[f++]=m)}return e};
g.Yj=Array.prototype.map?function(a,b,c){return Array.prototype.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=g.va(a)?a.split(""):a,k=0;k<d;k++)k in f&&(e[k]=b.call(c,f[k],k,a));
return e};
...
return e};
g.il=Array.prototype.some?function(a,b,c){return Array.prototype.some.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=g.va(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&b.call(c,e[f],f,a))return!0;
return!1};
g.jl=Array.prototype.every?function(a,b,c){return Array.prototype.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=g.va(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&!b.call(c,e[f],f,a))return!1;
return!0};var db="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");g.hb.prototype.fe=!0;g.hb.prototype.cd=function(){return this.C};
g.hb.prototype.toString=function(){return"Const{"+this.C+"}"};
var gb={},fb={},uaa=g.jb("");g.pca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.qca=RegExp("^[^\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.kl=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]");g.lb.prototype.fe=!0;g.lb.prototype.cd=function(){return this.F.toString()};
...
tb=/&/g;ub=/</g;vb=/>/g;wb=/"/g;xb=/'/g;yb=/\x00/g;faa=/[\x00&<>"']/;g.Fb.prototype.fe=!0;g.Fb.prototype.cd=function(){return this.F.toString()};
g.Fb.prototype.im=!0;g.Fb.prototype.C=function(){return 1};
var haa=/^(?:audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-wav|wav|webm)|image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|text\/csv|video\/(?:mpeg|mp4|ogg|webm|quicktime))(?:;\w+=(?:\w+|"[\w;=]+"))*$/i,gaa=/^data:([^,]*);base64,[a-z0-9+\/]+=*$/i,Kb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,Eb={};g.Ib("about:blank");g.Ob.prototype.fe=!0;g.Nb={};g.Ob.prototype.cd=function(){return this.C};
g.ll=g.Pb("");g.ml=RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))","g");g.nl=RegExp("\\b(hsl|hsla|rgb|rgba|matrix|calc|minmax|fit-content|repeat|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-+*/0-9a-z.%\\[\\], ]+\\)","g");g.Rb.prototype.fe=!0;g.Qb={};g.Rb.prototype.cd=function(){return this.C};
g.ol=g.Sb("");a:{var pl=g.n.navigator;if(pl){var ql=pl.userAgent;if(ql){g.Tb=ql;break a}}g.Tb=""};g.ac.prototype.im=!0;g.ac.prototype.C=function(){return this.D};
g.ac.prototype.fe=!0;g.ac.prototype.cd=function(){return this.F.toString()};
var $b={};g.fc("<!DOCTYPE html>",0);g.ae=g.fc("",0);g.rl=g.fc("<br>",0);g.rca=g.Ta(function(){var a=document.createElement("div"),b=document.createElement("div");b.appendChild(document.createElement("div"));a.appendChild(b);b=a.firstChild.firstChild;a.innerHTML=g.bc(g.ae);return!b.parentElement});g.nc=String.prototype.repeat?function(a,b){return a.repeat(b)}:function(a,b){return Array(b+1).join(a)};g.sc[" "]=g.ya;g.x={Gk:!1,Fk:!1,Yn:!1,co:!1,Ik:!1,Jk:!1,Gv:!1};g.x.hh=g.x.Gk||g.x.Fk||g.x.Yn||g.x.Ik||g.x.co||g.x.Jk;g.x.dd=function(){return g.Tb};
g.x.Jl=function(){return g.n.navigator||null};
g.x.UW=function(){return g.x.Jl()};
g.x.Qb=g.x.hh?g.x.Jk:g.Ub("Opera");g.x.ma=g.x.hh?g.x.Gk:g.Vb();g.x.mc=g.x.hh?g.x.Fk:g.Ub("Edge");g.x.Kk=g.x.mc||g.x.ma;g.x.Bb=g.x.hh?g.x.Yn:g.Ub("Gecko")&&!(g.Ab(g.Tb,"WebKit")&&!g.Ub("Edge"))&&!(g.Ub("Trident")||g.Ub("MSIE"))&&!g.Ub("Edge");g.x.lb=g.x.hh?g.x.co||g.x.Ik:g.Ab(g.Tb,"WebKit")&&!g.Ub("Edge");g.x.eC=function(){return g.x.lb&&g.Ub("Mobile")};
g.x.RS=g.x.Ik||g.x.eC();g.x.qg=g.x.lb;g.x.Tw=function(){var a=g.x.Jl();return a&&a.platform||""};
g.x.zT=g.x.Tw();g.x.ao=!1;g.x.eo=!1;g.x.Zn=!1;g.x.ho=!1;g.x.gh=!1;g.x.mg=!1;g.x.lg=!1;g.x.Hk=!1;g.x.Iv=!1;g.x.Hv=!1;g.x.Ed=g.x.ao||g.x.eo||g.x.Zn||g.x.ho||g.x.gh||g.x.mg||g.x.lg||g.x.Hk;g.x.sd=g.x.Ed?g.x.ao:g.Ub("Macintosh");g.x.vo=g.x.Ed?g.x.eo:g.Ub("Windows");g.x.cC=function(){return g.Ub("Linux")||g.Ub("CrOS")};
g.x.Rv=g.x.Ed?g.x.Zn:g.x.cC();g.x.iC=function(){var a=g.x.Jl();return!!a&&-1!=(a.appVersion||"").indexOf("X11")};
g.x.MW=g.x.Ed?g.x.ho:g.x.iC();g.x.ANDROID=g.x.Ed?g.x.gh:g.Ub("Android");g.x.Ai=g.x.Ed?g.x.mg:qc();g.x.zi=g.x.Ed?g.x.lg:g.Ub("iPad");g.x.Pv=g.x.Ed?g.x.Hk:g.Ub("iPod");g.x.IOS=g.x.Ed?g.x.mg||g.x.lg||g.x.Hk:g.rc();g.x.mR=g.x.Ed?g.x.Iv:g.Ab(g.Tb,"KaiOS");g.x.IQ=g.x.Ed?g.x.Hv:g.Ab(g.Tb,"GAFP");g.x.vh=function(){var a="",b=g.x.fz();b&&(a=b?b[1]:"");return g.x.ma&&(b=g.x.Gp(),null!=b&&b>parseFloat(a))?String(b):a};
g.x.fz=function(){var a=g.x.dd();if(g.x.Bb)return/rv:([^\);]+)(\)|;)/.exec(a);if(g.x.mc)return/Edge\/([\d\.]+)/.exec(a);if(g.x.ma)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(g.x.lb)return/WebKit\/(\S+)/.exec(a);if(g.x.Qb)return/(?:Version)[ \/]?(\S+)/.exec(a)};
g.x.Gp=function(){var a=g.n.document;return a?a.documentMode:void 0};
g.x.VERSION=g.x.vh();g.x.compare=function(a,b){return g.Db(a,b)};
g.x.hC={};g.x.fb=function(a){return g.x.Gv||iaa(a,function(){return 0<=g.Db(g.x.VERSION,a)})};
g.x.fd=g.x.fb;g.x.Ac=function(a){return Number(g.x.oo)>=a};
g.x.ZW=g.x.Ac;var sl;var tl=g.n.document;sl=tl&&g.x.ma?g.x.Gp()||("CSS1Compat"==tl.compatMode?parseInt(g.x.VERSION,10):5):void 0;g.x.oo=sl;g.x.product={};g.x.product.Xn=!1;g.x.product.mg=!1;g.x.product.lg=!1;g.x.product.gh=!1;g.x.product.Wn=!1;g.x.product.bo=!1;g.x.product.og=g.x.Gk||g.x.Fk||g.x.Jk||g.x.product.Xn||g.x.product.mg||g.x.product.lg||g.x.product.gh||g.x.product.Wn||g.x.product.bo;g.x.product.Qb=g.x.Qb;g.x.product.ma=g.x.ma;g.x.product.mc=g.x.mc;g.x.product.Lk=g.x.product.og?g.x.product.Xn:Wb();g.x.product.bC=function(){return qc()||g.Ub("iPod")};
g.x.product.Ai=g.x.product.og?g.x.product.mg:g.x.product.bC();g.x.product.zi=g.x.product.og?g.x.product.lg:g.Ub("iPad");g.x.product.ANDROID=g.x.product.og?g.x.product.gh:g.Zb();g.x.product.CHROME=g.x.product.og?g.x.product.Wn:g.Xb();g.x.product.fC=function(){return g.Yb()&&!g.rc()};
g.x.product.qg=g.x.product.og?g.x.product.bo:g.x.product.fC();var wc,vc;wc=null;g.yc=null;vc=null;g.zc.prototype.next=function(){return this.C<this.F.length?{done:!1,value:this.F[this.C++]}:{done:!0,value:void 0}};
...
g.h.set=function(a,b,c,d,e,f){if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');g.ua(c)||(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";f=f?";secure":"";c=0>c?"":0==c?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date((0,g.Nc)()+1E3*c)).toUTCString();this.C.cookie=a+"="+b+e+d+c+f};
...
g.vl=g.ul;g.vl=g.ul;g.h=g.Oc.prototype;g.h.Qe=g.vl.ua;g.h.Ah=g.vl.va;g.h.clone=function(){var a=new g.Oc(this.date);a.Qe=this.Qe;a.Ah=this.Ah;return a};
...
g.h.valueOf=function(){return this.date.valueOf()};var jaa;jaa=!g.x.ma||g.x.Ac(9);g.sca=!g.x.Bb&&!g.x.ma||g.x.ma&&g.x.Ac(9)||g.x.Bb&&g.x.fb("1.9.1");g.wl=g.x.ma&&!g.x.fb("9");g.tca=g.x.ma||g.x.Qb||g.x.lb;g.uca=g.x.ma;g.h=g.Pc.prototype;g.h.clone=function(){return new g.Pc(this.x,this.y)};
...
g.h.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};var Uc={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};var vca={uP:"allow-forms",vP:"allow-modals",wP:"allow-orientation-lock",xP:"allow-pointer-lock",yP:"allow-popups",zP:"allow-popups-to-escape-sandbox",AP:"allow-presentation",BP:"allow-same-origin",CP:"allow-scripts",DP:"allow-top-navigation",EP:"allow-top-navigation-by-user-activation"},laa=g.Ta(function(){return g.hd(vca)});g.h=g.id.prototype;g.h.clone=function(){return new g.id(this.left,this.top,this.width,this.height)};
...
g.yd.prototype.preventDefault=function(){this.Wt=!1};var Pd,xca,saa;g.wca=!g.x.ma||g.x.Ac(9);Pd=!g.x.ma||g.x.Ac(9);xca=g.x.ma&&!g.x.fb("9");saa=function(){if(!g.n.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
...
g.zd.prototype.preventDefault=function(){g.zd.T.preventDefault.call(this);var a=this.yc;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,xca)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};var Ad="closure_listenable_"+(1E6*Math.random()|0),paa=0;g.h=g.Dd.prototype;g.h.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.C++);var k=Fd(a,b,d,e);-1<k?(b=a[k],c||(b.Ji=!1)):(b=new qaa(b,this.src,f,!!d,e),b.Ji=c,a.push(b));return b};
g.h.remove=function(a,b,c,d){a=a.toString();if(!(a in this.listeners))return!1;var e=this.listeners[a];b=Fd(e,b,c,d);return-1<b?(Cd(e[b]),g.Pa(e,b),0==e.length&&(delete this.listeners[a],this.C--),!0):!1};
...
g.h.Eg=g.ba(5);g.h.wf=function(a,b,c,d){a=this.listeners[a.toString()];var e=-1;a&&(e=Fd(a,b,c,d));return-1<e?a[e]:null};
g.h.hasListener=function(a,b){var c=g.ua(a),d=c?a.toString():"",e=g.ua(b);return g.Va(this.listeners,function(f){for(var k=0;k<f.length;++k)if(!(c&&f[k].type!=d||e&&f[k].capture!=b))return!0;return!1})};var Md="closure_lm_"+(1E6*Math.random()|0),Sd={},Od=0,Vd="__closure_events_fn_"+(1E9*Math.random()>>>0);g.w(g.Wd,g.C);g.Wd.prototype[Ad]=!0;g.h=g.Wd.prototype;g.h.ej=function(){return this.Um};
g.h.bi=g.ba(6);g.h.addEventListener=function(a,b,c,d){g.Id(this,a,b,c,d)};
g.h.removeEventListener=function(a,b,c,d){g.Qd(this,a,b,c,d)};
g.h.dispatchEvent=function(a){var b=this.ej();if(b){var c=[];for(var d=1;b;b=b.ej())c.push(b),++d}b=this.dw;d=a.type||a;if(g.va(a))a=new g.yd(a,b);else if(a instanceof g.yd)a.target=a.target||b;else{var e=a;a=new g.yd(d,b);g.eb(a,e)}e=!0;if(c)for(var f=c.length-1;!a.F&&0<=f;f--){var k=a.currentTarget=c[f];e=Xd(k,d,!0,a)&&e}a.F||(k=a.currentTarget=b,e=Xd(k,d,!0,a)&&e,a.F||(e=Xd(k,d,!1,a)&&e));if(c)for(f=0;!a.F&&f<c.length;f++)k=a.currentTarget=c[f],e=Xd(k,d,!1,a)&&e;return e};
...
g.h.Eg=g.ba(4);g.h.wf=function(a,b,c,d){return this.Hd.wf(String(a),b,c,d)};
g.h.hasListener=function(a,b){return this.Hd.hasListener(g.ua(a)?String(a):void 0,b)};Yd.prototype.get=function(){if(0<this.F){this.F--;var a=this.C;this.C=a.next;a.next=null}else a=this.D();return a};var ie;var je=new Yd(function(){return new ce},function(a){a.reset()});
...
g.h.start=function(a){this.stop();this.rb=g.De(this.hc,g.ua(a)?a:this.D)};
g.h.stop=function(){this.isActive()&&g.Ee(this.rb);this.rb=0};
g.h.tf=g.ba(7);g.h.isActive=function(){return 0!=this.rb};
g.h.Sp=function(){this.rb=0;this.C&&this.C.call(this.F)};g.w(Ge,Aaa);Ge.prototype.reset=function(){this.C[0]=1732584193;this.C[1]=4023233417;this.C[2]=2562383102;this.C[3]=271733878;this.C[4]=3285377520;this.H=this.D=0};
Ge.prototype.update=function(a,b){if(null!=a){g.ua(b)||(b=a.length);for(var c=b-this.F,d=0,e=this.L,f=this.D;d<b;){if(0==f)for(;d<=c;)He(this,a,d),d+=this.F;if(g.va(a))for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.F){He(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.F){He(this,e);f=0;break}}this.D=f;this.H+=b}};
...
g.h.Dd=function(a){var b=this.C[a];if(b){var c=this.F[b];0!=this.G?(this.D.push(a),this.C[a+1]=g.ya):(c&&g.Qa(c,a),delete this.C[a],delete this.C[a+1],delete this.C[a+2])}return!!b};
...
g.h.Y=function(){g.Ve.T.Y.call(this);this.clear();this.D.length=0};g.Xe.prototype.set=function(a,b){g.ua(b)?this.C.set(a,g.Se(b)):this.C.remove(a)};
...
Ye.prototype.F=function(a){a=Ye.T.get.call(this,a);if(!g.ua(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
Ye.prototype.get=function(a){if(a=this.F(a)){if(a=a.data,!g.ua(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};g.w(g.bf,Ye);g.bf.prototype.set=function(a,b,c){if(b=af(b)){if(c){if(c<(0,g.Nc)()){g.bf.prototype.remove.call(this,a);return}b.expiration=c}b.creation=(0,g.Nc)()}g.bf.T.set.call(this,a,b)};
...
g.h.ud=function(a){var b=0,c=this.C,d=new g.Je;d.next=function(){if(b>=c.length)throw g.Ke;var e=c.key(b++);if(a)return e;e=c.getItem(e);if(!g.va(e))throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
g.h.get=function(a){a=this.C.getAttribute(jf(a));if(!g.va(a)&&null!==a)throw"Storage mechanism: Invalid value was encountered";return a};
g.h.remove=function(a){this.C.removeAttribute(jf(a));kf(this)};
g.h.Pb=function(){return lf(this).attributes.length};
g.h.ud=function(a){var b=0,c=lf(this).attributes,d=new g.Je;d.next=function(){if(b>=c.length)throw g.Ke;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if(!g.va(e))throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
Df.prototype.get=function(a){return!!this.C[a]};g.xh=window.performance&&window.performance.timing&&window.performance.now?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};
...
g.eg.prototype.ge=function(){return!!this.C};
...
g.p("yt.ads_.signals_.getAdSignalsString",function(){return g.tg(g.Ag())},void 0);(0,g.Nc)();var Cg=g.ua(XMLHttpRequest)?function(){return new XMLHttpRequest}:g.ua(ActiveXObject)?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;var Fg,Saa,Kg;Fg={Authorization:"AUTHORIZATION","X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};Saa="app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ");
...
window.addEventListener("test",null,b)}catch(c){}return a});g.w(g.gh,g.C);g.gh.prototype.X=function(a){this.C=new g.Pc(g.Yg(a),g.Zg(a))};
g.gh.prototype.N=function(){if(this.C){var a=g.xh();if(0!=this.D){var b=g.Rc(this.L,this.C)/(a-this.D);this.F[this.H]=.5<Math.abs((b-this.G)/this.G)?1:0;for(var c=0,d=0;4>d;d++)c+=this.F[d]||0;3<=c&&this.hc();this.G=b}this.D=a;this.L=this.C;this.H=(this.H+1)%4}};
g.gh.prototype.Y=function(){g.Uf(this.O);g.dh(this.J)};g.ha(hh,g.C);hh.prototype.Wa=function(a){for(var b=0;b<this.C.length;b++)if(this.C[b]==a){this.C.splice(b,1);a.target.removeEventListener(a.name,a.callback);break}};
hh.prototype.Y=function(){for(;this.C.length;){var a=this.C.pop();a.target.removeEventListener(a.name,a.callback)}g.C.prototype.Y.call(this)};ih.prototype.clone=function(){var a=new ih,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==g.Aa(c)?a[b]=g.bb(c):a[b]=c}return a};var lh={},kh=0;var aba,Eh,Fh,$aa,yh,bba,sh;aba=Math.pow(2,16)-1;Eh=null;Fh=0;$aa={log_event:"events",log_interaction:"interactions"};yh=Object.create(null);yh.log_event="GENERIC_EVENT_LOGGING";yh.log_interaction="INTERACTION_LOGGING";bba=new Set(["log_event"]);sh={};g.ph=0;g.qh=0;g.rh=g.r("ytLoggingTransportLogPayloadsQueue_")||{};g.p("ytLoggingTransportLogPayloadsQueue_",g.rh,void 0);var Dh=g.r("ytLoggingTransportTokensToCttTargetIds_")||{};g.p("ytLoggingTransportTokensToCttTargetIds_",Dh,void 0);
var vh=g.r("ytLoggingTransportDispatchedStats_")||{};g.p("ytLoggingTransportDispatchedStats_",vh,void 0);var zh=g.r("ytLoggingTransportCapturedTime_")||{};g.p("ytytLoggingTransportCapturedTime_",zh,void 0);var Kh={};g.Sh.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.C)try{this.C.set(a,b,(0,g.Nc)()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(g.Se(b))}catch(f){return}else e=escape(b);g.Qh(a,e,c,this.F)};
...
g.Sh.prototype.remove=function(a){this.C&&this.C.remove(a);g.Rh(a,"/",this.F)};var Th=new g.Sh("yt.innertube");g.Zh.prototype.toString=function(){return JSON.stringify(g.$h(this))};var di=g.r("ytLoggingLatencyUsageStats_")||{};g.p("ytLoggingLatencyUsageStats_",di,void 0);var ei=0;var fi=(0,g.Nc)().toString();var ji=g.r("ytLoggingTimeDocumentNonce_")||gi(),ki,hi;g.p("ytLoggingTimeDocumentNonce_",ji,void 0);ki=0;g.ii=null;hi=null;g.p("yt_logging_screen.getRootVeType",pi,void 0);g.p("yt_logging_screen.getCurrentCsn",g.ri,void 0);g.p("yt_logging_screen.setCurrentScreen",g.si,void 0);g.h=g.ui.prototype;g.h.HL=function(){this.ge()||this.init()};
g.h.enable=function(){this.C=1;(0,g.A)("string"==typeof this.page?[this.page]:this.page,function(a){a&&(this.subscribe("init-"+a,this.HL,this),this.subscribe("dispose-"+a,this.dispose,this),g.E("PAGE_NAME")==a&&g.vi(this))},this)};
g.h.init=function(){g.lg(this.F);this.C=2;this.L&&this.L()};
g.h.ge=function(){return 2==this.C};
...
g.h.clear=function(){g.$f(this.G);this.G=[]};var wi=g.r("yt.modules.registry_")||{};g.p("yt.modules.registry_",wi,void 0);g.zi=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};g.p("yt.msgs_",g.zi,void 0);var Fi={},gba=0;var hba=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;g.ha(Qi,g.C);g.h=Qi.prototype;g.h.getId=function(){return this.O};
g.h.loadNewVideoConfig=function(a){if(!this.sb()){this.ob=a=g.jh(a);this.C=a.clone();this.F=this.C.attrs.id||this.F;"video-player"==this.F&&(this.F=this.O,this.C.attrs.id=this.O);this.H.id==this.F&&(this.F+="-player",this.C.attrs.id=this.F);this.C.args.enablejsapi="1";this.C.args.playerapiid=this.O;this.ia||(this.ia=bj(this,this.C.args.jsapicallback||"onYouTubePlayerReady"));this.C.args.jsapicallback=null;(a=this.C.attrs.width)&&g.kd(this.H,Number(a)||a);if(a=this.C.attrs.height)this.H.style.height=
g.jd(Number(a)||a,!0);jba(this);this.L&&Ri(this)}};
g.h.Gx=function(){return this.ob};
g.h.VC=function(){return this.L};
g.h.Ci=function(a,b){var c=this,d=bj(this,b);if(d){if(!g.Ma(this.ub,a)&&!this.D[a]){var e=lba(this,a);this.X&&this.X(a,e)}this.J.subscribe(a,d);"onReady"==a&&this.L&&g.Rf(function(){d(c.api)},0)}};
g.h.tL=function(a,b){if(!this.sb()){var c=bj(this,b);c&&g.We(this.J,a,c)}};
g.h.bw=function(a){g.G("a11y-announce",a)};
g.h.cH=function(a){g.G("WATCH_LATER_VIDEO_ADDED",a)};
g.h.dH=function(a){g.G("WATCH_LATER_VIDEO_REMOVED",a)};
g.h.xy=function(){return this.la||(Si(this)?"html5":null)};
g.h.dy=function(){return this.Za};
g.h.cancel=function(){if(this.N){var a=this.N,b=g.bg(this.C.assets.js);spf.script.ignore(b,a)}g.Tf(this.qb);this.V=!1};
g.h.Y=function(){Zi(this);if(this.G&&this.C&&this.G.destroy)try{this.G.destroy()}catch(b){g.Mf(b)}this.wa=null;for(var a in this.D)g.n[this.D[a]]=null;this.ob=this.C=this.api=null;delete this.qa;delete this.H;g.C.prototype.Y.call(this)};g.dj={};g.cj="player_uid_"+(1E9*Math.random()>>>0);g.ij.prototype.toString=function(){return this.topic};var Bca=g.r("ytPubsub2Pubsub2Instance")||new g.Ve;g.Ve.prototype.subscribe=g.Ve.prototype.subscribe;g.Ve.prototype.unsubscribeByKey=g.Ve.prototype.Dd;g.Ve.prototype.publish=g.Ve.prototype.oa;g.Ve.prototype.clear=g.Ve.prototype.clear;g.p("ytPubsub2Pubsub2Instance",Bca,void 0);g.Dl=g.r("ytPubsub2Pubsub2SubscribedKeys")||{};g.p("ytPubsub2Pubsub2SubscribedKeys",g.Dl,void 0);g.El=g.r("ytPubsub2Pubsub2TopicToKeys")||{};g.p("ytPubsub2Pubsub2TopicToKeys",g.El,void 0);
g.Fl=g.r("ytPubsub2Pubsub2IsAsync")||{};g.p("ytPubsub2Pubsub2IsAsync",g.Fl,void 0);g.p("ytPubsub2Pubsub2SkipSubKey",null,void 0);var oj=null;g.Gl=window.performance&&window.performance.memory;g.Mk={};var pj=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};g.ha(sj,g.hj);g.ha(tj,g.hj);var xba=new g.ij("aft-recorded",sj),Bba=new g.ij("timing-sent",tj);var zba,Aj,Hl,Nj,wba,sba,vba,Il,Oj,Sj,uj,uba,ak,Tba;zba={vc:!0};
Aj={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'link[rel="import"][name="desktop_polymer_sel_auto_svg_home_v2"]':"dph",'script[name="mobile-c3/mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-phone/base"]':"mcppj",
...
"video.video_editor_async":"LATENCY_ACTION_CREATOR_VIDEO_VIDEO_EDITOR_ASYNC","video.monetization":"LATENCY_ACTION_CREATOR_VIDEO_MONETIZATION"};vba="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist".split(" ");Il={};Oj=(Il.pa="LATENCY_ACTION_",Il.yt_pt="LATENCY_PLAYER_",Il.yt_vst="VIDEO_STREAM_TYPE_",Il);Sj=!1;uj=!1;
uba=(0,g.t)(pj.clearResourceTimings||pj.webkitClearResourceTimings||pj.mozClearResourceTimings||pj.msClearResourceTimings||pj.oClearResourceTimings||g.ya,pj);ak=vj;Tba=zj;g.bk=xj;var ik=0,ek=[],hk=[],Zj=0,fk={},gk={},ck=new g.Fe(Iba,1E3);var kk=["server_prefetched_vast","vmap"];var mk,qk="";var sk=null,vk=[];var zk,Sk,Rk,Bk,Ak,Pba,Sba,Qba,Rba,Nk;Bk=0;Ak=0;Pba=[900,60,"waiting"];Sba=[500,99,"waiting"];Qba=[300,60,"waiting"];Rba=[400,99,"waiting"];Nk=[300,101,"done"];var Zk=!1;window.yt=window.yt||{};g.p("yt.setConfig",g.Jf,void 0);g.p("yt.pushConfigArray",Kf,void 0);g.p("yt.getConfig",g.E,void 0);g.p("yt.config.set",g.Jf,void 0);g.p("yt.config.pushArray",Kf,void 0);g.p("yt.config.get",g.E,void 0);g.p("yt.hasMsg",g.Bi,void 0);g.p("yt.setMsg",Ai,void 0);g.p("yt.setGoogMsg",Ci,void 0);g.p("yt.msgs.has",g.Bi,void 0);g.p("yt.msgs.set",Ai,void 0);g.p("yt.msgs.setGoog",Ci,void 0);g.p("yt.pubsub.publish",g.G,void 0);g.p("yt.pubsub.subscribe",g.Zf,void 0);
g.p("ytcsi.tick",g.bk,void 0);g.w(bl,g.ui);
bl.prototype.enable=function(){window.onload=Nba;window.onunload=Oba;window.onerror=Jaa;var a=window.ytspf||{};a.enabled?(window.addEventListener&&(window.addEventListener("spfclick",xk),window.addEventListener("spfhistory",yk),window.addEventListener("spfrequest",Dk),window.addEventListener("spfpartprocess",Hk),window.addEventListener("spfpartdone",Ik),window.addEventListener("spfprocess",Kk),window.addEventListener("spfdone",Ok),window.addEventListener("spferror",Pk),window.addEventListener("spfreload",
Qk),window.addEventListener("spfjsbeforeunload",cl)),a.config=a.config||{},window.ytdepmap?spf.script.ready("spf",function(){a.enabled=spf.init(a.config)}):a.enabled=spf.init(a.config),this.subscribe("init",Vba),this.subscribe("dispose",Wba)):spf.dispose();
this.subscribe("init",this.init,this);this.subscribe("dispose",this.dispose,this)};
bl.prototype.init=function(){bl.T.init.call(this);(window.ytspf||{}).enabled||spf.dispose();var a=window.ytPageFrameLoaded||!1;if(!a&&g.E("PAGEFRAME_JS")){var b=g.E("PAGEFRAME_JS",void 0);var c=function(){var e=g.r("ytbin.www.pageframe.setup");e&&(window.ytPageFrameLoaded=!0,e())}}else a&&(a=g.r("yt.www.masthead.loadSearchbox"))&&a();
...
g.p("yt.abuse.player.botguardInitialized",Oaa,void 0);g.p("yt.abuse.player.invokeBotguard",Paa,void 0);g.p("yt.abuse.dclkstatus.checkDclkStatus",Naa,void 0);g.p("yt.player.exports.navigate",g.Oi,void 0);g.p("yt.util.activity.init",g.Jh,void 0);g.p("yt.util.activity.getTimeSinceActive",g.Lh,void 0);g.p("yt.util.activity.setTimestamp",g.Hh,void 0);rk(g.r("ytplayer.config"));g.r("ytspf.enabled")&&Lba();tba();g.E("SERVICE_WORKER_KILLSWITCH",void 0)||navigator.serviceWorker&&navigator.serviceWorker.getRegistrations&&
"https:"==window.location.protocol&&(g.qg("service_worker_enabled")?kca():ica())};
bl.prototype.dispose=function(){g.Tf(this.D);var a=g.r("ytbin.www.pageframe.cancelSetup");a&&a();g.Uf(mk);if(a=g.ok())a.removeEventListener("onReady",nk),a.removeEventListener("onStateChange",nk);Hj(!1);(a=(a=(a=document.getElementById("ticker"))&&"TRIGGER_CONDITION_ENABLE_NOTIFICATIONS_PROMPT"==g.F(a,"trigger-condition")?a:null)?a.querySelector(".yt-uix-button-alert-info"):null)&&g.fh(a);bl.T.dispose.call(this)};
bl.prototype.disable=function(){bl.T.disable.call(this);window.removeEventListener&&(window.removeEventListener("spfclick",xk),window.removeEventListener("spfhistory",yk),window.removeEventListener("spfrequest",Dk),window.removeEventListener("spfpartprocess",Hk),window.removeEventListener("spfpartdone",Ik),window.removeEventListener("spfprocess",Kk),window.removeEventListener("spfdone",Ok),window.removeEventListener("spferror",Pk),window.removeEventListener("spfreload",Qk),window.removeEventListener("spfjsbeforeunload",
...
/*
     FILE ARCHIVED ON 00:02:28 Jun 01, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:44:31 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 237.663
  exclusion.robots: 0.063
  exclusion.robots.policy: 0.056
  cdx.remote: 0.052
  esindex: 0.008
  LoadShardBlock: 158.119 (3)
  PetaboxLoader3.datanode: 147.864 (4)
  load_resource: 39.705
*/