...
;function Y(a,b,c){this.m=this.f=this.g=null;this.l=wa(this);this.h=0;this.A=!1;this.u=[];this.i=null;this.S=c;this.U={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?Ab(a.src):"https://web.archive.org/web/20200528003543/https://www.youtube.com"),this.g=new gd(b),c||(b=re(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+wa(this.f)),ad[this.f.id]=this,window.postMessage){this.i=new M;se(this);b=T(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
...
/*
     FILE ARCHIVED ON 00:35:43 May 28, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:44:58 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 1134.346
  exclusion.robots: 0.133
  exclusion.robots.policy: 0.113
  cdx.remote: 0.105
  esindex: 0.016
  LoadShardBlock: 114.074 (4)
  PetaboxLoader3.datanode: 122.204 (5)
  load_resource: 125.726
  PetaboxLoader3.resolve: 63.919
*/