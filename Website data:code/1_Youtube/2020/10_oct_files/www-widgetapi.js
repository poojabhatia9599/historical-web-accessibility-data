...
;function Y(a,b,c){this.l=this.f=this.g=null;this.j=Na(this);this.h=0;this.s=!1;this.m=[];this.i=null;this.v=c;this.H={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?sc(a.src):"https://web.archive.org/web/20201001000048/https://www.youtube.com"),this.g=new If(b),c||(b=ej(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+Na(this.f)),Cf[this.f.id]=this,window.postMessage){this.i=new N;fj(this);b=R(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
...
/*
     FILE ARCHIVED ON 00:00:48 Oct 01, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:58:16 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 214.192
  exclusion.robots: 0.069
  exclusion.robots.policy: 0.062
  cdx.remote: 0.047
  esindex: 0.007
  LoadShardBlock: 50.846 (3)
  PetaboxLoader3.datanode: 128.494 (5)
  load_resource: 233.227 (2)
  PetaboxLoader3.resolve: 118.384 (2)
*/