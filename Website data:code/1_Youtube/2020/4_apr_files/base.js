...
gaa=function(a,b){if(!a||/[?&]dsh=1(&|$)/.test(a))return null;if(/[?&]ae=1(&|$)/.test(a)){var c=/[?&]adurl=([^&]+)/.exec(a);if(!c)return null;var d=b?c.index:a.length;try{return{Pt:a.slice(0,d)+"&act=1"+a.slice(d),Mu:decodeURIComponent(c[1])}}catch(f){return null}}if(/[?&]ae=2(&|$)/.test(a)){c=a;d="";if(b){var e=a.indexOf("&adurl=");0<e&&(c=a.slice(0,e),d=a.slice(e))}return{Pt:c+"&act=1"+d,Mu:c+"&dct=1"+d}}return null};
...
g.Ib=function(a){if(a instanceof g.Db)return a;a="object"==typeof a&&a.Md?a.Uc():String(a);Hb.test(a)||(a="about:invalid#zClosurez");return g.Fb(a)};
g.Jb=function(a,b){if(a instanceof g.Db)return a;a="object"==typeof a&&a.Md?a.Uc():String(a);if(b&&/^data:/i.test(a)){var c=g.Gb(a);if(c.Uc()==a)return c}Hb.test(a)||(a="about:invalid#zClosurez");return g.Fb(a)};
...
g.bc=function(a){if(a instanceof g.Yb)return a;var b="object"==typeof a,c=null;b&&a.Rk&&(c=a.C());return g.ac(g.wb(b&&a.Md?a.Uc():String(a)),c)};
...
kaa=function(a){this.C=gaa(a.url,a.dR)};
...
Mc=function(a,b){g.Ca(a);void 0===b&&(b=0);Kc();for(var c=Lc[b],d=[],e=0;e<a.length;e+=3){var f=a[e],k=e+1<a.length,l=k?a[e+1]:0,m=e+2<a.length,p=m?a[e+2]:0,t=f>>2;f=(f&3)<<4|l>>4;l=(l&15)<<2|p>>6;p&=63;m||(p=64,k||(l=64));d.push(c[t],c[f],c[l]||"",c[p]||"")}return d.join("")};
...
g.Nc=function(a,b){function c(m){for(;d<a.length;){var p=a.charAt(d++),t=Oc[p];if(null!=t)return t;if(!g.pb(p))throw Error("Unknown base64 encoding at char: "+p);}return m}
...
g.Qc=function(){};
Rc=function(a){if(a.C)for(var b in a.C){var c=a.C[b];if(g.Aa(c))for(var d=0;d<c.length;d++)c[d]&&c[d].Zc();else c&&c.Zc()}};
...
g.Wc=function(a){a=(a.C.cookie||"").split(";");for(var b=[],c=[],d,e,f=0;f<a.length;f++)e=(0,g.yb)(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));return{keys:b,values:c}};
g.Xc=function(a,b){switch(b){case 1:return 0!=a%4||0==a%100&&0!=a%400?28:29;case 5:case 8:case 10:case 3:return 30}return 31};
g.ad=function(a,b,c){"number"===typeof a?(this.date=Yc(a,b||0,c||1),Zc(this,c||1)):g.Ea(a)?(this.date=Yc(a.getFullYear(),a.getMonth(),a.getDate()),Zc(this,a.getDate())):(this.date=new Date((0,g.$c)()),a=this.date.getDate(),this.date.setHours(0),this.date.setMinutes(0),this.date.setSeconds(0),this.date.setMilliseconds(0),Zc(this,a))};
Yc=function(a,b,c){b=new Date(a,b,c);0<=a&&100>a&&b.setFullYear(b.getFullYear()-1900);return b};
Zc=function(a,b){if(a.getDate()!=b){var c=a.getDate()<b?1:-1;a.date.setUTCHours(a.date.getUTCHours()+c)}};
g.bd=function(a,b){this.x=void 0!==a?a:0;this.y=void 0!==b?b:0};
g.cd=function(a,b){return a==b?!0:a&&b?a.x==b.x&&a.y==b.y:!1};
g.dd=function(a,b){var c=a.x-b.x,d=a.y-b.y;return Math.sqrt(c*c+d*d)};
g.ed=function(a,b){this.width=a;this.height=b};
g.z=function(a){return g.fd(document,a)};
g.fd=function(a,b){return"string"===typeof b?a.getElementById(b):b};
g.gd=function(a){return g.fd(document,a)};
g.id=function(a,b){g.Ta(b,function(c,d){c&&"object"==typeof c&&c.Md&&(c=c.Uc());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:hd.hasOwnProperty(d)?a.setAttribute(hd[d],c):g.nb(d,"aria-")||g.nb(d,"data-")?a.setAttribute(d,c):a[d]=c})};
g.kd=function(a){return g.jd(a||window)};
g.jd=function(a){a=a.document;a=g.ld(a)?a.documentElement:a.body;return new g.ed(a.clientWidth,a.clientHeight)};
g.nd=function(a,b,c){return g.md(document,arguments)};
g.md=function(a,b){var c=String(b[0]),d=b[1];if(!oaa&&d&&(d.name||d.type)){c=["<",c];d.name&&c.push(' name="',g.ic(d.name),'"');if(d.type){c.push(' type="',g.ic(d.type),'"');var e={};g.cb(e,d);delete e.type;d=e}c.push(">");c=c.join("")}c=g.od(a,c);d&&("string"===typeof d?c.className=d:Array.isArray(d)?c.className=d.join(" "):g.id(c,d));2<b.length&&g.pd(a,c,b,2);return c};
g.pd=function(a,b,c,d){function e(k){k&&b.appendChild("string"===typeof k?a.createTextNode(k):k)}
for(;d<c.length;d++){var f=c[d];!g.Ca(f)||g.Ea(f)&&0<f.nodeType?e(f):(0,g.B)(paa(f)?g.Qa(f):f,e)}};
g.qd=function(a){return g.od(document,a)};
g.od=function(a,b){b=String(b);"application/xhtml+xml"===a.contentType&&(b=b.toLowerCase());return a.createElement(b)};
g.ld=function(a){return"CSS1Compat"==a.compatMode};
g.rd=function(a){for(var b;b=a.firstChild;)a.removeChild(b)};
g.sd=function(a){return a&&a.parentNode?a.parentNode.removeChild(a):null};
...
return b};
raa=function(){var a=g.qd("IFRAME"),b={};(0,g.B)(qaa(),function(c){a.sandbox&&a.sandbox.supports&&a.sandbox.supports(c)&&(b[c]=!0)});
return b};
...
function c(y,A){if("string"===typeof y){y=unescape(encodeURIComponent(y));for(var G=[],O=0,T=y.length;O<T;++O)G.push(y.charCodeAt(O));y=G}A||(A=y.length);G=0;if(0==p)for(;G+64<A;)b(y.slice(G,G+64)),G+=64,t+=64;for(;G<A;)if(f[p++]=y[G++],t++,64==p)for(p=0,b(f);G+64<A;)b(y.slice(G,G+64)),G+=64,t+=64}
function d(){var y=[],A=8*t;56>p?c(l,56-p):c(l,64-(p-56));for(var G=63;56<=G;G--)f[G]=A&255,A>>>=8;b(f);for(G=A=0;5>G;G++)for(var O=24;0<=O;O-=8)y[A++]=e[G]>>O&255;return y}
for(var e=[],f=[],k=[],l=[128],m=1;64>m;++m)l[m]=0;var p,t;a();return{reset:a,update:c,digest:d,tu:function(){for(var y=d(),A="",G=0;G<y.length;G++)A+="0123456789ABCDEF".charAt(Math.floor(y[G]/16))+"0123456789ABCDEF".charAt(y[G]%16);return A}}};
taa=function(a,b,c){var d=[],e=[];if(1==(g.Aa(c)?2:1))return e=[b,a],(0,g.B)(d,function(l){e.push(l)}),Kd(e.join(" "));
...
Kd=function(a){var b=saa();b.update(a);return b.tu().toLowerCase()};
Ld=function(a){var b=Jd(String(g.q.location.href)),c;(c=g.q.__SAPISID||g.q.__APISID||g.q.__OVERRIDE_SID)?c=!0:(c=new g.Vc(document),c=c.get("SAPISID")||c.get("APISID")||c.get("__Secure-3PAPISID")||c.get("SID"),c=!!c);if(c&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?g.q.__SAPISID:g.q.__APISID,c||(c=new g.Vc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){b=b?"SAPISIDHASH":"APISIDHASH";var d=String(g.q.location.href);return d&&c&&b?[b,taa(Jd(d),c,a||null)].join(" "):
null}return null};
Md=function(){this.C=[];this.F=-1};
uaa=function(a){-1==a.F&&(a.F=(0,g.Nd)(a.C,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.F};
g.Od=function(){var a=new Md;g.q.SVGElement&&g.q.document.createElementNS&&a.set(0);var b=raa();b["allow-top-navigation-by-user-activation"]&&a.set(1);b["allow-popups-to-escape-sandbox"]&&a.set(2);g.q.crypto&&g.q.crypto.subtle&&a.set(3);g.q.TextDecoder&&g.q.TextEncoder&&a.set(4);return uaa(a)};
...
waa=function(a,b,c,d,e){this.listener=a;this.C=null;this.src=b;this.type=c;this.capture=!!d;this.Zg=e;this.key=++vaa;this.kg=this.Ph=!1};
...
return a[oe]};
g.pe=function(){g.C.call(this);this.vd=new g.Yd(this);this.Dt=this;this.Ol=null};
...
te=function(a){g.q.setTimeout(function(){throw a;},0)};
Baa=function(){var a=g.q.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!g.Rb("Presto")&&(a=function(){var e=g.qd("IFRAME");e.style.display="none";g.ec(e,g.mb(Aaa));document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(g.Zb(g.ue));e.close();var k="callImmediate"+Math.random(),l="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=(0,g.v)(function(m){if(("*"==l||m.origin==
...
return function(e){d.next={jn:e};d=d.next;b.port2.postMessage(0)}}return function(e){g.q.setTimeout(e,0)}};
ve=function(){this.F=this.C=null};
we=function(){this.next=this.scope=this.mc=null};
Ae=function(a,b){xe||Caa();ye||(xe(),ye=!0);ze.add(a,b)};
Caa=function(){if(g.q.Promise&&g.q.Promise.resolve){var a=g.q.Promise.resolve(void 0);xe=function(){a.then(Be)}}else xe=function(){var b=Be;
...
Oe=function(a,b,c,d){var e=Ke(null,null,null);e.C=new g.He(function(f,k){e.F=b?function(l){try{var m=b.call(d,l);f(m)}catch(p){k(p)}}:f;
e.onRejected=c?function(l){try{var m=c.call(d,l);void 0===m&&l instanceof g.Ve?k(l):f(m)}catch(p){k(p)}}:k});
e.C.D=a;Ue(a,e);return e.C};
g.Ge=function(a,b,c){0==a.C&&(a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself")),a.C=1,Le(c,a.Y,a.N,a)||(a.M=c,a.C=b,a.D=null,Te(a),3!=b||c instanceof g.Ve||Daa(a,c)))};
Le=function(a,b,c,d){if(a instanceof g.He)return Ue(a,Ke(b||g.xa,c||null,d)),!0;if(g.Fe(a))return a.then(b,c,d),!0;if(g.Ea(a))try{var e=a.then;if(g.Da(e))return Eaa(a,e,b,c,d),!0}catch(f){return c.call(d,f),!0}return!1};
...
Daa=function(a,b){a.H=!0;Ae(function(){a.H&&Xe.call(null,b)})};
...
g.$e=function(a,b,c){g.C.call(this);this.C=a;this.D=b||0;this.F=c;this.Pb=(0,g.v)(this.xk,this)};
...
Gaa=function(a){if(g.Ca(a))return g.Qa(a);a=gf(a);var b=[];g.hf(a,function(c){b.push(c)});
return b};
...
g.of=function(a){var b=[];nf(new Iaa,a,b);return b.join("")};
Iaa=function(){};
...
pf=function(a,b){b.push('"',a.replace(Jaa,function(c){var d=qf[c];d||(d="\\u"+(c.charCodeAt(0)|65536).toString(16).substr(1),qf[c]=d);return d}),'"')};
...
Kaa=function(a,b,c){Ae(function(){a.apply(b,c)})};
...
g.zf=function(a){var b=a.creation;a=a.expiration;return!!a&&a<(0,g.$c)()||!!b&&b>(0,g.$c)()};
Laa=function(){};
Af=function(){};
g.Bf=function(a){this.C=a};
g.Cf=function(){var a=null;try{a=window.localStorage||null}catch(b){}this.C=a};
Ff=function(a,b){this.F=a;this.C=null;if(g.Df&&!g.Jc(9)){Ef||(Ef=new g.kf);this.C=Ef.get(a);this.C||(b?this.C=document.getElementById(b):(this.C=document.createElement("userdata"),this.C.addBehavior("#default#userData"),document.body.appendChild(this.C)),Ef.set(a,this.C));try{this.C.load(this.F)}catch(c){this.C=null}}};
Gf=function(a){return"_"+encodeURIComponent(a).replace(/[.!~*'()%]/g,function(b){return Maa[b]})};
...
Rf=function(a){var b=g.E("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:g.E("EXPERIMENT_FLAGS",{})[a]};
g.F=function(a,b){return a?a.dataset?a.dataset[g.Vf(b)]:a.getAttribute("data-"+b):null};
g.Vf=function(a){return Wf[a]||(Wf[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))};
Oaa=function(a){Naa.forEach(function(b){return b(a)})};
Yf=function(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){g.Xf(b),Oaa(b)}}:a};
g.Xf=function(a){var b=g.u("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=Pf(),b.push([a,"ERROR",void 0,void 0,void 0]),g.Nf("ERRORS",b))};
g.Zf=function(a){var b=g.u("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=Pf(),b.push([a,"WARNING",void 0,void 0,void 0]),g.Nf("ERRORS",b))};
...
g.$f=function(a,b){g.Da(a)&&(a=Yf(a));return window.setTimeout(a,b)};
g.ag=function(a,b){g.Da(a)&&(a=Yf(a));return window.setInterval(a,b)};
g.bg=function(a){window.clearTimeout(a)};
g.cg=function(a){window.clearInterval(a)};
g.ig=function(a,b,c){var d=dg();if(d){var e=d.subscribe(a,function(){var f=arguments;var k=function(){eg[e]&&b.apply(c||window,f)};
try{fg[a]?k():g.$f(k,0)}catch(l){g.Xf(l)}},c);
eg[e]=!0;hg[a]||(hg[a]=[]);hg[a].push(e);return e}return 0};
g.jg=function(a){var b=dg();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),(0,g.B)(a,function(c){b.unsubscribeByKey(c);delete eg[c]}))};
g.H=function(a,b){var c=dg();return c?c.publish.apply(c,arguments):!1};
g.kg=function(a,b){fg[a]=!0;var c=dg();c=c?c.publish.apply(c,arguments):!1;fg[a]=!1;return c};
dg=function(){return g.u("ytPubsubPubsubInstance")};
g.mg=function(a,b){var c=g.lg(a);spf.script.load(a,c,b)};
g.ng=function(a){a=g.lg(a);spf.script.unload(a)};
g.lg=function(a){var b="";if(a){var c=a.indexOf("jsbin/"),d=a.lastIndexOf(".js"),e=c+6;-1<c&&-1<d&&d>e&&(b=a.substring(e,d),b=b.replace(Qaa,""),b=b.replace(Raa,""),b=b.replace("debug-",""),b=b.replace("tracing-",""))}return b};
g.Dg=function(){g.bg(g.og);g.bg(g.pg);g.pg=0;if(!g.Wa(g.qg)){for(var a in g.qg){var b=rg[a];if(b&&b.isReady()){var c=void 0,d=a,e=b,f=Saa[d],k=sg[d]||{};sg[d]=k;b=Math.round((0,g.tg)());for(c in g.qg[d]){var l=g.ab(g.ug(e));l[f]=vg(d,c);k.dispatchedEventCount=k.dispatchedEventCount||0;k.dispatchedEventCount+=l[f].length;var m=wg[c];if(m)a:{var p=l,t=c;if(m.videoId)var y="VIDEO";else if(m.playlistId)y="PLAYLIST";else break a;p.credentialTransferTokenTargetId=m;p.context=p.context||{};p.context.user=
p.context.user||{};p.context.user.credentialTransferTokens=[{token:t,scope:y}]}delete wg[c];m=l;m.requestTimeMs=b;g.Sf("unsplit_gel_payloads_in_logs")&&(m.unsplitGelPayloadsInLogs=!0);if(y=g.E("EVENT_ID",void 0))p=g.E("BATCH_CLIENT_COUNTER",void 0)||0,!p&&g.Sf("web_client_counter_random_seed")&&(p=Math.floor(Math.random()*xg/2)),p++,p>xg&&(p=1),g.Nf("BATCH_CLIENT_COUNTER",p),y={serializedEventId:y,clientCounter:p},m.serializedClientEventId=y,yg&&zg&&g.Sf("log_gel_rtt_web")&&(m.previousBatchInfo={serializedClientEventId:yg,
roundtripMs:zg}),yg=y,zg=0;g.Ag(e,d,l,{retry:Taa.has(d),onSuccess:g.w(Uaa,(0,g.tg)())})}c=k;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?((c.averageTimeBetweenDispatchesMs||0)*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete g.qg[a];Bg=!1}}g.Wa(g.qg)||g.Cg()}};
Vaa=function(){var a=[];for(e in g.qg){var b=sg[e]||{};sg[e]=b;for(var c in g.qg[e]){var d=vg(e,c);b.storedEventsCount=b.storedEventsCount||0;b.storedEventsCount+=d.length}}var e=Math.round((0,g.tg)());for(var f in sg)b=sg[f],b.eventType=f in Eg?Eg[f]:"UNKNOWN_TYPE",c=Fg[f],b.metricIntervalMs=c?e-c:e-g.Gg,a.push(b),Fg[f]=e,delete sg[f];return a};
g.Cg=function(){g.Sf("web_gel_timeout_cap")&&!g.pg&&(g.pg=g.$f(g.Dg,6E4));g.bg(g.og);var a=g.Tf("web_gel_debounce_ms",1E4);a=g.E("LOGGING_BATCH_TIMEOUT",g.Hg||a);g.Sf("shorten_initial_gel_batch_timeout")&&Bg&&(a=Waa);g.og=g.$f(g.Dg,a)};
vg=function(a,b){b=void 0===b?"":b;g.qg[a]=g.qg[a]||{};g.qg[a][b]=g.qg[a][b]||[];return g.qg[a][b]};
Uaa=function(a){zg=Math.round((0,g.tg)()-a)};
g.Jg=function(a){var b=a.__yt_uid_key;b||(b=Ig(),a.__yt_uid_key=b);return b};
g.Kg=function(){var a=document;if("visibilityState"in a)return a.visibilityState;var b=Xaa+"VisibilityState";if(b in a)return a[b]};
g.Lg=function(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.rotation=this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{if(a=a||window.event){this.event=a;for(var b in a)b in Yaa||(this[b]=a[b]);this.rotation=a.rotation;var c=a.target||a.srcElement;c&&3==c.nodeType&&(c=c.parentNode);this.target=c;var d=a.relatedTarget;if(d)try{d=d.nodeName?
...
Mg=function(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.C=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.F=a.clientY+b}};
g.Ng=function(a){void 0===a.C&&Mg(a);return a.C};
g.Og=function(a){void 0===a.F&&Mg(a);return a.F};
g.Qg=function(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return g.Va(Pg,function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,k=g.Ea(e[4])&&g.Ea(d)&&g.Za(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||k)})};
g.I=function(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=g.Qg(a,b,c,d);if(e)return e;e=++Tg.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var k=f?function(l){l=new g.Lg(l);if(!g.ud(l.relatedTarget,function(m){return m==a},!0))return l.currentTarget=a,l.type=b,c.call(a,l)}:function(l){l=new g.Lg(l);
l.currentTarget=a;return c.call(a,l)};
k=Yf(k);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Ug()||"boolean"===typeof d?a.addEventListener(b,k,d):a.addEventListener(b,k,!!d.capture)):a.attachEvent("on"+b,k);Pg[e]=[a,b,c,k,d];return e};
g.Vg=function(a){a&&("string"==typeof a&&(a=[a]),(0,g.B)(a,function(b){if(b in Pg){var c=Pg[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Ug()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Pg[b]}}))};
g.Wg=function(a,b,c){var d=void 0===d?{}:d;var e;return e=g.I(a,b,function(){g.Vg(e);c.apply(a,arguments)},d)};
g.Xg=function(a){for(var b in Pg)Pg[b][0]==a&&g.Vg(b)};
g.Yg=function(a){this.Pb=a;this.C=null;this.D=0;this.L=null;this.G=0;this.F=[];for(a=0;4>a;a++)this.F.push(0);this.H=0;this.J=g.I(window,"mousemove",(0,g.v)(this.Y,this));this.N=g.ag((0,g.v)(this.M,this),25)};
Zaa=function(){};
g.$g=function(a,b){return Zg(a,0,b)};
g.ah=function(a,b){return Zg(a,1,b)};
g.ch=function(a){for(var b=0,c=a.length;b<c;b++)g.bh(a[b])};
dh=function(){};
g.eh=function(){return!!g.u("yt.scheduler.instance")};
Zg=function(a,b,c){isNaN(c)&&(c=void 0);var d=g.u("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):g.$f(a,c||0)};
g.bh=function(a){if(!isNaN(a)){var b=g.u("yt.scheduler.instance.cancelJob");b?b(a):g.bg(a)}};
g.hh=function(a){var b=void 0===a?{}:a;a=void 0===b.dy?!0:b.dy;b=void 0===b.LF?!1:b.LF;if(null==g.u("_lact",window)){var c=parseInt(g.E("LACT"),10);c=isFinite(c)?(0,g.$c)()-Math.max(c,0):-1;g.r("_lact",c,window);g.r("_fact",c,window);-1==c&&g.fh();g.I(document,"keydown",g.fh);g.I(document,"keyup",g.fh);g.I(document,"mousedown",g.fh);g.I(document,"mouseup",g.fh);a&&(b?g.I(window,"touchmove",function(){gh("touchmove",200)},{passive:!0}):(g.I(window,"resize",function(){gh("resize",200)}),g.I(window,
"scroll",function(){gh("scroll",200)})));
new g.Yg(function(){gh("mouse",100)});
g.I(document,"touchstart",g.fh,{passive:!0});g.I(document,"touchend",g.fh,{passive:!0})}};
gh=function(a,b){ih[a]||(ih[a]=!0,g.ah(function(){g.fh();ih[a]=!1},b))};
g.fh=function(){null==g.u("_lact",window)&&g.hh();var a=(0,g.$c)();g.r("_lact",a,window);-1==g.u("_fact",window)&&g.r("_fact",a,window);(a=g.u("ytglobal.ytUtilActivityCallback_"))&&a()};
g.jh=function(){var a=g.u("_lact",window);return null==a?-1:Math.max((0,g.$c)()-a,0)};
g.ph=function(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||(0,g.tg)());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:g.jh())};g.Sf("log_sequence_info_on_gel_web")&&d.Fe&&(a=e.context,b=d.Fe,kh[b]=b in kh?kh[b]+1:0,a.sequence={index:kh[b],groupKey:b},d.Gu&&delete kh[d.Fe]);(d=d.Of)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),wg[d.token]=a,d=vg("log_event",d.token)):d=vg("log_event");d.push(e);c&&(rg.log_event=new c);c=g.Tf("web_logging_max_batch")||
100;e=(0,g.tg)();d.length>=c?g.Dg():e-g.lh>=g.mh&&(g.Cg(),g.lh=e)};
qh=function(a){a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=g.hc(e[0]||""),k=g.hc(e[1]||"");f in b?g.Aa(b[f])?g.Ra(b[f],k):b[f]=[b[f],k]:b[f]=k}catch(m){if("q"!=e[0]){var l=Error("Error decoding URL component");l.params={key:e[0],value:e[1]};g.Xf(l)}}}return b};
g.rh=function(a){var b=[];g.Ta(a,function(c,d){var e=g.gc(d),f;g.Aa(c)?f=c:f=[c];(0,g.B)(f,function(k){""==k?b.push(e):b.push(e+"="+g.gc(k))})});
return b.join("&")};
g.sh=function(a){"?"==a.charAt(0)&&(a=a.substr(1));return qh(a)};
g.uh=function(a,b){return g.th(a,b||{},!0)};
g.th=function(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=g.sh(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);return g.xc(a,e)+d};
yh=function(a){var b=g.vh;a=void 0===a?g.u("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(g.wh(b),g.xh(b));b.ca_type="image";a&&(b.bid=a);return b};
g.wh=function(a){var b={};b.dt=g.zh;b.flash="0";a:{try{var c=a.C.top.location.href}catch(d){a=2;break a}a=c?c===a.F.location.href?0:1:2}b=(b.frm=a,b);g.Gd(b);return b};
g.xh=function(a){var b=g.Id(a.C),c=g.Hd(a.C.top),d={};return d.bc=g.Od(),d.bih=c.height,d.biw=c.width,d.brdim=b.join(),d.vis=g.Pd(a.F),d.wgl=!!g.Dd.WebGLRenderingContext,d};
$aa=function(){if(!Ah)return null;var a=Ah();return"open"in a?a:null};
g.Ch=function(a){switch(g.Bh(a)){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:return!0;default:return!1}};
g.Bh=function(a){return a&&"status"in a?a.status:-1};
aba=function(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=g.pc(1,a),e=g.qc(a);d&&e?(d=c,c=a.match(g.oc),d=d.match(g.oc),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?g.qc(c)==e&&(Number(g.pc(4,c))||null)==(Number(g.pc(4,a))||null):!0;d=g.Sf("web_ajax_ignore_global_headers_if_set");for(var f in Dh)e=g.E(Dh[f]),!e||!c&&!Eh(a,f)||d&&void 0!==b[f]||(b[f]=e);if(c||Eh(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(c||Eh(a,"X-YouTube-Time-Zone"))&&
(f="undefined"!=typeof Intl?(new Intl.DateTimeFormat).resolvedOptions().timeZone:null)&&(b["X-YouTube-Time-Zone"]=f);if(c||Eh(a,"X-YouTube-Ad-Signals"))b["X-YouTube-Ad-Signals"]=g.rh(yh(void 0));return b};
cba=function(a){var b=window.location.search,c=g.qc(a),d=g.nc(g.pc(5,a));d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=g.sh(b),f={};(0,g.B)(bba,function(k){e[k]&&(f[k]=e[k])});
return g.th(a,f||{},!1)};
Eh=function(a,b){var c=g.E("CORS_HEADER_WHITELIST")||{},d=g.qc(a);return d?(c=c[d])?g.Ma(c,b):!1:!0};
dba=function(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=Fh(a,b);var d=Gh(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(k){if(!e){e=!0;f&&g.bg(f);var l=k.ok,m=function(p){p=p||{};var t=b.context||g.q;l?b.onSuccess&&b.onSuccess.call(t,p,k):b.onError&&b.onError.call(t,p,k);b.Xa&&b.Xa.call(t,p,k)};
"JSON"==(b.format||"JSON")&&(l||400<=k.status&&500>k.status)?k.json().then(m,function(){m(null)}):m(null)}});
b.hq&&0<b.timeout&&(f=g.$f(function(){e||(e=!0,g.bg(f),b.hq.call(b.context||g.q))},b.timeout))}else g.J(a,b)};
g.J=function(a,b){var c=b.format||"JSON";a=Fh(a,b);var d=Gh(a,b),e=!1,f,k=Hh(a,function(l){if(!e){e=!0;f&&g.bg(f);var m=g.Ch(l),p=null,t=400<=l.status&&500>l.status,y=500<=l.status&&600>l.status;if(m||t||y)p=eba(c,l,b.ob);if(m)a:if(l&&204==l.status)m=!0;else{switch(c){case "XML":m=0==parseInt(p&&p.return_code,10);break a;case "RAW":m=!0;break a}m=!!p}p=p||{};t=b.context||g.q;m?b.onSuccess&&b.onSuccess.call(t,l,p):b.onError&&b.onError.call(t,l,p);b.Xa&&b.Xa.call(t,l,p)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.Oc&&0<b.timeout&&(f=g.$f(function(){e||(e=!0,k.abort(),g.bg(f),b.Oc.call(b.context||g.q,k))},b.timeout));
return k};
Fh=function(a,b){b.cR&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=g.E("XSRF_FIELD_NAME",void 0),d=b.Ta;d&&(d[c]&&delete d[c],a=g.uh(a,d));return a};
Gh=function(a,b){var c=g.E("XSRF_FIELD_NAME",void 0),d=g.E("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.ia,k=g.E("XSRF_FIELD_NAME",void 0),l;b.headers&&(l=b.headers["Content-Type"]);b.Ku||g.qc(a)&&!b.withCredentials&&g.qc(a)!=document.location.hostname||"POST"!=b.method||l&&"application/x-www-form-urlencoded"!=l||b.ia&&b.ia[k]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=g.sh(e),g.cb(e,f),e=b.er&&"JSON"==b.er?JSON.stringify(e):g.wc(e));f=e||f&&!g.Wa(f);!Ih&&f&&"POST"!=b.method&&(Ih=!0,g.Xf(Error("AJAX request with postData should use POST")));
return e};
eba=function(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Jh(b):null)d={},(0,g.B)(b.getElementsByTagName("*"),function(e){d[e.tagName]=g.Kh(e)})}c&&Lh(d);
return d};
Lh=function(a){if(g.Ea(a))for(var b in a)"html_content"==b||g.ob(b,"_html")?a[b]=g.cc(a[b],null):Lh(a[b])};
Jh=function(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null};
g.Kh=function(a){var b="";(0,g.B)(a.childNodes,function(c){b+=c.nodeValue});
return b};
g.Mh=function(a,b){b.method="POST";b.ia||(b.ia={});return g.J(a,b)};
Hh=function(a,b,c,d,e,f,k){function l(){4==(m&&"readyState"in m?m.readyState:0)&&b&&Yf(b)(m)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var m=$aa();if(!m)return null;"onloadend"in m?m.addEventListener("loadend",l,!1):m.onreadystatechange=l;g.Sf("debug_forward_web_query_parameters")&&(a=cba(a));m.open(c,a,!0);f&&(m.responseType=f);k&&(m.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=aba(a,e))for(var p in e)m.setRequestHeader(p,e[p]),"content-type"==p.toLowerCase()&&(c=!1);c&&m.setRequestHeader("Content-Type","application/x-www-form-urlencoded");m.send(d);
return m};
fba=function(){for(var a={},b=g.ka(Object.entries(g.sh(g.E("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=g.ka(c.value);c=d.next().value;d=d.next().value;"cbrand"===c?a.deviceMake=d:"cmodel"===c?a.deviceModel=d:"cbr"===c?a.browserName=d:"cbrver"===c?a.browserVersion=d:"cos"===c?a.osName=d:"cosver"===c?a.osVersion=d:"cplatform"===c&&(a.platform=d)}return a};
Nh=function(){return"INNERTUBE_API_KEY"in g.Mf&&"INNERTUBE_API_VERSION"in g.Mf};
Oh=function(){return{innertubeApiKey:g.E("INNERTUBE_API_KEY",void 0),innertubeApiVersion:g.E("INNERTUBE_API_VERSION",void 0),fy:g.E("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),gy:g.E("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:g.E("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),iy:g.E("INNERTUBE_CONTEXT_HL",void 0),hy:g.E("INNERTUBE_CONTEXT_GL",void 0),jy:g.E("INNERTUBE_HOST_OVERRIDE",void 0)||"",ky:!!g.E("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)}};
Ph=function(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||g.E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.WQ||g.E("AUTHORIZATION"))||(a?b="Bearer "+g.u("gapi.auth.getToken")().UQ:b=Ld([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=g.E("SESSION_INDEX",0),g.Sf("pageid_as_header_web")&&(d["X-Goog-PageId"]=g.E("DELEGATED_SESSION_ID")));return d};
Qh=function(a){a=Object.assign({},a);delete a.Authorization;var b=Ld();if(b){var c=new af;c.update(g.E("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=Mc(c.digest(),3)}return a};
g.Sh=function(a,b,c,d){g.Rh.set(""+a,b,{wl:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})};
g.Th=function(a,b,c){g.Rh.remove(""+a,void 0===b?"/":b,void 0===c?"youtube.com":c)};
g.Uh=function(a){var b;(b=g.Kf(a))||(a=new Ff(a||"UserDataSharedStore"),b=a.isAvailable()?a:null);this.C=(a=b)?new g.yf(a):null;this.F=document.domain||window.location.hostname};
gba=function(a,b,c,d){if(d)return null;d=Vh.get("nextId",!0)||1;var e=Vh.get("requests",!0)||{};e[d]={method:a,request:b,authState:Qh(c),requestTime:Math.round((0,g.tg)())};Vh.set("nextId",d+1,86400,!0);Vh.set("requests",e,86400,!0);return d};
Wh=function(a){var b=Vh.get("requests",!0)||{};delete b[a];Vh.set("requests",b,86400,!0)};
Xh=function(a){var b=Vh.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round((0,g.tg)())-d.requestTime)){var e=d.authState,f=Qh(Ph(!1));g.Za(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round((0,g.tg)())),g.Ag(a,d.method,e,{}));delete b[c]}}Vh.set("requests",b,86400,!0)}};
g.Yh=function(a){var b=this;this.C=null;a?this.C=a:Nh()&&(this.C=Oh());g.$g(function(){Xh(b)},5E3)};
g.ug=function(a){a=a.C||Oh();a={client:{hl:a.iy,gl:a.hy,clientName:a.gy,clientVersion:a.innertubeContextClientVersion,configInfo:a.fy}};var b=window.devicePixelRatio;b&&1!=b&&(a.client.screenDensityFloat=String(b));b=g.E("EXPERIMENTS_TOKEN","");""!==b&&(a.client.experimentsToken=b);b=[];var c=g.E("EXPERIMENTS_FORCED_FLAGS",{});for(d in c)b.push({key:d,value:String(c[d])});var d=g.E("EXPERIMENT_FLAGS",{});for(var e in d)e.startsWith("force_")&&void 0===c[e]&&b.push({key:e,value:String(d[e])});0<b.length&&
(a.request={internalExperimentFlags:b});g.E("DELEGATED_SESSION_ID")&&!g.Sf("pageid_as_header_web")&&(a.user={onBehalfOfUser:g.E("DELEGATED_SESSION_ID")});g.Sf("enable_device_forwarding_from_xhr_client")&&(a.client=Object.assign(a.client,fba()));return{context:a}};
g.Ag=function(a,b,c,d){!g.E("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&g.Zf(Error("Missing VISITOR_DATA when sending innertube request."));var e={headers:{"Content-Type":"application/json"},method:"POST",ia:c,er:"JSON",Oc:function(){d.Oc()},
...
timeout:d.timeout,withCredentials:!0},f="",k=a.C.jy;k&&(f=k);k=a.C.ky||!1;var l=Ph(k,f,d);Object.assign(e.headers,l);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var m=g.uh(""+f+("/youtubei/"+a.C.innertubeApiVersion+"/"+b),{alt:"json",key:a.C.innertubeApiKey}),p;if(d.retry&&g.Sf("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(p=gba(b,c,l,k))){var t=e.onSuccess,y=e.Zi;e.onSuccess=function(A,G){Wh(p);t(A,G)};
c.Zi=function(A,G){Wh(p);y(A,G)}}try{g.Sf("use_fetch_for_op_xhr")?dba(m,e):g.Mh(m,e)}catch(A){if("InvalidAccessError"==A)p&&(Wh(p),p=0),g.Zf(Error("An extension is blocking network request."));
else throw A;}p&&g.$g(function(){Xh(a)},5E3)};
g.Zh=function(a,b,c){c=void 0===c?{}:c;var d=g.Yh;g.E("ytLoggingEventsDefaultDisabled",!1)&&g.Yh==g.Yh&&(d=null);g.ph(a,b,d,c)};
g.$h=function(){g.Sf("log_web_meta")&&Vaa().forEach(function(a){g.Zh("delayedEventMetricCaptured",a)})};
g.ai=function(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(g.la(c))};
g.bi=function(a){var b=g.u("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,!1,void 0):(b=Pf(),b.push([a,"ERROR",void 0,void 0,!1,void 0]),g.Nf("ERRORS",b))};
g.ci=function(a){var b=g.u("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,!1,void 0):(b=Pf(),b.push([a,"WARNING",void 0,void 0,!1,void 0]),g.Nf("ERRORS",b))};
g.di=function(){this.F=!1;this.C=null};
ei=function(a,b,c,d){if(d)try{a.C=new window.botguard.bg(b,c?function(){return c(b)}:g.xa)}catch(e){g.ci(e)}else{try{a.C=new window.botguard.bg(b)}catch(e){g.ci(e)}c&&c(b)}};
g.fi=function(a,b){b=void 0===b?{}:b;return a.C?a.C.invoke(void 0,void 0,b):null};
hba=function(){return parseInt(g.E("DCLKSTAT",0),10)};
iba=function(){return g.gi.Nd()};
jba=function(a){a=void 0===a?{}:a;return g.fi(g.gi,a)};
...
oi=function(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=(0,g.$c)();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ni)for(a=1,b=0;b<ni.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ni.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&
63));return a.join("")};
g.qi=function(a){a&&g.ph("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:pi,clientScreenNonce:a},g.Yh)};
...
xi=function(){var a=g.E("csn-to-ctt-auth-info");a||(a={},g.Nf("csn-to-ctt-auth-info",a));return a};
g.yi=function(a){a=void 0===a?0:a;var b=g.E(ti(a));if(!b&&!g.E("USE_CSN_FALLBACK",!0))return null;b||0!=a||(g.Sf("kevlar_client_side_screens")||g.Sf("c3_client_side_screens")?b="UNDEFINED_CSN":b=g.E("EVENT_ID"));return b?b:null};
kba=function(a,b,c){var d=xi();(c=g.yi(c))&&delete d[c];b&&(d[a]=b)};
g.zi=function(a){return xi()[a]};
g.Ai=function(a,b,c,d){c=void 0===c?0:c;if(a!==g.E(ti(c))||b!==g.E(ui(c)))kba(a,d,c),g.Nf(ti(c),a),g.Nf(ui(c),b),0==c&&(b=function(){setTimeout(function(){g.qi(a)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())};
...
g.Ii=function(a,b,c){var d=Di();if(!d)return 0;var e=d.subscribe(a.toString(),function(f,k){var l=g.u("ytPubsub2Pubsub2SkipSubKey");l&&l==e||(l=function(){if(Fi[e])try{if(k&&a instanceof g.Ci&&a!=f)try{var m=a.C,p=k;if(!p.args||!p.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!m.Je){var t=new m;m.Je=t.version}var y=m.Je}catch(A){}if(!y||p.version!=y)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{k=Reflect.construct(m,
g.Qa(p.args))}catch(A){throw A.message="yt.pubsub2.Data.deserialize(): "+A.message,A;}}catch(A){throw A.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+a.toString()+": "+A.message,A;}b.call(c||window,k)}catch(A){g.Xf(A)}},Gi[a.toString()]?g.eh()?g.ah(l):g.$f(l,0):l())});
Fi[e]=!0;Hi[a.toString()]||(Hi[a.toString()]=[]);Hi[a.toString()].push(e);return e};
nba=function(){var a=lba,b=g.Ii(mba,function(c){a.apply(void 0,arguments);g.Ji(b)},void 0);
return b};
...
g.Ni=function(a,b,c){Li.push({payloadName:a,payload:b,options:c});Mi||(Mi=nba())};
lba=function(a){if(Li){for(var b=g.ka(Li),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,g.ph(c.payloadName,c.payload,null,c.options));Li.length=0}Mi=0};
g.Ri=function(a,b,c){var d=g.Sf("use_default_events_client")?void 0:g.Yh;(0,g.B)(b,function(e){var f=c;f=void 0===f?!1:f;e={csn:a,ve:g.si(e),eventType:f?16:8};f={Of:g.zi(a),Fe:a,Gu:f};"UNDEFINED_CSN"==a?g.Ni("visualElementHidden",e,f):d?g.ph("visualElementHidden",e,d,f):g.Zh("visualElementHidden",e,f)})};
Si=function(){var a=g.wi(),b=g.yi();b&&a&&g.Ri(b,[a],!0)};
g.Wi=function(a){if("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND"==a||"FOREGROUND_HEARTBEAT_TRIGGER_ON_FOREGROUND"==a){if(Ti==a)return;Ti=a}var b=9E4+2E3*Math.random();if("FOREGROUND_HEARTBEAT_TRIGGER_ON_INTERVAL"!=a||!(g.jh()>b)&&"visible"==g.Kg()){b=-1;g.Ui&&(b=Math.round((0,g.tg)()-g.Ui));var c=String;var d=g.u("_fact",window);d=null==d||-1==d?-1:Math.max((0,g.$c)()-d,0);a={firstActivityMs:c(d),clientDocumentNonce:pi,index:String(Vi),lastEventDeltaMs:String(b),trigger:a};g.ph("foregroundHeartbeat",
a,g.Yh);g.r("_fact",-1,window);Vi++;g.Ui=(0,g.tg)()}};
g.Xi=function(a,b,c,d,e){this.name=a;this.deps=b||[];this.page=c||"";this.L=d?Yf(d):null;this.H=e?Yf(e):null;this.G=[];this.C=this.F=0};
g.Yi=function(a){g.bh(a.F);a.F=g.ah((0,g.v)(a.init,a))};
...
g.fj=function(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=g.Qb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=g.Eb(g.Ib(a)),"about:invalid#zClosurez"===a?a="":(a=g.$b(g.bc(a)),a=g.gc(g.of(a))),g.pb(a)||(a=g.nd("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),g.td(a).body.appendChild(a))):e?Hh(a,b,"POST",e,d):g.E("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Hh(a,b,"GET","",d):oba(a,b)||pba(a,b))};
oba=function(a,b){if(!Qf("web_use_beacon_api_for_ad_click_server_pings"))return!1;if(Qf("use_sonic_library_for_v4_support"))try{var c=g.nc(g.pc(5,a));if(!c||!c.endsWith("/aclk")||!(new kaa({url:a})).C)return!1}catch(d){return g.Zf(Error("ClickUrl library throws error, url = "+a)),!1}else if(c=g.nc(g.pc(5,a)),!c||-1==c.indexOf("/aclk")||"1"!==g.Ac(a,"ae")||"1"!==g.Ac(a,"act"))return!1;return gj(a)?(b&&b(),!0):!1};
...
pba=function(a,b){var c=new Image,d=""+qba++;hj[d]=c;c.onload=c.onerror=function(){b&&hj[d]&&b();delete hj[d]};
c.src=a};
g.ij=function(a,b){a=a||"";var c=a.match(rba);spf.style.load(a,c?c[1]:"",b)};
...
g.oj=function(a,b,c){var d=void 0===d?!0:d;var e=g.E("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=g.qc(window.location.href);f&&e.push(f);f=g.qc(a);if(g.Ma(e,f)||!f&&g.nb(a,"/"))if(g.Sf("autoescape_tempdata_url")&&(e=document.createElement("a"),g.dc(e,a),a=e.href),a&&(a=g.rc(a),e=a.indexOf("#"),a=0>e?a:a.substr(0,e)))d&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:g.yi()},b)),c?(c=parseInt(c,10),isFinite(c)&&0<c&&(d="ST-"+g.lc(a).toString(36),b=b?g.wc(b):"",g.Sh(d,b,c||5))):(c=b,b="ST-"+g.lc(a).toString(36),
...
vj=function(a,b,c,d){g.C.call(this);var e=this;this.L=this.Ya=a;this.ha=b;this.M=!1;this.api={};this.na=this.N=null;this.Y=new g.rf;g.Sd(this,this.Y);this.G={};this.la=this.qa=this.F=this.nb=this.C=null;this.T=!1;this.H=this.J=null;this.ib={};this.Pd=["onReady"];this.kb=null;this.sb=NaN;this.W={};this.D=d;sj(this);this.Jh("WATCH_LATER_VIDEO_ADDED",this.iD.bind(this));this.Jh("WATCH_LATER_VIDEO_REMOVED",this.jD.bind(this));this.Jh("onAdAnnounce",this.Ct.bind(this));this.Hb=new ki(this);g.Sd(this,this.Hb);
this.aa=0;c?this.aa=g.$f(function(){e.loadNewVideoConfig(c)},0):d&&(tj(this),uj(this))};
...
uj=function(a){if(!a.qb()&&!a.T){var b=zj(a);if(b&&"html5"==(xj(a)?"html5":null))a.la="html5",a.M||Aj(a);else if(Bj(a),a.la="html5",b&&a.H)a.Ya.appendChild(a.H),Aj(a);else{a.C&&(a.C.loaded=!0);var c=!1;a.J=function(){c=!0;if(a.D)var d=a.D.serializedExperimentFlags;else a.C&&a.C.args&&(d=a.C.args.fflags);d="true"==qh(d||"").player_bootstrap_method?g.u("yt.player.Application.createAlternate")||g.u("yt.player.Application.create"):g.u("yt.player.Application.create");var e=a.C?a.C.clone():void 0;d(a.Ya,
e,a.D);Aj(a)};
a.T=!0;b?a.J():(g.mg(yj(a),a.J),(b=a.D?a.D.cssUrl:a.C.assets.css)&&g.ij(b),Cj(a)&&!c&&g.r("yt.player.Application.create",null,void 0))}}};
xj=function(a){var b=g.z(a.F);!b&&a.L&&a.L.querySelector&&(b=a.L.querySelector("#"+a.F));return b};
Aj=function(a){if(!a.qb()){var b=xj(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.T=!1,b.isNotServable&&a.C&&b.isNotServable(a.C.args.video_id)||sba(a)):a.sb=g.$f(function(){Aj(a)},50)}};
sba=function(a){sj(a);a.M=!0;var b=xj(a);b.addEventListener&&(a.N=Dj(a,b,"addEventListener"));b.removeEventListener&&(a.na=Dj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Dj(a,b,e))}for(var f in a.G)a.N(f,a.G[f]);wj(a);a.qa&&a.qa(a.api);a.Y.oa("onReady",a.api)};
Dj=function(a,b,c){var d=b[c];return function(){try{return a.kb=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.kb=e,g.Zf(e))}}};
sj=function(a){a.M=!1;if(a.na)for(var b in a.G)a.na(b,a.G[b]);for(var c in a.W)g.bg(parseInt(c,10));a.W={};a.N=null;a.na=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Jh.bind(a);a.api.removeEventListener=a.RF.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.gv.bind(a);a.api.getPlayerType=a.tv.bind(a);a.api.getCurrentVideoConfig=a.Zu.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.dz.bind(a)};
Ej=function(a,b){var c=b;if("string"==typeof b){if(a.ib[b])return a.ib[b];c=function(){var d=g.u(b);d&&d.apply(g.q,arguments)};
a.ib[b]=c}return c?c:null};
tba=function(a,b){var c="ytPlayer"+b+a.ha;a.G[b]=c;g.q[c]=function(d){var e=g.$f(function(){a.qb()||(a.Y.oa(b,d),g.Xa(a.W,String(e)))},0);
g.Ya(a.W,String(e),!0)};
return c};
Bj=function(a){a.cancel();sj(a);a.la=null;a.C&&(a.C.loaded=!1);var b=xj(a);b&&(zj(a)||!Cj(a)?a.H=b:(b&&b.destroy&&b.destroy(),a.H=null));g.rd(a.Ya)};
...
g.Hj=function(a,b){var c=void 0===c?!0:c;a="string"===typeof a?g.gd(a):a;var d=g.Fj+"_"+g.Ga(a),e=g.Gj[d];if(e&&c)return b&&b.args&&b.args.fflags&&b.args.fflags.includes("web_player_remove_playerproxy=true")?e.api.loadVideoByPlayerVars(b.args||null):e.loadNewVideoConfig(b),e.api;e=new vj(a,d,b,void 0);g.Gj[d]=e;g.H("player-added",e.api);g.Qd(e,g.w(uba,e));return e.api};
uba=function(a){delete g.Gj[a.getId()]};
...
g.Mj=function(a){var b=new g.ai("Error accessing DB");return Kj().then(function(c){return new Promise(function(d,e){try{var f=c.transaction("swpushnotificationsstore").objectStore("swpushnotificationsstore").get(a);f.onsuccess=function(){var k=f.result;d(k?k.value:null)};
...
wba=function(){this.timing={};this.clearResourceTimings=function(){};
...
Vj=function(){return g.Sf("csi_use_time_origin")&&Sj.timeOrigin?Math.floor(Sj.timeOrigin):Sj.timing.navigationStart};
...
ek=function(a){var b=Qj(a||""),c=Rj(a);c&&!dk&&(g.Ei(xba,new Oj(Math.round(c-b._start),a)),dk=!0)};
yba=function(){if(Sj.getEntriesByType){var a=Sj.getEntriesByType("paint");if(a=g.Ka(a,function(b){return"first-paint"===b.name}))return Tj(a.startTime)}a=Sj.timing;
...
lk=function(a,b){kk[b]=kk[b]||{count:0};var c=kk[b];c.count++;c.time=(0,g.tg)();a.C||(a.C=g.$g(function(){var d=(0,g.tg)(),e;for(e in kk)kk[e]&&6E4<d-kk[e].time&&delete kk[e];a&&(a.C=0)},5E3));
...
mk=function(a){return!!g.E("FORCE_CSI_ON_GEL",!1)||g.Sf("csi_on_gel")||!!ak(a).useGel};
ok=function(a,b,c){var d=nk(c);d.gelTicks&&(d.gelTicks["tick_"+a]=!0);c||b||(0,g.tg)();return mk(c)?(hk(c||"").tick[a]=b||(0,g.tg)(),d=ck(c),"_start"===a?(a=jk(),lk(a,"baseline_"+d)||g.Zh("latencyActionBaselined",{clientActionNonce:d},{timestamp:b})):jk().tick(a,d,b),ek(c),!0):!1};
rk=function(a,b,c){c=nk(c);if(c.gelInfos)c.gelInfos["info_"+a]=!0;else{var d={};c.gelInfos=(d["info_"+a]=!0,d)}if(a in pk){c=pk[a];g.Ma(zba,c)&&(b=!!b);a in qk&&"string"===typeof b&&(b=qk[a]+b.toUpperCase());a=c.split(".");d=c={};for(var e=0;e<a.length-1;e++){var f=a[e];d[f]={};d=d[f]}d[a[a.length-1]]=b;return lj({},c)}g.Ma(Aba,a)||g.ci(new g.ai("Unknown label logged with GEL CSI",a))};
...
vk=function(){Zj(void 0);Bba();Yj(!1,void 0);g.E("TIMING_ACTION")&&g.Nf("PREVIOUS_ACTION",g.E("TIMING_ACTION"));g.Nf("TIMING_ACTION","")};
Fba=function(){var a=g.E("TIMING_ACTION",void 0),b=g.E("TIMING_AFT_KEYS");hk("").info.actionType=a;b&&g.Nf("TIMING_AFT_KEYS",b);g.Nf("TIMING_ACTION",a);a=g.E("TIMING_INFO",{});for(var c in a)uk(c,a[c]);uk("is_nav",1);(c=g.yi())&&uk("csn",c);(c=g.E("PREVIOUS_ACTION",void 0))&&!mk()&&uk("pa",c);c=bk();a=g.E("CLIENT_PROTOCOL");b=g.E("CLIENT_TRANSPORT");a&&uk("p",a);b&&uk("t",b);uk("yt_vis",Cba());if("cold"==c.yt_lt){uk("yt_lt","cold");a=Uj();if(b=Vj())g.wk("srt",a.responseStart),1!=c.prerender&&xk("n",
b);c=yba();0<c&&g.wk("fpt",c);yk();Sj.getEntriesByType&&Dba();c=[];if(document.querySelector&&Sj&&Sj.getEntriesByName)for(var d in zk)a=zk[d],Eba(d,a)&&c.push(a);c.length&&uk("rc",c.join(","))}mk(void 0)&&(d={actionType:Ak[g.E("TIMING_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN",previousAction:Ak[g.E("PREVIOUS_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN"},c=ck(void 0),jk().info(d,c));d=bk();a=Qj();if("cold"===d.yt_lt&&(c=nk(),b=c.gelTicks?c.gelTicks:c.gelTicks={},c=c.gelInfos?c.gelInfos:c.gelInfos={},
...
g.wk=function(a,b,c){var d=Qj(c);if(g.Sf("use_first_tick")&&Ck(a,c))return d[a];if(!b&&"_"!=a[0]){var e=a;Sj.mark&&(g.nb(e,"mark_")||(e="mark_"+e),c&&(e+=" ("+c+")"),Sj.mark(e))}e=b||(0,g.tg)();d[a]=e;ok(a,b,c)||(g.Bk(!1,c),hk(c||"").tick[a]=b||(0,g.tg)());return d[a]};
...
Cba=function(){switch(g.Kg()){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3}return-1};
Ek=function(a){if(!mk(a)){var b=Qj(a),c=bk(a),d=b._start,e=g.E("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:g.E((a||"")+"TIMING_ACTION",void 0)},k=c.srt;void 0!==b.srt&&delete c.srt;if(c.h5jse){var l=window.location.protocol+g.u("ytplayer.config.assets.js");(l=Sj.getEntriesByName?Sj.getEntriesByName(l)[0]:void 0)?c.h5jse=Math.round(c.h5jse-l.responseEnd):delete c.h5jse}b.aft=Rj(a);var m=Qj(a);l=m.pbr;var p=m.vc;m=m.pbs;l&&p&&m&&l<p&&p<m&&bk(a).yt_pvis&&"youtube"==e&&(uk("yt_lt","hot_bg",a),e=b.vc,
l=b.pbs,delete b.aft,c.aft=Math.round(l-e));for(var t in c)"_"!=t.charAt(0)&&(f[t]=c[t]);b.ps=(0,g.tg)();t={};e=[];for(var y in b)"_"!=y.charAt(0)&&(l=Math.round(b[y]-d),t[y]=l,e.push(y+"."+l));f.rt=e.join(",");(b=g.u("ytdebug.logTiming"))&&b(f,t);c=!!c.ap;g.Sf("debug_csi_data")&&(b=g.u("yt.timing.csiData"),b||(b=[],g.r("yt.timing.csiData",b,void 0)),b.push({page:location.href,time:new Date,args:f}));b="";for(var A in f)f.hasOwnProperty(A)&&(b+="&"+A+"="+f[A]);f="/csi_204?"+b.substring(1);if(window.navigator&&
window.navigator.sendBeacon&&c){var G=void 0===G?"":G;gj(f,G)||g.fj(f,void 0,void 0,void 0,G)}else g.fj(f);Yj(!0,a);g.Ei(Gba,new Pj(t.aft+(k||0),a))}};
...
Dba=function(){var a=window.location.protocol,b=Sj.getEntriesByType("resource");b=(0,g.Gk)(b,function(c){return 0==c.name.indexOf(a+"//web.archive.org/web/20200401000101/https://fonts.gstatic.com/s/")});
...
Eba=function(a,b){var c=document.querySelector(a);if(!c)return!1;var d="",e=c.nodeName;"SCRIPT"==e?(d=c.src,d||(d=c.getAttribute("data-timing-href"))&&(d=window.location.protocol+d)):"LINK"==e&&(d=c.href);g.wa()&&c.setAttribute("nonce",g.wa());return d?(c=Sj.getEntriesByName(d))&&c[0]&&(c=c[0],d=Vj(),g.wk("rsf_"+b,d+Math.round(c.fetchStart)),g.wk("rse_"+b,d+Math.round(c.responseEnd)),void 0!==c.transferSize&&(d=bk(void 0),e=sk(void 0),"rc"in d||"rc"in e||uk("rc",""),0===c.transferSize))?!0:!1:!1};
Mba=function(){Ik++;var a=g.kd(),b=new g.zd(0,0,a.width,a.height);Dk("vph",a.height);Dk("vpw",a.width);g.wk("vpc");a=document.querySelectorAll(".yt-lockup-thumbnail img[data-ytimg]");var c=a.length,d=[];Jk.start();for(var e=0;e<c;e++){var f=a[e];Kk(f,b)&&(f=Hba(f),f.then(Iba),d.push(f),Lk.push(f))}g.wk("vpcc");b=g.Ne(d).then(Jba);g.Pe(b,Kba);b.then(Lba);Lk.push(b);return b};
Lba=function(){Jk.stop()};
Kba=function(){g.wk("vpr")};
Kk=function(a,b){for(var c=a,d=[];c!=document.body;){var e=g.Jg(c);if(e in Mk)return!0;if(e in Nk)return!1;var f=window.getComputedStyle(c);if("none"==f.display||"hidden"==f.visibility)return Nk[e]=!0,!1;f=c.getBoundingClientRect();if(!(b.left<=f.left+f.width&&f.left<=b.left+b.width&&b.top<=f.top+f.height&&f.top<=b.top+b.height))return Nk[e]=!0,!1;d.push(e);c=c.parentElement}for(c=0;c<d.length;c++)Mk[d[c]]=!0;return!0};
Jba=function(a){var b=g.kd();b=new g.zd(0,0,b.width,b.height);for(var c=0,d=0,e=a.length;d<e;d++){var f=a[d].time;Kk(a[d].cy,b)&&c<f&&(c=f)}return c};
Hba=function(a){var b=Ik;return new g.He(function(c,d){var e={cy:a,time:0};a.loadTime?(e.time=parseInt(a.loadTime,10),c(e)):(a.slt=function(){Ik!=b?d():(e.time=parseInt(a.loadTime,10),c(e),a.slt=void 0)},Ok.push(a))})};
Iba=function(a){Jk.start();a=a.time;Pk<a&&(Pk=a,g.wk("lim",a))};
Nba=function(){g.wk("vptl",Pk);g.wk("vpl",Pk)};
Oba=function(){Lk.forEach(function(a){a.cancel()});
Pk=Lk.length=0;Mk={};Nk={};Ok.forEach(function(a){a.slt=void 0});
Ok.length=0};
g.Qk=function(a,b){g.fj("/gen_204?"+a,b)};
Pba=function(a){if(null==a)return[];var b=[];g.Sf("ima_prevent_mpu_queries_on_cached_playback")&&0>Rk.indexOf("ad3_module")&&Rk.push("ad3_module");Rk.forEach(function(c){c in a&&(delete a[c],b.push(c))});
a.cached_load="1";return b};
g.Sk=function(){return g.D(g.z("page-container"),"remote-connected")};
Qba=function(){Tk=g.ag(Uk,5E3);var a=g.Vk();a&&(a.addEventListener("onReady",Uk),a.addEventListener("onStateChange",Uk))};
Wk=function(a){for(var b in g.Gj){var c=g.Gj[b];c&&c.cancel()}if(a=a||null)g.Hj("player-api",a),a=g.mi(a),a.loaded=!0;Uk();g.r("ytplayer.config",a,void 0)};
...
Rba();g.E("CSI_VIEWPORT")&&(Xk=Mba(),Xk.then(function(a){g.wk("vpl",a);Xk=null},function(){}))};
Rba=function(){Zk("init");var a=g.E("PAGE_NAME",void 0);a&&Zk("init-"+a)};
Zk=function(a){g.eh()?$k.push(g.ah(g.w(g.kg,a),0)):g.H(a)};
al=function(){g.ch($k);$k.length=0;Oba();Xk&&(Xk.cancel(),Xk=null);var a=g.E("PAGE_NAME",void 0);a&&g.kg("dispose-"+a);g.kg("dispose")};
Sba=function(){Yk()};
Tba=function(){g.E("TIMING_REPORT_ON_UNLOAD")&&g.Bk(!0);Fk("u");g.Wi("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND");Si();g.$h();g.Dg();al();g.kg("pageunload")};
bl=function(){g.fh()};
cl=function(){window.yt_spf_loaded_history=!0;g.fh()};
hl=function(){dl=1;el=fl=0;g.E("TIMING_REPORT_ON_UNLOAD")&&g.Bk(!0);if(g.Sf("warm_load_nav_start_web")){var a=gk();a[""]&&delete a[""];var b={timerName:"",info:{},tick:{}};fk().push(b);a[""]=b;Fk("n");vk();Wj(!1);g.Nf("TIMING_AFT_KEYS",[]);uk("yt_lt","warm");g.Nf("TIMING_ACTION","");g.Nf("TIMING_WAIT",[]);delete g.E("TIMING_INFO",{}).yt_lt;xk("n")}else Fk("n"),vk(),xk("n");a="nr";Sj.mark&&(g.nb(a,"mark_")||(a="mark_"+a),Sj.mark(a));gl(Uba);Si();g.kg("navigate")};
kl=function(a){a=a.detail.part||a.detail.partial;g.wk("nc"+fl);++fl;if(a&&a.data&&a.data.deferDispose)"watch"==a.name&&g.wk("bc");else{var b=1==dl;dl=2;b?(gl(Vba),il()):gl(Wba);if(b=a&&a.data&&a.data.swfcfg)jl(a.timing,b.args),Ck("cfg")||g.wk("cfg"),Wk(b)}};
ll=function(){g.wk("np"+el);++el};
ml=function(a){a=a.detail.response;var b=1==dl;dl=3;b&&(gl(Xba),il());if(b=a.data&&a.data.swfcfg)jl(a.timing,b.args),Ck("cfg")||g.wk("cfg"),Wk(b)};
ql=function(a){g.wk("nd");a=a.detail.response;g.nl=a.cacheKey;a=a.timing;var b=window._spf_state;g.ol.navigationCount=b&&b["nav-counter"]||0;g.Sf("warm_load_nav_start_web")?g.wk("srt",a.responseStart):(xk("ne",a.responseStart),b=Uj().responseStart,Dk("srt",Math.max(0,b-Vj())));Dk("yt_lt",a.spfCached?"hot":"warm");g.wk("pfs",a.fetchStart);g.wk("pfrs",a.responseStart);"redirectStart"in a&&yk();gl(pl);document.getElementById("content").style.height="";Yk();dl=0};
rl=function(a){var b=a.detail.url,c=a.detail.err;c&&(a=a.detail.xhr,a&&!a.responseText||a&&a.responseText&&a.responseText.startsWith("<")||(c.params=b,g.Zf(c)))};
...
gl=function(a){var b=document.getElementById("progress");b||(b=document.createElement("div"),b.id="progress",b.appendChild(document.createElement("dt")),b.appendChild(document.createElement("dd")),document.body.appendChild(b));g.bh(tl);tl=g.ah(function(){var c=a[0],d=a[1],e=a[2];b.className="";var f=b.style;f.transitionDuration=f.webkitTransitionDuration=c+"ms";f.width=d+"%";g.bg(ul);ul=g.$f(function(){b.className=e},c)},0)};
Yba=function(){var a=pl[0]+50;g.bg(ul);ul=g.$f(function(){var b=document.getElementById("progress");b&&b.parentNode.removeChild(b)},a)};
jl=function(a,b){var c=a&&a.spfCached,d=a&&a.spfPrefetched,e=[];c&&!d&&null!=b&&(e=Pba(b));g.E("EXP_DEBUG_PREFETCH")&&(e.sort(),c={a:"updatePlayerVarsForCachedLoad",cached:c,prefetched:d,deleted:e.join("")},g.Qk(g.wc(c)))};
...
vl=function(){var a=Uf("service_worker_scope");try{return navigator.serviceWorker.getRegistration(a)}catch(b){return Promise.reject(b)}};
aca=function(){return vl().then(zl)["catch"](function(){return!1})};
...
bca=function(){if(!g.E("LOGGED_IN",void 0))return Promise.resolve(!1);var a=Uf("service_worker_push_force_notification_prompt_tag");return a?g.Mj("PromptTags").then(function(b){if(!b)return!0;var c=[];try{c=JSON.parse(b)}catch(d){return!1}return c&&-1==c.indexOf(a)}):Promise.resolve(!1)};
fca=function(){var a=void 0===a?!1:a;return(navigator.serviceWorker&&navigator.serviceWorker.getRegistration&&window.Notification?aca():Promise.resolve(!1)).then(function(b){if(!b)return Promise.resolve();b=wl().then(function(){return xl({type:"notifications_check_registration",data:g.E("ID_TOKEN")})});
return"default"!=Notification.permission?b:b.then(function(){return cca(a)}).then(function(c){if(c)return dca(),eca().then(function(){})})["catch"](function(){})})};
cca=function(a){return g.E("SERVICE_WORKER_PROMPT_NOTIFICATIONS",void 0)||g.E("LOGGED_IN",void 0)&&(void 0===a?0:a)?bca().then(function(b){if(b)return!0;b=[gca(),hca()];g.E("LOGGED_IN",void 0)||b.push(ica());return Promise.all(b).then(function(c){return c.every(function(d){return d})})}):Promise.resolve(!1)};
ica=function(){var a=g.Tf("service_worker_push_logged_out_prompt_watches");return-1==a?Promise.resolve(!1):g.Mj("WatchCount").then(function(b){return b>=a})};
eca=function(){var a=arguments;g.Sf("service_worker_push_prompt_modal_enable")&&jca();return Notification.requestPermission().then(function(b){Al();var c=document.getElementById("ticker");c&&(c.className=c.classList.remove("show"));if("granted"==b)return wl().then(function(){g.Lj("NotificationsDisabled",!1);yl();return Promise.resolve(!0)});
"denied"==b&&yl();return Promise.resolve(!1)})["catch"](function(){Al();
return Promise.reject.apply(Promise,g.la(a))})};
dca=function(){g.Mj("PromptCount").then(function(a){return g.Lj("PromptCount",a+1)}).then(function(){return g.Lj("PromptTime",(0,g.$c)())}).then(function(){var a=Uf("service_worker_push_force_notification_prompt_tag");
...
gca=function(){return-1==g.Tf("service_worker_push_prompt_cap")?Promise.resolve(!0):g.Mj("PromptCount").then(function(a){a||(a=0);return Promise.resolve(a<g.Tf("service_worker_push_prompt_cap"))})};
hca=function(){var a=g.Tf("service_worker_push_prompt_delay_microseconds");return a?g.Mj("PromptTime").then(function(b){return Promise.resolve((0,g.$c)()-a>(b||0))}):Promise.resolve(!0)};
kca=function(){Bl||Al()};
...
jca=function(){var a=g.z("yt-push-prompt-modal-bg");Bl=g.Sf("service_worker_push_prompt_modal_ignore_click");a?Cl(a):(a=g.nd("div",{id:"yt-push-prompt-modal-bg"}),Cl(a),document.body.appendChild(a),g.Wg(document,"click",kca))};
Al=function(){var a=g.z("yt-push-prompt-modal-bg");a&&g.sd(a)};
lca=function(a){return zl(a)?fca():Promise.resolve()};
nca=function(){navigator.serviceWorker.getRegistrations().then(function(a){a.forEach(mca)})};
pca=function(){var a="/sw.js",b=g.E("SERVICE_WORKER_VFL",void 0);b&&(a+="?vfl="+b);try{var c=Dl(a)["catch"](function(){return new Promise(function(){})});
g.Sf("service_worker_push_enabled")&&c.then(oca).then(lca)}catch(d){if("SecurityError"!=d.name)throw d;}};
oca=function(a){var b=a.installing||a.waiting;return a.active||!b?Promise.resolve(a):new Promise(function(c){function d(e){if("activated"==e.target.state||"redundant"==e.target.state)b.removeEventListener("statechange",d),c(a)}
b.addEventListener("statechange",d)})};
mca=function(a){a&&Dl("/sw.js?0",a.scope)};
Dl=function(a,b){return navigator.serviceWorker.register(a,{scope:b||Uf("service_worker_scope")||"/"})};
...
if("function"==typeof Object.setPrototypeOf)Gl=Object.setPrototypeOf;else{var Hl;a:{var qca={a:!0},Il={};try{Il.__proto__=qca;Hl=Il.a;break a}catch(a){}Hl=!1}Gl=Hl?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var na=Gl;
...
b.prototype.then=function(k,l){function m(A,G){return"function"==typeof A?function(O){try{p(A(O))}catch(T){t(T)}}:G}
var p,t,y=new b(function(A,G){p=A;t=G});
this.Qh(m(k,p),m(l,t));return y};
b.prototype["catch"]=function(k){return this.then(void 0,k)};
b.prototype.Qh=function(k,l){function m(){switch(p.F){case 1:k(p.D);break;case 2:l(p.D);break;default:throw Error("Unexpected state: "+p.F);}}
var p=this;null==this.C?f.F(m):this.C.push(m)};
b.resolve=d;b.reject=function(k){return new b(function(l,m){m(k)})};
b.race=function(k){return new b(function(l,m){for(var p=g.ka(k),t=p.next();!t.done;t=p.next())d(t.value).Qh(l,m)})};
b.all=function(k){var l=g.ka(k),m=l.next();return m.done?d([]):new b(function(p,t){function y(O){return function(T){A[O]=T;G--;0==G&&p(A)}}
...
var rca="function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(d)for(var e in d)ta(d,e)&&(a[e]=d[e])}return a};
pa("Object.assign",function(a){return a||rca});
pa("WeakMap",function(a){function b(m){this.pb=(l+=Math.random()+1).toString();if(m){m=g.ka(m);for(var p;!(p=m.next()).done;)p=p.value,this.set(p[0],p[1])}}
function c(){}
...
var k="$jscomp_hidden_"+Math.random();f("freeze");f("preventExtensions");f("seal");var l=0;b.prototype.set=function(m,p){if(!d(m))throw Error("Invalid WeakMap key");e(m);if(!ta(m,k))throw Error("WeakMap key fail: "+m);m[k][this.pb]=p;return this};
...
function d(l,m){var p=m&&typeof m;"object"==p||"function"==p?f.has(m)?p=f.get(m):(p=""+ ++k,f.set(m,p)):p="p_"+m;var t=l.C[p];if(t&&ta(l.C,p))for(var y=0;y<t.length;y++){var A=t[y];if(m!==m&&A.key!==A.key||m===A.key)return{id:p,list:t,index:y,lc:A}}return{id:p,list:t,index:-1,lc:void 0}}
...
g.ja();var f=new WeakMap;e.prototype.set=function(l,m){l=0===l?0:l;var p=d(this,l);p.list||(p.list=this.C[p.id]=[]);p.lc?p.lc.value=m:(p.lc={next:this.F,previous:this.F.previous,head:this.F,key:l,value:m},p.list.push(p.lc),this.F.previous.next=p.lc,this.F.previous=p.lc,this.size++);return this};
...
var sca=function(){function a(){function c(){}
...
g.Jl=g.Jl||{};g.q=this||self;caa=/^[\w+/_-]+[=]{0,2}$/;va=null;Fa="closure_uid_"+(1E9*Math.random()>>>0);daa=0;g.$c=Date.now||function(){return+new Date};g.x(g.Ia,Error);g.Ia.prototype.name="CustomError";g.La=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if("string"===typeof a)return"string"!==typeof b||1!=b.length?-1:a.indexOf(b,0);
...
return!0};g.uca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.vca=RegExp("^[^\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.Nl=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0900-\u1fff\u200e\u2c00-\ud801\ud804-\ud839\ud83c-\udbff\uf900-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u08ff\u200f\ud802-\ud803\ud83a-\ud83b\ufb1d-\ufdff\ufe70-\ufefc]");var bb="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");g.fb.prototype.Md=!0;g.fb.prototype.Uc=function(){return this.C};
var eb={},db={},Aaa=g.hb("");var jb;g.kb.prototype.Md=!0;g.kb.prototype.Uc=function(){return this.F.toString()};
...
qb=/&/g;rb=/</g;sb=/>/g;tb=/"/g;ub=/'/g;vb=/\x00/g;haa=/[\x00&<>"']/;g.Db.prototype.Md=!0;g.Db.prototype.Uc=function(){return this.F.toString()};
g.Db.prototype.Rk=!0;g.Db.prototype.C=function(){return 1};
var jaa=/^(?:audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font\/\w+|image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|text\/csv|video\/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\w+=(?:\w+|"[\w;,= ]+"))*$/i,iaa=/^data:(.*);base64,[a-z0-9+\/]+=*$/i,Hb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,Cb={},Bb={};g.Lb.prototype.Md=!0;g.Kb={};g.Lb.prototype.Uc=function(){return this.C};
g.Ol=g.Mb("");g.Pl=RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))","g");g.Ql=RegExp("\\b(calc|cubic-bezier|fit-content|hsl|hsla|linear-gradient|matrix|minmax|repeat|rgb|rgba|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-+*/0-9a-z.%\\[\\], ]+\\)","g");g.Ob.prototype.Md=!0;g.Nb={};g.Ob.prototype.Uc=function(){return this.C};
g.wca=g.Pb("");a:{var Rl=g.q.navigator;if(Rl){var Sl=Rl.userAgent;if(Sl){g.Qb=Sl;break a}}g.Qb=""};g.Yb.prototype.Rk=!0;g.Yb.prototype.C=function(){return this.D};
g.Yb.prototype.Md=!0;g.Yb.prototype.Uc=function(){return this.F.toString()};
var Xb={};g.cc("<!DOCTYPE html>",0);g.ue=g.cc("",0);g.Tl=g.cc("<br>",0);g.xca=g.Sa(function(){var a=document.createElement("div"),b=document.createElement("div");b.appendChild(document.createElement("div"));a.appendChild(b);b=a.firstChild.firstChild;a.innerHTML=g.Zb(g.ue);return!b.parentElement});g.jc=String.prototype.repeat?function(a,b){return a.repeat(b)}:function(a,b){return Array(b+1).join(a)};g.oc=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^\\/?#]*)@)?([^\\/?#]*?)(?::([0-9]+))?(?=[\\/?#]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;g.zc=/#|$/;g.Dc[" "]=g.xa;var am,laa,em;g.Ul=g.Rb("Opera");g.Df=g.Sb();g.Vl=g.Rb("Edge");g.Wl=g.Vl||g.Df;g.Xl=g.Rb("Gecko")&&!(g.xb(g.Qb.toLowerCase(),"webkit")&&!g.Rb("Edge"))&&!(g.Rb("Trident")||g.Rb("MSIE"))&&!g.Rb("Edge");g.Yl=g.xb(g.Qb.toLowerCase(),"webkit")&&!g.Rb("Edge");g.Zl=g.Rb("Macintosh");g.$l=g.Rb("Windows");g.yca=g.Rb("Linux")||g.Rb("CrOS");g.zca=g.Rb("Android");g.Aca=Bc();g.Bca=g.Rb("iPad");g.Cca=g.Rb("iPod");g.Dca=g.Cc();
a:{var bm="",cm=function(){var a=g.Qb;if(g.Xl)return/rv:([^\);]+)(\)|;)/.exec(a);if(g.Vl)return/Edge\/([\d\.]+)/.exec(a);if(g.Df)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(g.Yl)return/WebKit\/(\S+)/.exec(a);if(g.Ul)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
cm&&(bm=cm?cm[1]:"");if(g.Df){var dm=Fc();if(null!=dm&&dm>parseFloat(bm)){am=String(dm);break a}}am=bm}g.Gc=am;laa={};if(g.q.document&&g.Df){var fm=Fc();em=fm?fm:parseInt(g.Gc,10)||void 0}else em=void 0;g.Ic=em;g.gm=Tb();g.hm=Bc()||g.Rb("iPod");g.im=g.Rb("iPad");g.Eca=g.Wb();g.jm=Ub();g.km=g.Vb()&&!g.Cc();var Lc={},Oc=null;g.Pc.prototype.next=function(){return this.C<this.F.length?{done:!1,value:this.F[this.C++]}:{done:!0,value:void 0}};
"undefined"!=typeof Symbol&&(g.Pc.prototype[Symbol.iterator]=function(){return this});g.Uc="function"==typeof Uint8Array;g.Qc.prototype.Zc=function(){Rc(this);return this.ec};
g.Qc.prototype.F=g.Uc?function(){var a=Uint8Array.prototype.toJSON;Uint8Array.prototype.toJSON=function(){return Mc(this)};
try{return JSON.stringify(this.ec&&this.Zc(),Sc)}finally{Uint8Array.prototype.toJSON=a}}:function(){return JSON.stringify(this.ec&&this.Zc(),Sc)};
g.Qc.prototype.toString=function(){Rc(this);return this.ec.toString()};
g.Qc.prototype.clone=function(){return new this.constructor(Tc(this.Zc()))};g.lm=document;g.Dd=window;g.h=g.Vc.prototype;g.h.isEnabled=function(){return navigator.cookieEnabled};
g.h.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.lR;d=c.secure||!1;var f=c.domain||void 0;var k=c.path||void 0;var l=c.wl}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===l&&(l=-1);c=f?";domain="+f:"";k=k?";path="+k:"";d=d?";secure":"";l=0>l?"":0==l?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date((0,g.$c)()+1E3*l)).toUTCString();this.C.cookie=a+"="+b+c+k+l+d+(null!=e?";samesite="+
e:"")};
...
g.nm=g.mm;g.nm=g.mm;g.h=g.ad.prototype;g.h.xe=g.nm.ua;g.h.Mg=g.nm.va;g.h.clone=function(){var a=new g.ad(this.date);a.xe=this.xe;a.Mg=this.Mg;return a};
...
g.h.valueOf=function(){return this.date.valueOf()};var oaa;oaa=!g.Df||g.Jc(9);g.Fca=!g.Xl&&!g.Df||g.Df&&g.Jc(9)||g.Xl&&g.Hc("1.9.1");g.om=g.Df&&!g.Hc("9");g.Gca=g.Df||g.Ul||g.Yl;g.h=g.bd.prototype;g.h.clone=function(){return new g.bd(this.x,this.y)};
g.h.equals=function(a){return a instanceof g.bd&&g.cd(this,a)};
...
g.h.round=function(){this.x=Math.round(this.x);this.y=Math.round(this.y);return this};g.h=g.ed.prototype;g.h.clone=function(){return new g.ed(this.width,this.height)};
...
g.h.round=function(){this.width=Math.round(this.width);this.height=Math.round(this.height);return this};var hd={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};var Hca={KJ:"allow-forms",LJ:"allow-modals",MJ:"allow-orientation-lock",NJ:"allow-pointer-lock",OJ:"allow-popups",PJ:"allow-popups-to-escape-sandbox",QJ:"allow-presentation",RJ:"allow-same-origin",SJ:"allow-scripts",TJ:"allow-top-navigation",UJ:"allow-top-navigation-by-user-activation"},qaa=g.Sa(function(){return g.xd(Hca)});g.ya(g.yd);g.h=g.zd.prototype;g.h.clone=function(){return new g.zd(this.left,this.top,this.width,this.height)};
g.h.contains=function(a){return a instanceof g.bd?a.x>=this.left&&a.x<=this.left+this.width&&a.y>=this.top&&a.y<=this.top+this.height:this.left<=a.left&&this.left+this.width>=a.left+a.width&&this.top<=a.top&&this.top+this.height>=a.top+a.height};
...
g.h.round=function(){this.left=Math.round(this.left);this.top=Math.round(this.top);this.width=Math.round(this.width);this.height=Math.round(this.height);return this};g.pm=g.Xl?"MozUserSelect":g.Yl||g.Vl?"WebkitUserSelect":null;g.qm=!!window.google_async_iframe_id;g.rm=g.qm&&window.parent||window;g.mb(g.hb("//web.archive.org/web/20200401000101/https://fonts.googleapis.com/css"));g.zh=(new Date).getTime();/*
...
*/
Md.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.C[a]!=b&&(this.C[a]=b,this.F=-1)};
...
g.Td.prototype.preventDefault=function(){this.defaultPrevented=!0};var ie,Jca,yaa;g.Ica=!g.Df||g.Jc(9);ie=!g.Df||g.Jc(9);Jca=g.Df&&!g.Hc("9");yaa=function(){if(!g.q.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
try{g.q.addEventListener("test",g.xa,b),g.q.removeEventListener("test",g.xa,b)}catch(c){}return a}();g.sm=g.Yl?"webkitTransitionEnd":g.Ul?"otransitionend":"transitionend";g.x(g.Ud,g.Td);var Kca={2:"touch",3:"pen",4:"mouse"};
g.Ud.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.currentTarget=b;var e=a.relatedTarget;e?g.Xl&&(g.Ec(e,"nodeName")||(e=null)):"mouseover"==c?e=a.fromElement:"mouseout"==c&&(e=a.toElement);this.relatedTarget=e;d?(this.clientX=void 0!==d.clientX?d.clientX:d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0):(this.clientX=void 0!==
a.clientX?a.clientX:a.pageX,this.clientY=void 0!==a.clientY?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0);this.button=a.button;this.keyCode=a.keyCode||0;this.key=a.key||"";this.charCode=a.charCode||("keypress"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.G=g.Zl?a.metaKey:a.ctrlKey;this.pointerId=a.pointerId||0;this.pointerType="string"===typeof a.pointerType?a.pointerType:Kca[a.pointerType]||"";this.state=
...
g.Ud.prototype.preventDefault=function(){g.Ud.V.preventDefault.call(this);var a=this.zc;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,Jca)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};var Vd="closure_listenable_"+(1E6*Math.random()|0),vaa=0;g.h=g.Yd.prototype;g.h.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.C++);var k=$d(a,b,d,e);-1<k?(b=a[k],c||(b.Ph=!1)):(b=new waa(b,this.src,f,!!d,e),b.Ph=c,a.push(b));return b};
...
g.h.hasListener=function(a,b){var c=void 0!==a,d=c?a.toString():"",e=void 0!==b;return g.Ua(this.listeners,function(f){for(var k=0;k<f.length;++k)if(!(c&&f[k].type!=d||e&&f[k].capture!=b))return!0;return!1})};var fe="closure_lm_"+(1E6*Math.random()|0),le={},he=0,oe="__closure_events_fn_"+(1E9*Math.random()>>>0);g.x(g.pe,g.C);g.pe.prototype[Vd]=!0;g.h=g.pe.prototype;g.h.ni=function(){return this.Ol};
...
g.h.xk=function(){this.pb=0;this.C&&this.C.call(this.F)};g.x(af,Faa);af.prototype.reset=function(){this.C[0]=1732584193;this.C[1]=4023233417;this.C[2]=2562383102;this.C[3]=271733878;this.C[4]=3285377520;this.H=this.D=0};
...
g.h.ud=g.ba(2);g.h.equals=function(a,b){if(this===a)return!0;if(this.D!=a.Gb())return!1;var c=b||Haa;g.mf(this);for(var d,e=0;d=this.C[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
...
return e};var qf={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},Jaa=/\uffff/.test("\uffff")?/[\\"\x00-\x1f\x7f-\uffff]/g:/[\\"\x00-\x1f\x7f-\xff]/g;g.x(g.rf,g.C);g.h=g.rf.prototype;g.h.subscribe=function(a,b,c){var d=this.F[a];d||(d=this.F[a]=[]);var e=this.H;this.C[e]=a;this.C[e+1]=b;this.C[e+2]=c;this.H=e+3;d.push(e);return e};
...
uf.prototype.get=function(a){if(a=this.F(a)){if(a=a.data,void 0===a)throw"Storage: Invalid value was encountered";}else a=void 0;return a};g.x(g.yf,uf);g.yf.prototype.set=function(a,b,c){if(b=wf(b)){if(c){if(c<(0,g.$c)()){g.yf.prototype.remove.call(this,a);return}b.expiration=c}b.creation=(0,g.$c)()}g.yf.V.set.call(this,a,b)};
g.yf.prototype.F=function(a,b){var c=g.yf.V.F.call(this,a);if(c)if(!b&&g.zf(c))g.yf.prototype.remove.call(this,a);else return c};g.x(Af,Laa);Af.prototype.Gb=function(){var a=0;g.hf(this.bd(!0),function(){a++});
return a};
Af.prototype.clear=function(){var a=Gaa(this.bd(!0)),b=this;(0,g.B)(a,function(c){b.remove(c)})};g.x(g.Bf,Af);g.h=g.Bf.prototype;g.h.isAvailable=function(){if(!this.C)return!1;try{return this.C.setItem("__sak","1"),this.C.removeItem("__sak"),!0}catch(a){return!1}};
...
g.h.key=function(a){return this.C.key(a)};g.x(g.Cf,g.Bf);g.x(Ff,Af);var Maa={".":".2E","!":".21","~":".7E","*":".2A","'":".27","(":".28",")":".29","%":"."},Ef=null;g.h=Ff.prototype;g.h.isAvailable=function(){return!!this.C};
...
return d};g.Mf=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};g.r("yt.config_",g.Mf,void 0);var Wf={};var Naa=[];var Lca=g.u("ytPubsubPubsubInstance")||new g.rf;g.rf.prototype.subscribe=g.rf.prototype.subscribe;g.rf.prototype.unsubscribeByKey=g.rf.prototype.qd;g.rf.prototype.publish=g.rf.prototype.oa;g.rf.prototype.clear=g.rf.prototype.clear;g.r("ytPubsubPubsubInstance",Lca,void 0);var eg=g.u("ytPubsubPubsubSubscribedKeys")||{};g.r("ytPubsubPubsubSubscribedKeys",eg,void 0);var hg=g.u("ytPubsubPubsubTopicToKeys")||{};g.r("ytPubsubPubsubTopicToKeys",hg,void 0);var fg=g.u("ytPubsubPubsubIsSynchronous")||{};
g.r("ytPubsubPubsubIsSynchronous",fg,void 0);var Qaa=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Raa=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;var tm;tm=window;g.tg=tm.ytcsi&&tm.ytcsi.now?tm.ytcsi.now:tm.performance&&tm.performance.timing&&tm.performance.now&&tm.performance.timing.navigationStart?function(){return tm.performance.timing.navigationStart+tm.performance.now()}:function(){return(new Date).getTime()};var Waa,xg,yg,zg,Saa,Eg,Taa,rg,Bg;Waa=g.Tf("initial_gel_batch_timeout",1E3);xg=Math.pow(2,16)-1;g.mh=10;yg=null;zg=0;Saa={log_event:"events",log_interaction:"interactions"};Eg=Object.create(null);Eg.log_event="GENERIC_EVENT_LOGGING";Eg.log_interaction="INTERACTION_LOGGING";Taa=new Set(["log_event"]);rg={};g.og=0;g.pg=0;g.lh=0;Bg=!0;g.qg=g.u("ytLoggingTransportLogPayloadsQueue_")||{};g.r("ytLoggingTransportLogPayloadsQueue_",g.qg,void 0);var wg=g.u("ytLoggingTransportTokensToCttTargetIds_")||{};
g.r("ytLoggingTransportTokensToCttTargetIds_",wg,void 0);var sg=g.u("ytLoggingTransportDispatchedStats_")||{};g.r("ytLoggingTransportDispatchedStats_",sg,void 0);var Fg=g.u("ytLoggingTransportCapturedTime_")||{};g.r("ytytLoggingTransportCapturedTime_",Fg,void 0);var Mca=0,Xaa=g.Yl?"webkit":g.Xl?"moz":g.Df?"ms":g.Ul?"o":"",Ig=g.u("ytDomDomGetNextId")||function(){return++Mca};
g.r("ytDomDomGetNextId",Ig,void 0);var Yaa={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};g.Lg.prototype.preventDefault=function(){this.event&&(this.event.returnValue=!1,this.event.preventDefault&&this.event.preventDefault())};
...
g.Lg.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Pg=g.u("ytEventsEventsListeners")||{};g.r("ytEventsEventsListeners",Pg,void 0);var Tg=g.u("ytEventsEventsCounter")||{count:0};g.r("ytEventsEventsCounter",Tg,void 0);var Ug=g.Sa(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
g.ym="Microsoft Internet Explorer"==navigator.appName;g.x(g.Yg,g.C);g.Yg.prototype.Y=function(a){this.C=new g.bd(g.Ng(a),g.Og(a))};
g.Yg.prototype.M=function(){if(this.C){var a=g.um();if(0!=this.D){var b=g.dd(this.L,this.C)/(a-this.D);this.F[this.H]=.5<Math.abs((b-this.G)/this.G)?1:0;for(var c=0,d=0;4>d;d++)c+=this.F[d]||0;3<=c&&this.Pb();this.G=b}this.D=a;this.L=this.C;this.H=(this.H+1)%4}};
g.Yg.prototype.X=function(){g.cg(this.N);g.Vg(this.J)};g.n(dh,Zaa);dh.prototype.start=function(){var a=g.u("yt.scheduler.instance.start");a&&a()};
dh.prototype.pause=function(){var a=g.u("yt.scheduler.instance.pause");a&&a()};
g.ya(dh);dh.getInstance();var ih={};var kh=g.u("ytLoggingGelSequenceIdObj_")||{};g.r("ytLoggingGelSequenceIdObj_",kh,void 0);g.vh=new function(){var a=window.document;this.C=window;this.F=a};
g.r("yt.ads_.signals_.getAdSignalsString",function(a){return g.rh(yh(a))},void 0);(0,g.$c)();var Ah=void 0!==XMLHttpRequest?function(){return new XMLHttpRequest}:void 0!==ActiveXObject?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;var Dh,bba,Ih;Dh={Authorization:"AUTHORIZATION","X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-YouTube-Device":"DEVICE","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"};bba="app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ");
Ih=!1;g.zm=Jh;g.Uh.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.C)try{this.C.set(a,b,(0,g.$c)()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(g.of(b))}catch(f){return}else e=escape(b);g.Sh(a,e,c,this.F)};
g.Uh.prototype.get=function(a,b){var c=void 0,d=!this.C;if(!d)try{c=this.C.get(a)}catch(e){d=!0}if(d&&(c=g.Rh.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
g.Uh.prototype.remove=function(a){this.C&&this.C.remove(a);g.Th(a,"/",this.F)};var Vh=new g.Uh("yt.innertube");g.Yh.prototype.isReady=function(){!this.C&&Nh()&&(this.C=Oh());return!!this.C};g.n(g.ai,Error);g.Am=new Set;g.di.prototype.initialize=function(a,b,c,d,e,f){var k=this;f=void 0===f?!1:f;b?(this.F=!0,g.mg(b,function(){k.F=!1;window.botguard?ei(k,c,d,f):(g.ng(b),g.ci(new g.ai("Unable to load Botguard","from "+b)))})):a&&(eval(a),window.botguard?ei(this,c,d,f):g.ci(Error("Unable to load Botguard from JS")))};
g.di.prototype.Nd=function(){return!!this.C};
g.di.prototype.dispose=function(){this.C=null};g.gi=new g.di;hi.prototype.then=function(a,b,c){return this.D?this.D.then(a,b,c):1===this.F&&a?(a=a.call(c,this.C),g.Fe(a)?a:g.ji(a)):2===this.F&&b?(a=b.call(c,this.C),g.Fe(a)?a:g.ii(a)):this};
hi.prototype.getValue=function(){return this.C};
g.Ee(hi);g.n(ki,g.C);ki.prototype.Va=function(a){for(var b=0;b<this.C.length;b++)if(this.C[b]==a){this.C.splice(b,1);a.target.removeEventListener(a.name,a.callback);break}};
ki.prototype.X=function(){for(;this.C.length;){var a=this.C.pop();a.target.removeEventListener(a.name,a.callback)}g.C.prototype.X.call(this)};li.prototype.clone=function(){var a=new li,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==g.za(c)?a[b]=g.$a(c):a[b]=c}return a};var ni=(0,g.$c)().toString();var pi=g.u("ytLoggingDocDocumentNonce_")||oi();g.r("ytLoggingDocDocumentNonce_",pi,void 0);g.ri.prototype.toString=function(){return JSON.stringify(g.si(this))};g.r("yt_logging_screen.getRootVeType",vi,void 0);g.r("yt_logging_screen.getCurrentCsn",g.yi,void 0);g.r("yt_logging_screen.getCttAuthInfo",g.zi,void 0);g.r("yt_logging_screen.setCurrentScreen",g.Ai,void 0);g.Ci.prototype.toString=function(){return this.topic};var Nca=g.u("ytPubsub2Pubsub2Instance")||new g.rf;g.rf.prototype.subscribe=g.rf.prototype.subscribe;g.rf.prototype.unsubscribeByKey=g.rf.prototype.qd;g.rf.prototype.publish=g.rf.prototype.oa;g.rf.prototype.clear=g.rf.prototype.clear;g.r("ytPubsub2Pubsub2Instance",Nca,void 0);var Fi=g.u("ytPubsub2Pubsub2SubscribedKeys")||{};g.r("ytPubsub2Pubsub2SubscribedKeys",Fi,void 0);var Hi=g.u("ytPubsub2Pubsub2TopicToKeys")||{};g.r("ytPubsub2Pubsub2TopicToKeys",Hi,void 0);
var Gi=g.u("ytPubsub2Pubsub2IsAsync")||{};g.r("ytPubsub2Pubsub2IsAsync",Gi,void 0);g.r("ytPubsub2Pubsub2SkipSubKey",null,void 0);g.n(Ki,g.Bi);var mba=new g.Ci("screen-created",Ki),Li=[],Mi=0;var Vi,Ti;Vi=0;g.Ui=null;Ti=null;g.h=g.Xi.prototype;g.h.dG=function(){this.Nd()||this.init()};
g.h.enable=function(){this.C=1;(0,g.B)("string"==typeof this.page?[this.page]:this.page,function(a){a&&(this.subscribe("init-"+a,this.dG,this),this.subscribe("dispose-"+a,this.dispose,this),g.E("PAGE_NAME")==a&&g.Yi(this))},this)};
g.h.init=function(){g.bh(this.F);this.C=2;this.L&&this.L()};
g.h.Nd=function(){return 2==this.C};
g.h.dispose=function(){this.C=3;g.bh(this.F);this.H&&this.H()};
...
g.h.clear=function(){g.jg(this.G);this.G=[]};var Zi=g.u("yt.modules.registry_")||{};g.r("yt.modules.registry_",Zi,void 0);g.bj=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};g.r("yt.msgs_",g.bj,void 0);var hj={},qba=0;var rba=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;g.n(vj,g.C);g.h=vj.prototype;g.h.getId=function(){return this.ha};
g.h.loadNewVideoConfig=function(a){if(!this.qb()){this.aa&&(g.bg(this.aa),this.aa=0);this.nb=a=g.mi(a);this.C=a.clone();tj(this);this.qa||(this.qa=Ej(this,this.C.args.jsapicallback||"onYouTubePlayerReady"));this.C.args.jsapicallback=null;(a=this.C.attrs.width)&&g.Bd(this.L,Number(a)||a);if(a=this.C.attrs.height)this.L.style.height=g.Ad(Number(a)||a,!0);uj(this);this.M&&wj(this)}};
g.h.Zu=function(){return this.nb};
g.h.dz=function(){return this.M};
g.h.Jh=function(a,b){var c=this,d=Ej(this,b);if(d){if(!g.Ma(this.Pd,a)&&!this.G[a]){var e=tba(this,a);this.N&&this.N(a,e)}this.Y.subscribe(a,d);"onReady"==a&&this.M&&g.$f(function(){d(c.api)},0)}};
g.h.RF=function(a,b){if(!this.qb()){var c=Ej(this,b);c&&g.sf(this.Y,a,c)}};
g.h.Ct=function(a){g.H("a11y-announce",a)};
g.h.iD=function(a){g.H("WATCH_LATER_VIDEO_ADDED",a)};
g.h.jD=function(a){g.H("WATCH_LATER_VIDEO_REMOVED",a)};
g.h.tv=function(){return this.la||(xj(this)?"html5":null)};
g.h.gv=function(){return this.kb};
g.h.cancel=function(){if(this.J){var a=this.J,b=g.lg(yj(this));spf.script.ignore(b,a)}g.bg(this.sb);this.T=!1};
g.h.X=function(){Bj(this);if(this.H&&this.C&&this.H.destroy)try{this.H.destroy()}catch(b){g.Xf(b)}this.ib=null;for(var a in this.G)g.q[this.G[a]]=null;this.nb=this.C=this.api=null;delete this.Ya;delete this.L;g.C.prototype.X.call(this)};g.Gj={};g.Fj="player_uid_"+(1E9*Math.random()>>>0);var Nj=null;g.Bm=window.performance&&window.performance.memory;g.ol={};g.n(Oj,g.Bi);g.n(Pj,g.Bi);var xba=new g.Ci("aft-recorded",Oj),Gba=new g.Ci("timing-sent",Pj);var Cm=window,Sj=Cm.performance||Cm.mozPerformance||Cm.msPerformance||Cm.webkitPerformance||new wba;var dk=!1;var kk=g.u("ytLoggingLatencyUsageStats_")||{};g.r("ytLoggingLatencyUsageStats_",kk,void 0);ik.prototype.tick=function(a,b,c){lk(this,"tick_"+a+"_"+b)||g.Zh("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
ik.prototype.info=function(a,b){var c=Object.keys(a).join("");lk(this,"info_"+c+"_"+b)||(a.clientActionNonce=b,g.Zh("latencyActionInfo",a))};var Dm={},Ak=(Dm.ad_to_ad="LATENCY_ACTION_AD_TO_AD",Dm.ad_to_video="LATENCY_ACTION_AD_TO_VIDEO",Dm.app_startup="LATENCY_ACTION_APP_STARTUP",Dm["artist.analytics"]="LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS",Dm["artist.events"]="LATENCY_ACTION_CREATOR_ARTIST_CONCERTS",Dm["artist.presskit"]="LATENCY_ACTION_CREATOR_ARTIST_PROFILE",Dm.browse="LATENCY_ACTION_BROWSE",Dm.channels="LATENCY_ACTION_CHANNELS",Dm.channel="LATENCY_ACTION_CREATOR_CHANNEL_DASHBOARD",Dm["channel.analytics"]="LATENCY_ACTION_CREATOR_CHANNEL_ANALYTICS",
...
Em.GetSearch_rid="getSearchRequestId",Em.GetPlayer_rid="getPlayerRequestId",Em.GetWatchNext_rid="getWatchNextRequestId",Em.GetBrowse_rid="getBrowseRequestId",Em.GetLibrary_rid="getLibraryRequestId",Em.is_continuation="isContinuation",Em.is_nav="isNavigation",Em.b_p="kabukiInfo.browseParams",Em.is_prefetch="kabukiInfo.isPrefetch",Em.is_secondary_nav="kabukiInfo.isSecondaryNav",Em.prev_browse_id="kabukiInfo.prevBrowseId",Em.query_source="kabukiInfo.querySource",Em.voz_type="kabukiInfo.vozType",Em.yt_lt=
"loadType",Em.mver="creatorInfo.measurementVersion",Em.yt_ad="isMonetized",Em.nr="webInfo.navigationReason",Em.nrsu="navigationRequestedSameUrl",Em.ncnp="webInfo.nonPreloadedNodeCount",Em.pnt="performanceNavigationTiming",Em.prt="playbackRequiresTap",Em.plt="playerInfo.playbackType",Em.pis="playerInfo.playerInitializedState",Em.paused="playerInfo.isPausedOnLoad",Em.yt_pt="playerType",Em.fmt="playerInfo.itag",Em.yt_pl="watchInfo.isPlaylist",Em.yt_pre="playerInfo.preloadType",Em.yt_ad_pr="prerollAllowed",
Em.pa="previousAction",Em.yt_red="isRedSubscriber",Em.rce="mwebInfo.responseContentEncoding",Em.scrh="screenHeight",Em.scrw="screenWidth",Em.st="serverTimeMs",Em.aq="tvInfo.appQuality",Em.br_trs="tvInfo.bedrockTriggerState",Em.kebqat="kabukiInfo.earlyBrowseRequestInfo.abandonmentType",Em.kebqa="kabukiInfo.earlyBrowseRequestInfo.adopted",Em.label="tvInfo.label",Em.is_mdx="tvInfo.isMdx",Em.preloaded="tvInfo.isPreloaded",Em.upg_player_vis="playerInfo.visibilityState",Em.query="unpluggedInfo.query",Em.upg_chip_ids_string=
"unpluggedInfo.upgChipIdsString",Em.yt_vst="videoStreamType",Em.vph="viewportHeight",Em.vpw="viewportWidth",Em.yt_vis="isVisible",Em.rcl="mwebInfo.responseContentLength",Em.GetSettings_rid="mwebInfo.getSettingsRequestId",Em.GetTrending_rid="mwebInfo.getTrendingRequestId",Em.GetMusicSearchSuggestions_rid="musicInfo.getMusicSearchSuggestionsRequestId",Em),zba="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
Fm={},qk=(Fm.mver="MEASUREMENT_VERSION_",Fm.pis="PLAYER_INITIALIZED_STATE_",Fm.yt_pt="LATENCY_PLAYER_",Fm.pa="LATENCY_ACTION_",Fm.yt_vst="VIDEO_STREAM_TYPE_",Fm),Aba="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");if(g.Sf("overwrite_polyfill_on_logging_lib_loaded")){var Gm=window;Gm.ytcsi&&(Gm.ytcsi.info=uk)};var zk={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3/mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"},Bba=(0,g.v)(Sj.clearResourceTimings||
Sj.webkitClearResourceTimings||Sj.mozClearResourceTimings||Sj.msClearResourceTimings||Sj.oClearResourceTimings||g.xa,Sj),Hm=window;g.Sf("csi_on_gel")&&Hm.ytcsi&&(Hm.ytcsi.tick=g.wk);var Pk=0,Lk=[],Ok=[],Ik=0,Mk={},Nk={},Jk=new g.$e(Nba,1E3);var Rk=["server_prefetched_vast","vmap"];var Tk;var Xk=null,$k=[];var dl,ul,tl,fl,el,Uba,Xba,Vba,Wba,pl;fl=0;el=0;Uba=[900,60,"waiting"];Xba=[500,99,"waiting"];Vba=[300,60,"waiting"];Wba=[400,99,"waiting"];pl=[300,101,"done"];var Bl=!1;window.yt=window.yt||{};g.r("yt.setConfig",g.Nf,void 0);g.r("yt.pushConfigArray",Of,void 0);g.r("yt.getConfig",g.E,void 0);g.r("yt.config.set",g.Nf,void 0);g.r("yt.config.pushArray",Of,void 0);g.r("yt.config.get",g.E,void 0);g.r("yt.hasMsg",g.dj,void 0);g.r("yt.setMsg",cj,void 0);g.r("yt.setGoogMsg",ej,void 0);g.r("yt.msgs.has",g.dj,void 0);g.r("yt.msgs.set",cj,void 0);g.r("yt.msgs.setGoog",ej,void 0);g.r("yt.pubsub.publish",g.H,void 0);g.r("yt.pubsub.subscribe",g.ig,void 0);
g.r("ytcsi.tick",g.wk,void 0);g.x(El,g.Xi);
El.prototype.enable=function(){window.onload=Sba;window.onunload=Tba;window.onerror=Paa;var a=window.ytspf||{};a.enabled?(window.addEventListener&&(window.addEventListener("spfclick",bl),window.addEventListener("spfhistory",cl),window.addEventListener("spfrequest",hl),window.addEventListener("spfpartprocess",kl),window.addEventListener("spfpartdone",ll),window.addEventListener("spfprocess",ml),window.addEventListener("spfdone",ql),window.addEventListener("spferror",rl),window.addEventListener("spfreload",
sl),window.addEventListener("spfjsbeforeunload",Fl)),a.config=a.config||{},window.ytdepmap?spf.script.ready("spf",function(){a.enabled=spf.init(a.config)}):a.enabled=spf.init(a.config),this.subscribe("init",Zba),this.subscribe("dispose",$ba)):spf.dispose();
...
a=g.E("JS_COMMON_MODULE");var d=g.E("JS_PAGE_MODULES");d||(d=[a]);a=g.E("JS_DELAY_LOAD",0);0<a?(g.bg(this.D),this.D=g.$f(function(){b&&g.mg(b,c);spf.script.require(d)},a)):(b&&g.mg(b,c),spf.script.require(d));
g.r("yt.abuse.player.botguardInitialized",iba,void 0);g.r("yt.abuse.player.invokeBotguard",jba,void 0);g.r("yt.abuse.dclkstatus.checkDclkStatus",hba,void 0);g.r("yt.player.exports.navigate",g.rj,void 0);g.r("yt.util.activity.init",g.hh,void 0);g.r("yt.util.activity.getTimeSinceActive",g.jh,void 0);g.r("yt.util.activity.setTimestamp",g.fh,void 0);Wk(g.u("ytplayer.config"));g.u("ytspf.enabled")&&Qba();Fba();g.E("SERVICE_WORKER_KILLSWITCH",void 0)||navigator.serviceWorker&&navigator.serviceWorker.getRegistrations&&
"https:"==window.location.protocol&&(g.Sf("service_worker_enabled")?pca():nca())};
El.prototype.dispose=function(){g.bg(this.D);var a=g.u("ytbin.www.pageframe.cancelSetup");a&&a();g.cg(Tk);if(a=g.Vk())a.removeEventListener("onReady",Uk),a.removeEventListener("onStateChange",Uk);Wj(!1);(a=(a=(a=document.getElementById("ticker"))&&"TRIGGER_CONDITION_ENABLE_NOTIFICATIONS_PROMPT"==g.F(a,"trigger-condition")?a:null)?a.querySelector(".yt-uix-button-alert-info"):null)&&g.Xg(a);El.V.dispose.call(this)};
...
/*
     FILE ARCHIVED ON 00:01:01 Apr 01, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:56:52 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 258.455
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.058
  cdx.remote: 0.057
  esindex: 0.009
  LoadShardBlock: 28.96 (3)
  PetaboxLoader3.datanode: 5600.752 (5)
  load_resource: 5646.947 (2)
  PetaboxLoader3.resolve: 54.664 (2)
*/