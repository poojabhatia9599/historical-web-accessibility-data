...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Open video page";a.T().ca("kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d={G:"svg",U:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},S:[{G:"g",U:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},S:[{G:"g",U:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},S:[{G:"path",U:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expand");g.V.call(this,{G:"button",ia:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],U:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},S:[d]});this.J=a;this.ua("click",this.onClick,this);this.wa("title",g.EX(a,e,"i"));g.dg(this,g.cY(b.Jb(),this.element))},O5=function(a){g.V.call(this,{G:"div",
L:"ytp-miniplayer-ui"});this.hh=!1;this.player=a;this.R(a,"minimized",this.yi);this.R(a,"onStateChange",this.RQ)},P5=function(a){g.pS.call(this,a);
...
g.k.show=function(){this.Cd=new g.qn(this.Mp,null,this);this.Cd.start();if(!this.hh){this.tooltip=new g.r_(this.player,this);g.C(this,this.tooltip);g.oP(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Kb=new g.XX(this.player);g.C(this,this.Kb);this.Jk=new g.V({G:"div",L:"ytp-miniplayer-scrim"});g.C(this,this.Jk);this.Jk.fa(this.element);this.R(this.Jk.element,"click",this.EE);var a=new g.V({G:"button",ia:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.pN()]});
g.C(this,a);a.fa(this.Jk.element);this.R(a.element,"click",this.xn);a=new N5(this.player,this);g.C(this,a);a.fa(this.Jk.element);this.jl=new g.V({G:"div",L:"ytp-miniplayer-controls"});g.C(this,this.jl);this.jl.fa(this.Jk.element);this.R(this.jl.element,"click",this.EE);var b=new g.V({G:"div",L:"ytp-miniplayer-button-container"});g.C(this,b);b.fa(this.jl.element);a=new g.V({G:"div",L:"ytp-miniplayer-play-button-container"});g.C(this,a);a.fa(this.jl.element);var c=new g.V({G:"div",L:"ytp-miniplayer-button-container"});
g.C(this,c);c.fa(this.jl.element);this.cF=new g.sZ(this.player,this,!1);g.C(this,this.cF);this.cF.fa(b.element);b=new g.pZ(this.player,this);g.C(this,b);b.fa(a.element);this.nextButton=new g.sZ(this.player,this,!0);g.C(this,this.nextButton);this.nextButton.fa(c.element);this.Ih=new g.g_(this.player,this);g.C(this,this.Ih);this.Ih.fa(this.Jk.element);this.Oc=new g.wZ(this.player,this);g.C(this,this.Oc);g.oP(this.player,this.Oc.element,4);this.ht=new g.V({G:"div",L:"ytp-miniplayer-buttons"});g.C(this,
this.ht);g.oP(this.player,this.ht.element,4);a=new g.V({G:"button",ia:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.pN()]});g.C(this,a);a.fa(this.ht.element);this.R(a.element,"click",this.xn);a=new g.V({G:"button",ia:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Close"},S:[g.DN()]});g.C(this,a);a.fa(this.ht.element);this.R(a.element,"click",this.WO);this.R(this.player,"presentingplayerstatechange",this.Vb);this.R(this.player,"appresize",this.Ra);this.R(this.player,
...
g.k.EE=function(a){if(a.target===this.Jk.element||a.target===this.jl.element)g.R(this.player.T().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.hL(g.lI(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.va("onExpandMiniplayer")};
...
g.k.Mp=function(){this.Vd();this.Cd&&this.Cd.start()};
...
g.k.RQ=function(a){this.player.app.visibility.u&&(0===a?this.hide():this.show())};
...
/*
     ...
     INTERNET ARCHIVE ON 18:58:51 Dec 10, 2023.
...
/*
playback timings (ms):
  captures_list: 387.615
  exclusion.robots: 0.075
  exclusion.robots.policy: 0.065
  cdx.remote: 0.055
  esindex: 0.009
  LoadShardBlock: 126.68 (3)
  PetaboxLoader3.datanode: 94.91 (5)
  load_resource: 167.276 (2)
  PetaboxLoader3.resolve: 116.926 (2)
*/