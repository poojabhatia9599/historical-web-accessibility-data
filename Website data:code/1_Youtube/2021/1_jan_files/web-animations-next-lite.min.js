...
this._setMember("easing",p)},get easing(){return this._easing},set iterations(p){if((isNaN(p)||0>p)&&f())throw new TypeError("iterations must be non-negative, received: "+p);this._setMember("iterations",p)},get iterations(){return this._iterations}};var l=1,r=.5,t=0,x={ease:d(.25,.1,.25,1),"ease-in":d(.42,0,1,1),"ease-out":d(0,0,.58,1),"ease-in-out":d(.42,0,.58,1),"step-start":a(1,l),"step-middle":a(1,r),"step-end":a(1,t)},u=null,q=/cubic-bezier\(\s*(-?\d+\.?\d*|-?\.\d+)\s*,\s*(-?\d+\.?\d*|-?\.\d+)\s*,\s*(-?\d+\.?\d*|-?\.\d+)\s*,\s*(-?\d+\.?\d*|-?\.\d+)\s*\)/,
...
/*
     ...
     INTERNET ARCHIVE ON 19:07:57 Dec 11, 2023.
...
/*
playback timings (ms):
  captures_list: 258.187
  exclusion.robots: 0.079
  exclusion.robots.policy: 0.07
  cdx.remote: 0.066
  esindex: 0.013
  LoadShardBlock: 207.877 (3)
  PetaboxLoader3.resolve: 554.885 (5)
  PetaboxLoader3.datanode: 60.896 (5)
  load_resource: 455.839 (2)
*/