...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expand");g.X.call(this,{D:"button",ka:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],U:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},S:[d]});this.G=a;this.ya("click",this.onClick,this);this.Aa("title",g.dO(a,e,"i"));g.Qi(this,g.BO(b.Nb(),this.element))},j4=function(a){g.X.call(this,{D:"div",
...
this.Ai);this.Ai.fa(this.Bj.element);this.Zc=new g.bQ(this.player,this);g.L(this,this.Zc);g.xN(this.player,this.Zc.element,4);this.wu=new g.X({D:"div",K:"ytp-miniplayer-buttons"});g.L(this,this.wu);g.xN(this.player,this.wu.element,4);a=new g.X({D:"button",ka:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.yL()]});g.L(this,a);a.fa(this.wu.element);this.N(a.element,"click",this.qj);a=new g.X({D:"button",ka:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Close"},
...
/*
     FILE ARCHIVED ON 00:03:27 Mar 01, 2021 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 113.557
  exclusion.robots: 0.102
  exclusion.robots.policy: 0.089
  cdx.remote: 0.076
  esindex: 0.01
  LoadShardBlock: 51.585 (3)
  PetaboxLoader3.datanode: 99.264 (5)
  load_resource: 233.663 (2)
  PetaboxLoader3.resolve: 97.799 (2)
*/